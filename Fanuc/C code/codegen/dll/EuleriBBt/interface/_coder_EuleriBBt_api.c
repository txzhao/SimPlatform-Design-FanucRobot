...
/* Include files */
#include "_coder_EuleriBBt_api.h"
...
static const mxArray *emlrt_marshallOut(const double u[1296]);
 ...
 * Return Type  : void
 */
void EuleriBBt_initialize(emlrtContext *aContext)
{
 ...
 * Return Type  : void
 */
void EuleriBBt_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  double (*iBBt)[1296];
  double (*in1)[5];
  emlrtStack st = { NULL, NULL, NULL };
  ...
  st.tls = emlrtRootTLSGlobal;
  iBBt = (double (*)[1296])mxMalloc(sizeof(double [1296]));
...
/*
 * File trailer for _coder_EuleriBBt_api.c
 *
 * [EOF]
 */
