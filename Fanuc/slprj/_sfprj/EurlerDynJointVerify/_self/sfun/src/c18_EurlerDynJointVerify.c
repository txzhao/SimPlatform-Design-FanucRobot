...
static void initialize_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void initialize_params_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void enable_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void disable_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void set_sim_state_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance, const mxArray
   *c18_st);
static void finalize_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void sf_c18_EurlerDynJointVerify(SFc18_EurlerDynJointVerifyInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c18_EurlerDynJointVerify
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c18_machineNumber, uint32_T
  c18_chartNumber);
static void c18_fwd_kin(SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance,
...
static void c18_emlrt_marshallIn(SFc18_EurlerDynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c18_EndPos, const char_T *c18_name, real_T
  c18_y[3]);
static uint8_T c18_b_emlrt_marshallIn(SFc18_EurlerDynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_EurlerDynJointVerify, const
  char_T *c18_name);
static void init_dsm_address_info(SFc18_EurlerDynJointVerifyInstanceStruct
  *chartInstance);
  ...
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_EurlerDynJointVerify = 0U;
}
  ...
  (SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_EurlerDynJointVerify;
   ...
   *c18_st)
{
  ...
  chartInstance->c18_is_active_c18_EurlerDynJointVerify = c18_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_EurlerDynJointVerify");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_EurlerDynJointVerify(chartInstance);
...
static void c18_fwd_kin(SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance,
  real_T c18_in1[9], real_T c18_in2[6], real_T
  c18_gst[16])
{
...
static const mxArray *c18_sf_marshall(void *chartInstanceVoid, void *c18_u)
{
  ...
  const mxArray *c18_b_y = NULL;
  SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc18_EurlerDynJointVerifyInstanceStruct *)chartInstanceVoid;
  c18_y = NULL;
...
const mxArray *sf_c18_EurlerDynJointVerify_get_eml_resolved_functions_info(void)
{
...
static uint8_T c18_b_emlrt_marshallIn(SFc18_EurlerDynJointVerifyInstanceStruct
  *chartInstance, const mxArray *
  c18_b_is_active_c18_EurlerDynJointVerify, const char_T *c18_name)
{
  uint8_T c18_y;
  uint8_T c18_u0;
  sf_mex_import(c18_name, sf_mex_dup(c18_b_is_active_c18_EurlerDynJointVerify),
                &c18_u0, 1, 3, 0U, 0, 0U, 0);
  c18_y = c18_u0;
  sf_mex_destroy(&c18_b_is_active_c18_EurlerDynJointVerify);
  return c18_y;
}
...
/* SFunction Glue Code */
void sf_c18_EurlerDynJointVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_EurlerDynJointVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c18_EurlerDynJointVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c18_EurlerDynJointVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_EurlerDynJointVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc18_EurlerDynJointVerifyInstanceStruct *)
...
static void sf_opaque_initialize_c18_EurlerDynJointVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_EurlerDynJointVerifyInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_EurlerDynJointVerify
    ((SFc18_EurlerDynJointVerifyInstanceStruct*) chartInstanceVar);
  initialize_c18_EurlerDynJointVerify((SFc18_EurlerDynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_EurlerDynJointVerify(void *chartInstanceVar)
{
  enable_c18_EurlerDynJointVerify((SFc18_EurlerDynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_EurlerDynJointVerify(void *chartInstanceVar)
{
  disable_c18_EurlerDynJointVerify((SFc18_EurlerDynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_EurlerDynJointVerify(void *chartInstanceVar)
{
  sf_c18_EurlerDynJointVerify((SFc18_EurlerDynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c18_EurlerDynJointVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_EurlerDynJointVerify
    ((SFc18_EurlerDynJointVerifyInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c18_EurlerDynJointVerify();/* state var info */
...
static void sf_internal_set_sim_state_c18_EurlerDynJointVerify(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_EurlerDynJointVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c18_EurlerDynJointVerify
    ((SFc18_EurlerDynJointVerifyInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c18_EurlerDynJointVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_EurlerDynJointVerify(S);
}

static void sf_opaque_set_sim_state_c18_EurlerDynJointVerify(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_EurlerDynJointVerify(S, st);
}

static void sf_opaque_terminate_c18_EurlerDynJointVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_EurlerDynJointVerifyInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c18_EurlerDynJointVerify((SFc18_EurlerDynJointVerifyInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c18_EurlerDynJointVerify
    ((SFc18_EurlerDynJointVerifyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_EurlerDynJointVerify(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c18_EurlerDynJointVerify
      ((SFc18_EurlerDynJointVerifyInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c18_EurlerDynJointVerify(SimStruct *S)
{
...
static void mdlRTW_c18_EurlerDynJointVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EurlerDynJointVerify", "EurlerDynJointVerify",18);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c18_EurlerDynJointVerify(SimStruct *S)
{
  SFc18_EurlerDynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc18_EurlerDynJointVerifyInstanceStruct *)malloc(sizeof
    (SFc18_EurlerDynJointVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_EurlerDynJointVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_EurlerDynJointVerify;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_EurlerDynJointVerify;
...
void c18_EurlerDynJointVerify_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_EurlerDynJointVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_EurlerDynJointVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_EurlerDynJointVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_EurlerDynJointVerify_method_dispatcher.\n"
