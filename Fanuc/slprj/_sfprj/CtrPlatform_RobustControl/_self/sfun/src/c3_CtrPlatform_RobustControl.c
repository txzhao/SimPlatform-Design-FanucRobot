...
#include "c3_CtrPlatform_RobustControl.h"
...
static const char * c3_debug_family_names[15] = { "L", "Cen", "Ma", "nargin",
  "nargout", "RefAcc", "EnTheta", "Ie1", "Ie2", "Ie3", "Ie4", "Ie5", "Ie6", "M",
  "M_Acc" };
...
static void initialize_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initialize_params_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void enable_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void disable_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void set_sim_state_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void sf_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c3_chartstep_c3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initSimStructsc3_CtrPlatform_RobustControl
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_M_Acc, const char_T *c3_identifier, real_T
  c3_y[6]);
static void c3_b_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_M, const char_T *c3_identifier, real_T c3_y
  [36]);
static void c3_d_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[36]);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[9]);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_f_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_f_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_g_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[6]);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_h_emlrt_marshallIn(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[18]);
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[31]);
static void c3_M_d(SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance,
                   ...
                   real_T c3_M_d_[36]);
static real_T c3_power(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c3_a);
static void c3_eml_int_forloop_overflow_check
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_i_emlrt_marshallIn
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
...
static uint8_T c3_j_emlrt_marshallIn
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c3_b_is_active_c3_CtrPlatform_RobustControl, const char_T *c3_identifier);
static uint8_T c3_k_emlrt_marshallIn
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
  ...
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_CtrPlatform_RobustControl = 0U;
}
  ...
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  real_T (*c3_M_Acc)[6];
  real_T (*c3_M)[36];
  c3_M_Acc = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  for (c3_i9 = 0; c3_i9 < 36; c3_i9++) {
    c3_u[c3_i9] = (*c3_M)[c3_i9];
  }

  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 2, 6, 6), FALSE);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  for (c3_i10 = 0; c3_i10 < 6; c3_i10++) {
    c3_b_u[c3_i10] = (*c3_M_Acc)[c3_i10];
  }

  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", c3_b_u, 0, 0U, 1U, 0U, 1, 6), FALSE);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_CtrPlatform_RobustControl;
   ...
   *c3_st)
{
  ...
  c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)), "M",
                        c3_dv9);
  for (c3_i11 = 0; c3_i11 < 36; c3_i11++) {
    (*c3_M)[c3_i11] = c3_dv9[c3_i11];
  }

  c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
                      "M_Acc", c3_dv10);
  for (c3_i12 = 0; c3_i12 < 6; c3_i12++) {
    (*c3_M_Acc)[c3_i12] = c3_dv10[c3_i12];
  }

  chartInstance->c3_is_active_c3_CtrPlatform_RobustControl =
    c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
    "is_active_c3_CtrPlatform_RobustControl");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_CtrPlatform_RobustControl(chartInstance);
  ...
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  for (c3_i13 = 0; c3_i13 < 36; c3_i13++) {
    _SFD_DATA_RANGE_CHECK((*c3_M)[c3_i13], 0U);
  }

  for (c3_i14 = 0; c3_i14 < 6; c3_i14++) {
    _SFD_DATA_RANGE_CHECK((*c3_RefAcc)[c3_i14], 1U);
  }

  for (c3_i15 = 0; c3_i15 < 6; c3_i15++) {
    _SFD_DATA_RANGE_CHECK((*c3_EnTheta)[c3_i15], 2U);
  }

  for (c3_i16 = 0; c3_i16 < 6; c3_i16++) {
    _SFD_DATA_RANGE_CHECK((*c3_M_Acc)[c3_i16], 3U);
  }

  for (c3_i17 = 0; c3_i17 < 9; c3_i17++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_L[c3_i17], 4U);
  }

  for (c3_i18 = 0; c3_i18 < 18; c3_i18++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Cen[c3_i18], 5U);
  }

  for (c3_i19 = 0; c3_i19 < 6; c3_i19++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ma[c3_i19], 6U);
  }

  for (c3_i20 = 0; c3_i20 < 9; c3_i20++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie1[c3_i20], 7U);
  }

  for (c3_i21 = 0; c3_i21 < 9; c3_i21++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie2[c3_i21], 8U);
  }

  for (c3_i22 = 0; c3_i22 < 9; c3_i22++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie3[c3_i22], 9U);
  }

  for (c3_i23 = 0; c3_i23 < 9; c3_i23++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie4[c3_i23], 10U);
  }

  for (c3_i24 = 0; c3_i24 < 9; c3_i24++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie5[c3_i24], 11U);
  }

  for (c3_i25 = 0; c3_i25 < 9; c3_i25++) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c3_Ie6[c3_i25], 12U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_CtrPlatform_RobustControl(chartInstance);
  ...
  (SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  real_T c3_M_Acc[6];
  int32_T c3_i34;
  static real_T c3_d_Ma[6] = { 100.0, 70.0, 92.0, 22.0, 7.0, 1.0 };
  ...
  int32_T c3_i37;
  int32_T c3_i38;
  static real_T c3_dv11[9] = { 0.566, 0.15, 0.87, 0.17, 1.016, 0.154, 0.02, 0.0,
    0.0 };
  ...
  c3_b_M_Acc = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 2);
  c3_d_EnTheta = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_RefAcc = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
  c3_b_M = (real_T (*)[36])ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  for (c3_i26 = 0; c3_i26 < 6; c3_i26++) {
    c3_RefAcc[c3_i26] = (*c3_b_RefAcc)[c3_i26];
  }

  for (c3_i27 = 0; c3_i27 < 6; c3_i27++) {
    c3_EnTheta[c3_i27] = (*c3_d_EnTheta)[c3_i27];
  }

  for (c3_i28 = 0; c3_i28 < 9; c3_i28++) {
    c3_b_Ie1[c3_i28] = chartInstance->c3_Ie1[c3_i28];
  }

  for (c3_i29 = 0; c3_i29 < 9; c3_i29++) {
    c3_b_Ie2[c3_i29] = chartInstance->c3_Ie2[c3_i29];
  }

  for (c3_i30 = 0; c3_i30 < 9; c3_i30++) {
    c3_b_Ie3[c3_i30] = chartInstance->c3_Ie3[c3_i30];
  }

  for (c3_i31 = 0; c3_i31 < 9; c3_i31++) {
    c3_b_Ie4[c3_i31] = chartInstance->c3_Ie4[c3_i31];
  }

  for (c3_i32 = 0; c3_i32 < 9; c3_i32++) {
    c3_b_Ie5[c3_i32] = chartInstance->c3_Ie5[c3_i32];
  }

  for (c3_i33 = 0; c3_i33 < 9; c3_i33++) {
    c3_b_Ie6[c3_i33] = chartInstance->c3_Ie6[c3_i33];
  }

  sf_debug_symbol_scope_push_eml(0U, 15U, 15U, c3_debug_family_names,
    c3_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(c3_c_L, 0U, c3_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c3_c_Cen, 1U, c3_f_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c3_c_Ma, 2U, c3_e_sf_marshallOut);
  ...
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie1, 7U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie2, 8U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie3, 9U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie4, 10U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie5, 11U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_b_Ie6, 12U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_M, 13U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_M_Acc, 14U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  for (c3_i34 = 0; c3_i34 < 6; c3_i34++) {
    c3_c_Ma[c3_i34] = c3_d_Ma[c3_i34];
  }

  for (c3_i35 = 0; c3_i35 < 18; c3_i35++) {
    c3_c_Cen[c3_i35] = c3_d_Cen[c3_i35];
  }

  for (c3_i36 = 0; c3_i36 < 9; c3_i36++) {
    c3_c_L[c3_i36] = c3_d_L[c3_i36];
  }
  ...
  for (c3_i38 = 0; c3_i38 < 9; c3_i38++) {
    c3_dv12[c3_i38] = c3_dv11[c3_i38];
  }

  for (c3_i39 = 0; c3_i39 < 6; c3_i39++) {
    c3_b_EnTheta[c3_i39] = c3_EnTheta[c3_i39];
  }

  for (c3_i40 = 0; c3_i40 < 18; c3_i40++) {
    c3_e_Cen[c3_i40] = c3_d_Cen[c3_i40];
  }

  for (c3_i41 = 0; c3_i41 < 6; c3_i41++) {
    c3_e_Ma[c3_i41] = c3_d_Ma[c3_i41];
  }

  for (c3_i42 = 0; c3_i42 < 9; c3_i42++) {
    c3_c_Ie1[c3_i42] = c3_b_Ie1[c3_i42];
  }

  for (c3_i43 = 0; c3_i43 < 9; c3_i43++) {
    c3_c_Ie2[c3_i43] = c3_b_Ie2[c3_i43];
  }

  for (c3_i44 = 0; c3_i44 < 9; c3_i44++) {
    c3_c_Ie3[c3_i44] = c3_b_Ie3[c3_i44];
  }

  for (c3_i45 = 0; c3_i45 < 9; c3_i45++) {
    c3_c_Ie4[c3_i45] = c3_b_Ie4[c3_i45];
  }

  for (c3_i46 = 0; c3_i46 < 9; c3_i46++) {
    c3_c_Ie5[c3_i46] = c3_b_Ie5[c3_i46];
  }

  for (c3_i47 = 0; c3_i47 < 9; c3_i47++) {
    c3_c_Ie6[c3_i47] = c3_b_Ie6[c3_i47];
  }

  c3_M_d(chartInstance, c3_dv12, c3_b_EnTheta, c3_e_Cen, c3_e_Ma, c3_c_Ie1,
         c3_c_Ie2, c3_c_Ie3, c3_c_Ie4, c3_c_Ie5, c3_c_Ie6, c3_dv13);
  for (c3_i48 = 0; c3_i48 < 36; c3_i48++) {
    c3_M[c3_i48] = c3_dv13[c3_i48];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 6);
  for (c3_i49 = 0; c3_i49 < 9; c3_i49++) {
    c3_dv14[c3_i49] = c3_dv11[c3_i49];
  }

  for (c3_i50 = 0; c3_i50 < 6; c3_i50++) {
    c3_c_EnTheta[c3_i50] = c3_EnTheta[c3_i50];
  }

  for (c3_i51 = 0; c3_i51 < 18; c3_i51++) {
    c3_f_Cen[c3_i51] = c3_d_Cen[c3_i51];
  }

  for (c3_i52 = 0; c3_i52 < 6; c3_i52++) {
    c3_f_Ma[c3_i52] = c3_d_Ma[c3_i52];
  }

  for (c3_i53 = 0; c3_i53 < 9; c3_i53++) {
    c3_d_Ie1[c3_i53] = c3_b_Ie1[c3_i53];
  }

  for (c3_i54 = 0; c3_i54 < 9; c3_i54++) {
    c3_d_Ie2[c3_i54] = c3_b_Ie2[c3_i54];
  }

  for (c3_i55 = 0; c3_i55 < 9; c3_i55++) {
    c3_d_Ie3[c3_i55] = c3_b_Ie3[c3_i55];
  }

  for (c3_i56 = 0; c3_i56 < 9; c3_i56++) {
    c3_d_Ie4[c3_i56] = c3_b_Ie4[c3_i56];
  }

  for (c3_i57 = 0; c3_i57 < 9; c3_i57++) {
    c3_d_Ie5[c3_i57] = c3_b_Ie5[c3_i57];
  }

  for (c3_i58 = 0; c3_i58 < 9; c3_i58++) {
    c3_d_Ie6[c3_i58] = c3_b_Ie6[c3_i58];
  }

  c3_M_d(chartInstance, c3_dv14, c3_c_EnTheta, c3_f_Cen, c3_f_Ma, c3_d_Ie1,
         c3_d_Ie2, c3_d_Ie3, c3_d_Ie4, c3_d_Ie5, c3_d_Ie6, c3_a);
  for (c3_i59 = 0; c3_i59 < 6; c3_i59++) {
    c3_b[c3_i59] = c3_RefAcc[c3_i59];
  }
  ...
  for (c3_i62 = 0; c3_i62 < 6; c3_i62++) {
    c3_C[c3_i62] = c3_M_Acc[c3_i62];
  }

  for (c3_i63 = 0; c3_i63 < 6; c3_i63++) {
    c3_M_Acc[c3_i63] = c3_C[c3_i63];
  }

  for (c3_i64 = 0; c3_i64 < 6; c3_i64++) {
    c3_C[c3_i64] = c3_M_Acc[c3_i64];
  }

  for (c3_i65 = 0; c3_i65 < 6; c3_i65++) {
    c3_M_Acc[c3_i65] = c3_C[c3_i65];
  }
  ...
  for (c3_i66 = 0; c3_i66 < 6; c3_i66++) {
    ...
    for (c3_i68 = 0; c3_i68 < 6; c3_i68++) {
      c3_M_Acc[c3_i66] += c3_a[c3_i67 + c3_i66] * c3_b[c3_i68];
      c3_i67 += 6;
    }
  }
  ...
  for (c3_i69 = 0; c3_i69 < 36; c3_i69++) {
    (*c3_b_M)[c3_i69] = c3_M[c3_i69];
  }

  for (c3_i70 = 0; c3_i70 < 6; c3_i70++) {
    (*c3_b_M_Acc)[c3_i70] = c3_M_Acc[c3_i70];
  }
  ...
  c3_chartNumber)
{
  _SFD_SCRIPT_TRANSLATION(c3_chartNumber, 0U, sf_debug_get_script_id(
    "E:/\xd5\xe3\xb4\xf3/\xd7\xd4\xd6\xf7\xca\xb5\xcf\xb0/InternFromZHAOTX/Fanuc/M_d.m"));
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc3_CtrPlatform_RobustControlInstanceStruct *)
    chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i71 = 0; c3_i71 < 6; c3_i71++) {
    c3_b_inData[c3_i71] = (*(real_T (*)[6])c3_inData)[c3_i71];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i74 = 0; c3_i74 < 6; c3_i74++) {
    (*(real_T (*)[6])c3_outData)[c3_i74] = c3_y[c3_i74];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i76 = 0; c3_i76 < 6; c3_i76++) {
    for (c3_i77 = 0; c3_i77 < 6; c3_i77++) {
      c3_b_inData[c3_i77 + c3_i75] = (*(real_T (*)[36])c3_inData)[c3_i77 +
        c3_i75];
    }
  ...
  for (c3_i79 = 0; c3_i79 < 6; c3_i79++) {
    for (c3_i80 = 0; c3_i80 < 6; c3_i80++) {
      c3_u[c3_i80 + c3_i78] = c3_b_inData[c3_i80 + c3_i78];
    }
  ...
  real_T c3_y[36])
{
  real_T c3_dv16[36];
  int32_T c3_i81;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv16, 1, 0, 0U, 1, 0U, 2, 6, 6);
  for (c3_i81 = 0; c3_i81 < 36; c3_i81++) {
    c3_y[c3_i81] = c3_dv16[c3_i81];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i83 = 0; c3_i83 < 6; c3_i83++) {
    for (c3_i84 = 0; c3_i84 < 6; c3_i84++) {
      (*(real_T (*)[36])c3_outData)[c3_i84 + c3_i82] = c3_y[c3_i84 + c3_i82];
    }
  ...
  *c3_inData)
{
  ...
  for (c3_i85 = 0; c3_i85 < 9; c3_i85++) {
    c3_b_inData[c3_i85] = (*(real_T (*)[9])c3_inData)[c3_i85];
  }
  ...
  real_T c3_y[9])
{
  real_T c3_dv17[9];
  int32_T c3_i87;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv17, 1, 0, 0U, 1, 0U, 2, 1, 9);
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_Ie6), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_b_Ie6);
  for (c3_i88 = 0; c3_i88 < 9; c3_i88++) {
    (*(real_T (*)[9])c3_outData)[c3_i88] = c3_y[c3_i88];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i89 = 0; c3_i89 < 6; c3_i89++) {
    c3_b_inData[c3_i89] = (*(real_T (*)[6])c3_inData)[c3_i89];
  }
  ...
  *c3_inData)
{
  ...
  chartInstance = (SFc3_CtrPlatform_RobustControlInstanceStruct *)
    chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i91 = 0; c3_i91 < 18; c3_i91++) {
    c3_b_inData[c3_i91] = (*(real_T (*)[18])c3_inData)[c3_i91];
  }

  for (c3_i92 = 0; c3_i92 < 18; c3_i92++) {
  ...
  real_T c3_y[6])
{
  real_T c3_dv18[6];
  int32_T c3_i93;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv18, 1, 0, 0U, 1, 0U, 2, 1, 6);
  for (c3_i93 = 0; c3_i93 < 6; c3_i93++) {
    c3_y[c3_i93] = c3_dv18[c3_i93];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_in4), &c3_thisId, c3_y);
  ...
  real_T c3_y[18])
{
  real_T c3_dv19[18];
  int32_T c3_i95;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv19, 1, 0, 0U, 1, 0U, 2, 1,
                18);
  for (c3_i95 = 0; c3_i95 < 18; c3_i95++) {
    c3_y[c3_i95] = c3_dv19[c3_i95];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_in3), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_in3);
  for (c3_i96 = 0; c3_i96 < 18; c3_i96++) {
    (*(real_T (*)[18])c3_outData)[c3_i96] = c3_y[c3_i96];
  }

  sf_mex_destroy(&c3_mxArrayInData);
}

const mxArray *sf_c3_CtrPlatform_RobustControl_get_eml_resolved_functions_info
  (void)
{
  ...
  for (c3_i97 = 0; c3_i97 < 31; c3_i97++) {
    c3_r0 = &c3_info[c3_i97];
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", c3_r0->context, 15,
      0U, 0U, 0U, 2, 1, strlen(c3_r0->context)), "context", "nameCaptureInfo",
                    c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", c3_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c3_r0->name)), "name", "nameCaptureInfo", c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", c3_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c3_r0->dominantType)), "dominantType",
                    "nameCaptureInfo", c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", c3_r0->resolved, 15,
      0U, 0U, 0U, 2, 1, strlen(c3_r0->resolved)), "resolved", "nameCaptureInfo",
                    c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", &c3_r0->fileTimeLo,
      7, 0U, 0U, 0U, 0), "fileTimeLo", "nameCaptureInfo", c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", &c3_r0->fileTimeHi,
      7, 0U, 0U, 0U, 0), "fileTimeHi", "nameCaptureInfo", c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", &c3_r0->mFileTimeLo,
      7, 0U, 0U, 0U, 0), "mFileTimeLo", "nameCaptureInfo", c3_i97);
    sf_mex_addfield(c3_m0, sf_mex_create("nameCaptureInfo", &c3_r0->mFileTimeHi,
      7, 0U, 0U, 0U, 0), "mFileTimeHi", "nameCaptureInfo", c3_i97);
  }
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[31])
{
  ...
  c3_info[3].resolved =
    "[EW]E:/\\xe6\\xb5\\x99\\xe5\\xa4\\xa7/\\xe8\\x87\\xaa\\xe4\\xb8\\xbb\\xe5\\xae\\x9e\\xe4\\xb9\\xa0/InternFromZHAOTX/Fanuc/M_d.m";
                   ...
                   real_T c3_M_d_[36])
{
  ...
  sf_debug_symbol_scope_push_eml(0U, 734U, 734U, c3_b_debug_family_names,
    c3_debug_family_var_map);
  sf_debug_symbol_scope_add_eml_importable(&c3_A2, 0U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_A3, 1U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_A4, 2U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_A5, 3U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_A6, 4U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx1, 5U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx2, 6U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx3, 7U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx4, 8U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx5, 9U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cx6, 10U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy1, 11U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy2, 12U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy3, 13U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy4, 14U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy5, 15U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cy6, 16U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cz2, 17U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cz3, 18U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cz4, 19U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cz5, 20U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Cz6, 21U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I1_33, 22U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_11, 23U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_12, 24U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_21, 25U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_13, 26U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_22, 27U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_31, 28U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_23, 29U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_32, 30U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I2_33, 31U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_11, 32U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_12, 33U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_21, 34U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_13, 35U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_22, 36U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_31, 37U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_23, 38U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_32, 39U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I3_33, 40U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_11, 41U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_12, 42U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_21, 43U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_13, 44U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_22, 45U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_31, 46U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_23, 47U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_32, 48U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I4_33, 49U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_11, 50U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_12, 51U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_21, 52U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_13, 53U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_22, 54U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_31, 55U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_23, 56U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_32, 57U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I5_33, 58U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_11, 59U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_12, 60U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_21, 61U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_13, 62U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_22, 63U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_31, 64U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_23, 65U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_32, 66U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_I6_33, 67U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_L1, 68U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_L2, 69U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_L3, 70U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_L4, 71U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_L5, 72U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_Ma1, 73U, c3_d_sf_marshallOut,
    c3_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3
sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in2, 724U, c3_e_sf_marshallOut,
    c3_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in3, 725U, c3_f_sf_marshallOut,
    c3_f_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in4, 726U, c3_e_sf_marshallOut,
    c3_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in5, 727U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in6, 728U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in7, 729U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in8, 730U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in9, 731U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_in10, 732U, c3_c_sf_marshallOut,
    c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_M_d_, 733U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
   ...
   *c3_b_is_active_c3_CtrPlatform_RobustControl, const char_T *c3_identifier)
{
  ...
  c3_y = c3_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_CtrPlatform_RobustControl), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_CtrPlatform_RobustControl);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_CtrPlatform_RobustControl_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(643431256U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3043667717U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2353236782U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1006587997U);
}

mxArray *sf_c3_CtrPlatform_RobustControl_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5jwiHxuFT7ztxyxsYEr1fC");
...
static const mxArray *sf_get_sim_state_info_c3_CtrPlatform_RobustControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[17],T\"M\",},{M[1],M[5],T\"M_Acc\",},{M[8],M[0],T\"is_active_c3_CtrPlatform_RobustControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_CtrPlatform_RobustControl_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"RefAcc");
          _SFD_SET_DATA_PROPS(2,1,1,0,"EnTheta");
          _SFD_SET_DATA_PROPS(3,2,0,1,"M_Acc");
...

        {
          ...
          c3_RefAcc = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
          c3_M = (real_T (*)[36])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c3_M);
          _SFD_SET_DATA_VALUE_PTR(1U, *c3_RefAcc);
          _SFD_SET_DATA_VALUE_PTR(2U, *c3_EnTheta);
          _SFD_SET_DATA_VALUE_PTR(3U, *c3_M_Acc);
          _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c3_L);
          _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c3_Cen);
          _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c3_Ma);
          _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c3_Ie1);
          _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c3_Ie2);
          _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c3_Ie3);
          _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c3_Ie4);
          _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c3_Ie5);
          _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c3_Ie6);
        }
      }
    } else {
...
{
  return "SE8AxERIQAavGmsOKnoiMC";
}

static void sf_opaque_initialize_c3_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
  initialize_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_CtrPlatform_RobustControl(void *chartInstanceVar)
{
  enable_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  disable_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  sf_c3_CtrPlatform_RobustControl((SFc3_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_CtrPlatform_RobustControl
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_CtrPlatform_RobustControl();/* state var info */
...
extern void sf_internal_set_sim_state_c3_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_CtrPlatform_RobustControl
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_CtrPlatform_RobustControl(S);
}

static void sf_opaque_set_sim_state_c3_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_CtrPlatform_RobustControl(S, st);
}

static void sf_opaque_terminate_c3_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_CtrPlatform_RobustControlInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_CtrPlatform_RobustControl
      ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_CtrPlatform_RobustControl
    ((SFc3_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_CtrPlatform_RobustControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_CtrPlatform_RobustControl
      ((SFc3_CtrPlatform_RobustControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_CtrPlatform_RobustControl(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2464170025U));
  ssSetChecksum1(S,(1227193397U));
  ssSetChecksum2(S,(1711102645U));
  ssSetChecksum3(S,(4234682898U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c3_CtrPlatform_RobustControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_CtrPlatform_RobustControl(SimStruct *S)
{
  SFc3_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc3_CtrPlatform_RobustControlInstanceStruct *)malloc(sizeof
    (SFc3_CtrPlatform_RobustControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_CtrPlatform_RobustControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_CtrPlatform_RobustControl;
...
void c3_CtrPlatform_RobustControl_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_CtrPlatform_RobustControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_CtrPlatform_RobustControl_method_dispatcher.\n"
