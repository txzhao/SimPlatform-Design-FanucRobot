...
static void initialize_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initialize_params_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void enable_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void disable_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void set_sim_state_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void sf_c5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initSimStructsc5_CtrPlatform_RobustControl
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c5_N, const char_T *c5_identifier, real_T c5_y
  [6]);
static void c5_b_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[18]);
...
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_e_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[6]);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_f_emlrt_marshallIn(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[9]);
static void c5_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_N_d(SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance,
                   real_T c5_in1[9], real_T c5_in2[6], real_T c5_in3[18], real_T
...
static uint8_T c5_h_emlrt_marshallIn
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c5_b_is_active_c5_CtrPlatform_RobustControl, const char_T *c5_identifier);
static uint8_T c5_i_emlrt_marshallIn
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
  ...
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_CtrPlatform_RobustControl = 0U;
}
  ...
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_CtrPlatform_RobustControl;
   ...
   *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_CtrPlatform_RobustControl =
    c5_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "is_active_c5_CtrPlatform_RobustControl");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_CtrPlatform_RobustControl(chartInstance);
  ...
  (SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  real_T c5_N[6];
  int32_T c5_i12;
  static real_T c5_d_Ma[6] = { 100.0, 70.0, 92.0, 22.0, 7.0, 1.0 };
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc5_CtrPlatform_RobustControlInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c5_CtrPlatform_RobustControl_get_eml_resolved_functions_info
  (void)
{
   ...
   *c5_b_is_active_c5_CtrPlatform_RobustControl, const char_T *c5_identifier)
{
  ...
  c5_y = c5_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_CtrPlatform_RobustControl), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_CtrPlatform_RobustControl);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_CtrPlatform_RobustControl_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2681907542U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1743361787U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1085328997U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1138497085U);
}

mxArray *sf_c5_CtrPlatform_RobustControl_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("eEYZCyQn7mf8LnQJmY1mV");
...
static const mxArray *sf_get_sim_state_info_c5_CtrPlatform_RobustControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"N\",},{M[8],M[0],T\"is_active_c5_CtrPlatform_RobustControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_CtrPlatform_RobustControl_get_check_sum(&mxChecksum);
...
{
  return "KUn8hrFnFntB3E3ynhPyCG";
}

static void sf_opaque_initialize_c5_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
  initialize_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_CtrPlatform_RobustControl(void *chartInstanceVar)
{
  enable_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  disable_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  sf_c5_CtrPlatform_RobustControl((SFc5_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_CtrPlatform_RobustControl
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_CtrPlatform_RobustControl();/* state var info */
...
extern void sf_internal_set_sim_state_c5_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_CtrPlatform_RobustControl
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_CtrPlatform_RobustControl(S);
}

static void sf_opaque_set_sim_state_c5_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c5_CtrPlatform_RobustControl(S, st);
}

static void sf_opaque_terminate_c5_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_CtrPlatform_RobustControlInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_CtrPlatform_RobustControl
      ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_CtrPlatform_RobustControl
    ((SFc5_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_CtrPlatform_RobustControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_CtrPlatform_RobustControl
      ((SFc5_CtrPlatform_RobustControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_CtrPlatform_RobustControl(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4095812553U));
  ssSetChecksum1(S,(2324277671U));
  ssSetChecksum2(S,(1999773898U));
  ssSetChecksum3(S,(2713063033U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c5_CtrPlatform_RobustControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_CtrPlatform_RobustControl(SimStruct *S)
{
  SFc5_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc5_CtrPlatform_RobustControlInstanceStruct *)malloc(sizeof
    (SFc5_CtrPlatform_RobustControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_CtrPlatform_RobustControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_CtrPlatform_RobustControl;
...
void c5_CtrPlatform_RobustControl_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_CtrPlatform_RobustControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_CtrPlatform_RobustControl_method_dispatcher.\n"
