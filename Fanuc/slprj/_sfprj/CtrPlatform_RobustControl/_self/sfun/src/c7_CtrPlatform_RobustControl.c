...
#include "c7_CtrPlatform_RobustControl.h"
...
static void initialize_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initialize_params_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void enable_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void disable_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void set_sim_state_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void sf_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_chartstep_c7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void initSimStructsc7_CtrPlatform_RobustControl
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_Omega, const char_T *c7_identifier, real_T
  c7_y[6]);
static void c7_b_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_d_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_e_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[36]);
...
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_f_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[16]);
...
static const mxArray *c7_g_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_g_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[6]);
...
static const mxArray *c7_h_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_h_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
static void c7_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static void c7_i_emlrt_marshallIn(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[3]);
...
static void c7_fwd_kin(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_in1[9], real_T c7_in2[6], real_T c7_gst[16]);
static void c7_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_body_Jacobian(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_in1[9], real_T c7_in2[6], real_T c7_b_body_Jacobian
  [36]);
static void c7_b_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_AdjointInv(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_g[16], real_T c7_Adg_inv[36]);
static void c7_eml_scalar_eg(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static void c7_mldivide(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_B[36], real_T c7_Y[36]);
static void c7_realmin(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static void c7_eps(SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_eml_matlab_zgetrf(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_b_A[36], int32_T c7_ipiv[6],
  int32_T *c7_info);
static void c7_c_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static int32_T c7_eml_ixamax(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, int32_T c7_n, real_T c7_x[36], int32_T c7_ix0);
static void c7_d_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance, int32_T c7_b);
static void c7_e_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_f_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance, int32_T c7_a,
   int32_T c7_b);
static void c7_eml_warning(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static void c7_eml_xtrsm(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_B[36], real_T c7_b_B[36]);
static void c7_below_threshold(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
static void c7_g_eml_int_forloop_overflow_check
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance);
static void c7_c_eml_scalar_eg(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
...
static uint8_T c7_k_emlrt_marshallIn
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c7_b_is_active_c7_CtrPlatform_RobustControl, const char_T *c7_identifier);
static uint8_T c7_l_emlrt_marshallIn
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance, const mxArray
   *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_matlab_zgetrf(SFc7_CtrPlatform_RobustControlInstanceStruct *
  chartInstance, real_T c7_A[36], int32_T c7_ipiv[6], int32_T *c7_info);
static void c7_b_eml_xtrsm(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_B[36]);
static void init_dsm_address_info(SFc7_CtrPlatform_RobustControlInstanceStruct
  *chartInstance);
  ...
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_CtrPlatform_RobustControl = 0U;
}
  ...
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_CtrPlatform_RobustControl;
   ...
   *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_CtrPlatform_RobustControl =
    c7_k_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
    "is_active_c7_CtrPlatform_RobustControl");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_CtrPlatform_RobustControl(chartInstance);
  ...
  (SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_CtrPlatform_RobustControl(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc7_CtrPlatform_RobustControlInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c7_CtrPlatform_RobustControl_get_eml_resolved_functions_info
  (void)
{
   ...
   *c7_b_is_active_c7_CtrPlatform_RobustControl, const char_T *c7_identifier)
{
  ...
  c7_y = c7_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_CtrPlatform_RobustControl), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_CtrPlatform_RobustControl);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_CtrPlatform_RobustControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_CtrPlatform_RobustControl_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_CtrPlatform_RobustControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Omega\",},{M[8],M[0],T\"is_active_c7_CtrPlatform_RobustControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_CtrPlatform_RobustControl_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
  initialize_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_CtrPlatform_RobustControl(void *chartInstanceVar)
{
  enable_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  disable_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  sf_c7_CtrPlatform_RobustControl((SFc7_CtrPlatform_RobustControlInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_CtrPlatform_RobustControl
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_CtrPlatform_RobustControl();/* state var info */
...
extern void sf_internal_set_sim_state_c7_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_CtrPlatform_RobustControl
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_CtrPlatform_RobustControl(S);
}

static void sf_opaque_set_sim_state_c7_CtrPlatform_RobustControl(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_CtrPlatform_RobustControl(S, st);
}

static void sf_opaque_terminate_c7_CtrPlatform_RobustControl(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_CtrPlatform_RobustControlInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_CtrPlatform_RobustControl
      ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_CtrPlatform_RobustControl
    ((SFc7_CtrPlatform_RobustControlInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_CtrPlatform_RobustControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_CtrPlatform_RobustControl
      ((SFc7_CtrPlatform_RobustControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_CtrPlatform_RobustControl(SimStruct *S)
{
...
static void mdlRTW_c7_CtrPlatform_RobustControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_CtrPlatform_RobustControl(SimStruct *S)
{
  SFc7_CtrPlatform_RobustControlInstanceStruct *chartInstance;
  chartInstance = (SFc7_CtrPlatform_RobustControlInstanceStruct *)malloc(sizeof
    (SFc7_CtrPlatform_RobustControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_CtrPlatform_RobustControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_CtrPlatform_RobustControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_CtrPlatform_RobustControl;
...
void c7_CtrPlatform_RobustControl_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_CtrPlatform_RobustControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_CtrPlatform_RobustControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_CtrPlatform_RobustControl_method_dispatcher.\n"
