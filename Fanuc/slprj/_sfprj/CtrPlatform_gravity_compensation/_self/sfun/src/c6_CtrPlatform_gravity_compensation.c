...
#include "CtrPlatform_gravity_compensation_sfun_debug_macros.h"
...
static void initialize_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initialize_params_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void enable_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void disable_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void set_sim_state_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_st);
static void finalize_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void sf_c6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initSimStructsc6_CtrPlatform_gravity_compensation
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
...
static void c6_emlrt_marshallIn
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_Theta, const char_T *c6_identifier, real_T c6_y[6]);
static void c6_b_emlrt_marshallIn
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[6]);
...
static void c6_f_emlrt_marshallIn
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[24]);
...
static void c6_l_emlrt_marshallIn
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, boolean_T c6_y[2]);
...
static void c6_inv_kin(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_gd[16], real_T c6_b_L[9], real_T c6_theta[24],
  real_T *c6_Num);
static void c6_cross(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                     *chartInstance, real_T c6_a[3], real_T c6_b[3], real_T
                     c6_c[3]);
static boolean_T c6_all(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, boolean_T c6_x[2]);
static void c6_mrdivide(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_A[16], real_T c6_B[16], real_T c6_y[16]);
static void c6_realmin(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c6_eps(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                   *chartInstance);
static void c6_eml_matlab_zgetrf
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c6_A[16], real_T c6_b_A[16], int32_T c6_ipiv[4], int32_T *c6_info);
static void c6_eml_int_forloop_overflow_check
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static int32_T c6_eml_ixamax(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, int32_T c6_n, real_T c6_x[16], int32_T c6_ix0);
static void c6_b_eml_int_forloop_overflow_check
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, int32_T
   c6_b);
...
static void c6_d_eml_int_forloop_overflow_check
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, int32_T
   c6_a, int32_T c6_b);
static void c6_eml_scalar_eg(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c6_eml_warning(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c6_b_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_eml_xtrsm(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_A[16], real_T c6_B[16], real_T c6_b_B[16]);
static void c6_below_threshold
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_c_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_e_eml_int_forloop_overflow_check
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_d_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static real_T c6_atan2(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_y, real_T c6_x);
static boolean_T c6_isInRange
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c6_x, real_T c6_xmin, real_T c6_xmax);
static void c6_expWre(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                      *chartInstance, real_T c6_kx[6], real_T c6_theta, real_T
                      c6_g[16]);
static void c6_eye(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                   *chartInstance, real_T c6_I[9]);
static void c6_expRot(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                      *chartInstance, real_T c6_w[3], real_T c6_theta, real_T
                      c6_R[9]);
static void c6_e_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_f_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c6_subPro3(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_kx[6], real_T c6_p[4], real_T c6_q[4], real_T c6_d[4],
  real_T c6_theta[2], real_T *c6_Nsol);
static void c6_g_eml_scalar_eg
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static real_T c6_mpower(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_a);
static real_T c6_norm(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                      *chartInstance, real_T c6_x[3]);
static void c6_eml_error(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c6_b_isInRange(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_x[2], real_T c6_xmin, real_T c6_xmax, boolean_T
  c6_isIn[2]);
static boolean_T c6_any(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, boolean_T c6_x[2]);
static real_T c6_subPro1(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_kx[6], real_T c6_p[4], real_T c6_q[4]);
static void c6_subPro2(SFc6_CtrPlatform_gravity_compensationInstanceStruct
...
static void c6_findCommon(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_w1[3], real_T c6_w2[3], real_T c6_r1[3], real_T
  c6_r2[3], real_T c6_r[3]);
static real_T c6_det(SFc6_CtrPlatform_gravity_compensationInstanceStruct
                     *chartInstance, real_T c6_x[4]);
static void c6_b_eml_matlab_zgetrf
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c6_A[4], real_T c6_b_A[4], int32_T c6_ipiv[2], int32_T *c6_info);
static void c6_eml_xger(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_alpha1, real_T c6_A[4], real_T c6_b_A[4]);
static void c6_b_eml_error(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static real_T c6_b_subPro1(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_kx[6], real_T c6_p[4], real_T c6_q[3]);
static real_T c6_c_subPro1(SFc6_CtrPlatform_gravity_compensationInstanceStruct
...
static uint8_T c6_o_emlrt_marshallIn
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c6_b_is_active_c6_CtrPlatform_gravity_compensation, const char_T
   *c6_identifier);
...
static void c6_c_eml_matlab_zgetrf
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c6_A[16], int32_T c6_ipiv[4], int32_T *c6_info);
static void c6_b_eml_xtrsm(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c6_A[16], real_T c6_B[16]);
static void c6_d_eml_matlab_zgetrf
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c6_A[4], int32_T c6_ipiv[2], int32_T *c6_info);
static void c6_b_eml_xger(SFc6_CtrPlatform_gravity_compensationInstanceStruct
  ...
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_CtrPlatform_gravity_compensation = 0U;
}
  ...
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal =
    chartInstance->c6_is_active_c6_CtrPlatform_gravity_compensation;
   ...
   mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_CtrPlatform_gravity_compensation =
    ...
    "is_active_c6_CtrPlatform_gravity_compensation");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_CtrPlatform_gravity_compensation(chartInstance);
  ...
  (SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  sf_debug_check_for_state_inconsistency
    (_CtrPlatform_gravity_compensationMachineNumber_, chartInstance->chartNumber,
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc6_CtrPlatform_gravity_compensationInstanceStruct *)
    chartInstanceVoid;
   ...
   *c6_identifier)
{
  ...
  c6_y = c6_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_CtrPlatform_gravity_compensation), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_CtrPlatform_gravity_compensation);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_CtrPlatform_gravity_compensation_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_CtrPlatform_gravity_compensation_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_CtrPlatform_gravity_compensation
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Theta\",},{M[8],M[0],T\"is_active_c6_CtrPlatform_gravity_compensation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_CtrPlatform_gravity_compensation_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_CtrPlatform_gravity_compensationMachineNumber_,
           6,
           1,
           1,
           4,
...
static void sf_opaque_initialize_c6_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
  initialize_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  enable_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  disable_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  sf_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c6_CtrPlatform_gravity_compensation(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_CtrPlatform_gravity_compensation
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c6_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c6_CtrPlatform_gravity_compensation(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_CtrPlatform_gravity_compensation(S);
}

static void sf_opaque_set_sim_state_c6_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_CtrPlatform_gravity_compensation(S, st);
}

static void sf_opaque_terminate_c6_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_CtrPlatform_gravity_compensation
      ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_CtrPlatform_gravity_compensation_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc6_CtrPlatform_gravity_compensation
    ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_CtrPlatform_gravity_compensation(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_CtrPlatform_gravity_compensation
      ((SFc6_CtrPlatform_gravity_compensationInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_CtrPlatform_gravity_compensation(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_CtrPlatform_gravity_compensation_optimization_info();
...
static void mdlRTW_c6_CtrPlatform_gravity_compensation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_CtrPlatform_gravity_compensation(SimStruct *S)
{
  SFc6_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc6_CtrPlatform_gravity_compensationInstanceStruct *)malloc
    (sizeof(SFc6_CtrPlatform_gravity_compensationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c6_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_CtrPlatform_gravity_compensation;
...
void c6_CtrPlatform_gravity_compensation_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_CtrPlatform_gravity_compensation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_CtrPlatform_gravity_compensation_method_dispatcher.\n"
