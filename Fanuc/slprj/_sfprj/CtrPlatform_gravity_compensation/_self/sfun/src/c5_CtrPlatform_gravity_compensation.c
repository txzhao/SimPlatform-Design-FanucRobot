...
static void initialize_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initialize_params_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void enable_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void disable_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void set_sim_state_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void sf_c5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initSimStructsc5_CtrPlatform_gravity_compensation
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
...
static void c5_emlrt_marshallIn
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c5_N, const char_T *c5_identifier, real_T c5_y[6]);
...
static void c5_d_emlrt_marshallIn
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[18]);
...
static void c5_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_N_d(SFc5_CtrPlatform_gravity_compensationInstanceStruct
                   *chartInstance, real_T c5_in1[9], real_T c5_in2[6], real_T
                   c5_in3[18], real_T c5_in4[6], real_T c5_g, real_T c5_N_d_[6]);
...
static uint8_T c5_h_emlrt_marshallIn
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_CtrPlatform_gravity_compensation, const char_T
   *c5_identifier);
  ...
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_CtrPlatform_gravity_compensation = 0U;
}
  ...
  (SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal =
    chartInstance->c5_is_active_c5_CtrPlatform_gravity_compensation;
   ...
   mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_CtrPlatform_gravity_compensation =
    ...
    "is_active_c5_CtrPlatform_gravity_compensation");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_CtrPlatform_gravity_compensation(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc5_CtrPlatform_gravity_compensationInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_CtrPlatform_gravity_compensation_get_eml_resolved_functions_info(void)
{
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_CtrPlatform_gravity_compensation), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_CtrPlatform_gravity_compensation);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_CtrPlatform_gravity_compensation_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_CtrPlatform_gravity_compensation_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_CtrPlatform_gravity_compensation
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"N\",},{M[8],M[0],T\"is_active_c5_CtrPlatform_gravity_compensation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_CtrPlatform_gravity_compensation_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
  initialize_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  enable_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  disable_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  sf_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_CtrPlatform_gravity_compensation(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_CtrPlatform_gravity_compensation
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c5_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_CtrPlatform_gravity_compensation(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_CtrPlatform_gravity_compensation(S);
}

static void sf_opaque_set_sim_state_c5_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_CtrPlatform_gravity_compensation(S, st);
}

static void sf_opaque_terminate_c5_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_CtrPlatform_gravity_compensation
      ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_CtrPlatform_gravity_compensation
    ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_CtrPlatform_gravity_compensation(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_CtrPlatform_gravity_compensation
      ((SFc5_CtrPlatform_gravity_compensationInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_CtrPlatform_gravity_compensation(SimStruct *S)
{
...
static void mdlRTW_c5_CtrPlatform_gravity_compensation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_CtrPlatform_gravity_compensation(SimStruct *S)
{
  SFc5_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc5_CtrPlatform_gravity_compensationInstanceStruct *)malloc
    (sizeof(SFc5_CtrPlatform_gravity_compensationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_CtrPlatform_gravity_compensation;
...
void c5_CtrPlatform_gravity_compensation_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_CtrPlatform_gravity_compensation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_CtrPlatform_gravity_compensation_method_dispatcher.\n"
