...
static void initialize_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initialize_params_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void enable_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void disable_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void set_sim_state_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void sf_c1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initSimStructsc1_CtrPlatform_gravity_compensation
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c1_Theta, const char_T *c1_identifier, real_T c1_y[6]);
...
static void c1_inv_kin(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_gd[16], real_T c1_b_L[9], real_T c1_theta[24],
  real_T *c1_Num);
static void c1_cross(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                     *chartInstance, real_T c1_a[3], real_T c1_b[3], real_T
                     c1_c[3]);
static boolean_T c1_all(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, boolean_T c1_x[2]);
static void c1_mrdivide(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16], real_T c1_y[16]);
static void c1_realmin(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c1_eps(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                   *chartInstance);
static void c1_eml_matlab_zgetrf
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4], int32_T *c1_info);
static void c1_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static int32_T c1_eml_ixamax(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static void c1_b_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, int32_T
   c1_b);
...
static void c1_d_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, int32_T
   c1_a, int32_T c1_b);
static void c1_eml_scalar_eg(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c1_eml_warning(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c1_b_eml_scalar_eg
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c1_eml_xtrsm(SFc1_CtrPlatform_gravity_compensationInstanceStruct
...
static void c1_d_eml_scalar_eg
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static real_T c1_atan2(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_y, real_T c1_x);
static boolean_T c1_isInRange
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c1_x, real_T c1_xmin, real_T c1_xmax);
static void c1_expWre(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                      *chartInstance, real_T c1_kx[6], real_T c1_theta, real_T
                      c1_g[16]);
static void c1_eye(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                   *chartInstance, real_T c1_I[9]);
static void c1_expRot(SFc1_CtrPlatform_gravity_compensationInstanceStruct
...
static void c1_f_eml_scalar_eg
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c1_subPro3(SFc1_CtrPlatform_gravity_compensationInstanceStruct
...
static void c1_g_eml_scalar_eg
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static real_T c1_mpower(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_a);
static real_T c1_norm(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                      *chartInstance, real_T c1_x[3]);
static void c1_eml_error(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static void c1_b_isInRange(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_x[2], real_T c1_xmin, real_T c1_xmax, boolean_T
  c1_isIn[2]);
static boolean_T c1_any(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, boolean_T c1_x[2]);
static real_T c1_subPro1(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_kx[6], real_T c1_p[4], real_T c1_q[4]);
static void c1_subPro2(SFc1_CtrPlatform_gravity_compensationInstanceStruct
...
static void c1_findCommon(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_w1[3], real_T c1_w2[3], real_T c1_r1[3], real_T
  c1_r2[3], real_T c1_r[3]);
static real_T c1_det(SFc1_CtrPlatform_gravity_compensationInstanceStruct
                     *chartInstance, real_T c1_x[4]);
static void c1_b_eml_matlab_zgetrf
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c1_A[4], real_T c1_b_A[4], int32_T c1_ipiv[2], int32_T *c1_info);
static void c1_eml_xger(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_alpha1, real_T c1_A[4], real_T c1_b_A[4]);
static void c1_b_eml_error(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance);
static real_T c1_b_subPro1(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_kx[6], real_T c1_p[4], real_T c1_q[3]);
static real_T c1_c_subPro1(SFc1_CtrPlatform_gravity_compensationInstanceStruct
...
static uint8_T c1_o_emlrt_marshallIn
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_CtrPlatform_gravity_compensation, const char_T
   *c1_identifier);
...
static void c1_c_eml_matlab_zgetrf
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c1_A[16], int32_T c1_ipiv[4], int32_T *c1_info);
static void c1_b_eml_xtrsm(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16]);
static void c1_d_eml_matlab_zgetrf
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c1_A[4], int32_T c1_ipiv[2], int32_T *c1_info);
static void c1_b_eml_xger(SFc1_CtrPlatform_gravity_compensationInstanceStruct
  ...
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_CtrPlatform_gravity_compensation = 0U;
}
  ...
  (SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal =
    chartInstance->c1_is_active_c1_CtrPlatform_gravity_compensation;
   ...
   mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_CtrPlatform_gravity_compensation =
    ...
    "is_active_c1_CtrPlatform_gravity_compensation");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_CtrPlatform_gravity_compensation(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc1_CtrPlatform_gravity_compensationInstanceStruct *)
    chartInstanceVoid;
   ...
   *c1_identifier)
{
  ...
  c1_y = c1_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_CtrPlatform_gravity_compensation), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_CtrPlatform_gravity_compensation);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_CtrPlatform_gravity_compensation_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_CtrPlatform_gravity_compensation_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_CtrPlatform_gravity_compensation
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Theta\",},{M[8],M[0],T\"is_active_c1_CtrPlatform_gravity_compensation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_CtrPlatform_gravity_compensation_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
  initialize_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  enable_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  disable_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  sf_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_CtrPlatform_gravity_compensation(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_CtrPlatform_gravity_compensation
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c1_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_CtrPlatform_gravity_compensation(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_CtrPlatform_gravity_compensation(S);
}

static void sf_opaque_set_sim_state_c1_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_CtrPlatform_gravity_compensation(S, st);
}

static void sf_opaque_terminate_c1_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_CtrPlatform_gravity_compensation
      ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_CtrPlatform_gravity_compensation
    ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_CtrPlatform_gravity_compensation(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_CtrPlatform_gravity_compensation
      ((SFc1_CtrPlatform_gravity_compensationInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_CtrPlatform_gravity_compensation(SimStruct *S)
{
...
static void mdlRTW_c1_CtrPlatform_gravity_compensation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_CtrPlatform_gravity_compensation(SimStruct *S)
{
  SFc1_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc1_CtrPlatform_gravity_compensationInstanceStruct *)malloc
    (sizeof(SFc1_CtrPlatform_gravity_compensationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_CtrPlatform_gravity_compensation;
...
void c1_CtrPlatform_gravity_compensation_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_CtrPlatform_gravity_compensation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_CtrPlatform_gravity_compensation_method_dispatcher.\n"
