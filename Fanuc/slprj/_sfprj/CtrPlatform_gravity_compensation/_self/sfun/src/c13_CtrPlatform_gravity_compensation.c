...
static void initialize_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initialize_params_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void enable_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void disable_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void set_sim_state_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_st);
static void finalize_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void sf_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c13_chartstep_c13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initSimStructsc13_CtrPlatform_gravity_compensation
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_EndVel, const char_T *c13_identifier, real_T c13_y[3]);
static void c13_b_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
...
static void c13_c_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[9]);
...
static void c13_e_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[16]);
static void c13_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static void c13_f_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[6]);
...
static void c13_g_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[36]);
...
static void c13_spat_Jacobian
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, real_T
   c13_in1[9], real_T c13_in2[6], real_T c13_b_spat_Jacobian[36]);
static real_T c13_power(SFc13_CtrPlatform_gravity_compensationInstanceStruct
  *chartInstance, real_T c13_a);
static void c13_eml_int_forloop_overflow_check
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c13_eml_scalar_eg
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c13_fwd_kin(SFc13_CtrPlatform_gravity_compensationInstanceStruct
...
static uint8_T c13_j_emlrt_marshallIn
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c13_b_is_active_c13_CtrPlatform_gravity_compensation, const char_T
   *c13_identifier);
  ...
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_CtrPlatform_gravity_compensation = 0U;
}
  ...
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal =
    chartInstance->c13_is_active_c13_CtrPlatform_gravity_compensation;
   ...
   mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_CtrPlatform_gravity_compensation =
    ...
    "is_active_c13_CtrPlatform_gravity_compensation");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_CtrPlatform_gravity_compensation(chartInstance);
  ...
  (SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_sfEvent = CALL_EVENT;
  c13_chartstep_c13_CtrPlatform_gravity_compensation(chartInstance);
  ...
  c13_chartNumber)
{
  _SFD_SCRIPT_TRANSLATION(c13_chartNumber, 0U, sf_debug_get_script_id(
    "E:/\xd5\xe3\xb4\xf3/\xd7\xd4\xd6\xf7\xca\xb5\xcf\xb0/Dynamics_DaiDan/Fanuc/spat_Jacobian.m"));
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc13_CtrPlatform_gravity_compensationInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c13_CtrPlatform_gravity_compensation_get_eml_resolved_functions_info(void)
{
...
static void c13_info_helper(c13_ResolvedFunctionInfo c13_info[34])
{
  ...
  c13_info[0].resolved =
    "[EW]E:/\\xe6\\xb5\\x99\\xe5\\xa4\\xa7/\\xe8\\x87\\xaa\\xe4\\xb8\\xbb\\xe5\\xae\\x9e\\xe4\\xb9\\xa0/Dynamics_DaiDan/Fanuc/spat_Jacobian.m";
   ...
   *c13_identifier)
{
  ...
  c13_y = c13_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_CtrPlatform_gravity_compensation), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_CtrPlatform_gravity_compensation);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_CtrPlatform_gravity_compensation_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_CtrPlatform_gravity_compensation_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_CtrPlatform_gravity_compensation
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c13_CtrPlatform_gravity_compensation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_CtrPlatform_gravity_compensation_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
  initialize_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  enable_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  disable_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  sf_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c13_CtrPlatform_gravity_compensation(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c13_CtrPlatform_gravity_compensation();/* state var info */
...
extern void sf_internal_set_sim_state_c13_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c13_CtrPlatform_gravity_compensation(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_CtrPlatform_gravity_compensation(S);
}

static void sf_opaque_set_sim_state_c13_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_CtrPlatform_gravity_compensation(S, st);
}

static void sf_opaque_terminate_c13_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_CtrPlatform_gravity_compensation
      ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_CtrPlatform_gravity_compensation
    ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_CtrPlatform_gravity_compensation(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_CtrPlatform_gravity_compensation
      ((SFc13_CtrPlatform_gravity_compensationInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_CtrPlatform_gravity_compensation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(364012926U));
  ssSetChecksum1(S,(3002992773U));
  ssSetChecksum2(S,(781628587U));
  ssSetChecksum3(S,(135381955U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c13_CtrPlatform_gravity_compensation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_CtrPlatform_gravity_compensation(SimStruct *S)
{
  SFc13_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc13_CtrPlatform_gravity_compensationInstanceStruct *)malloc
    (sizeof(SFc13_CtrPlatform_gravity_compensationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c13_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_CtrPlatform_gravity_compensation;
...
void c13_CtrPlatform_gravity_compensation_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_CtrPlatform_gravity_compensation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_CtrPlatform_gravity_compensation_method_dispatcher.\n"
