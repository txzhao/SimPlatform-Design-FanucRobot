...
static void initialize_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initialize_params_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void enable_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void disable_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void set_sim_state_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c12_st);
static void finalize_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void sf_c12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
static void initSimStructsc12_CtrPlatform_gravity_compensation
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance);
...
static void c12_emlrt_marshallIn
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c12_EndPos, const char_T *c12_identifier, real_T c12_y[3]);
...
static void c12_e_emlrt_marshallIn
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[16]);
...
static void c12_f_emlrt_marshallIn
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, real_T c12_y[6]);
...
static void c12_fwd_kin(SFc12_CtrPlatform_gravity_compensationInstanceStruct
...
static uint8_T c12_h_emlrt_marshallIn
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance, const
   mxArray *c12_b_is_active_c12_CtrPlatform_gravity_compensation, const char_T
   *c12_identifier);
  ...
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_CtrPlatform_gravity_compensation = 0U;
}
  ...
  (SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal =
    chartInstance->c12_is_active_c12_CtrPlatform_gravity_compensation;
   ...
   mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_CtrPlatform_gravity_compensation =
    ...
    "is_active_c12_CtrPlatform_gravity_compensation");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_CtrPlatform_gravity_compensation(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc12_CtrPlatform_gravity_compensationInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c12_CtrPlatform_gravity_compensation_get_eml_resolved_functions_info(void)
{
   ...
   *c12_identifier)
{
  ...
  c12_y = c12_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_CtrPlatform_gravity_compensation), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_CtrPlatform_gravity_compensation);
  return c12_y;
}
...
/* SFunction Glue Code */
void sf_c12_CtrPlatform_gravity_compensation_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_CtrPlatform_gravity_compensation_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_CtrPlatform_gravity_compensation
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c12_CtrPlatform_gravity_compensation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_CtrPlatform_gravity_compensation_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c12_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
  initialize_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  enable_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  disable_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  sf_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c12_CtrPlatform_gravity_compensation(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c12_CtrPlatform_gravity_compensation();/* state var info */
...
extern void sf_internal_set_sim_state_c12_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c12_CtrPlatform_gravity_compensation(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_CtrPlatform_gravity_compensation(S);
}

static void sf_opaque_set_sim_state_c12_CtrPlatform_gravity_compensation
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c12_CtrPlatform_gravity_compensation(S, st);
}

static void sf_opaque_terminate_c12_CtrPlatform_gravity_compensation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c12_CtrPlatform_gravity_compensation
      ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_CtrPlatform_gravity_compensation
    ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_CtrPlatform_gravity_compensation(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_CtrPlatform_gravity_compensation
      ((SFc12_CtrPlatform_gravity_compensationInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_CtrPlatform_gravity_compensation(SimStruct *S)
{
...
static void mdlRTW_c12_CtrPlatform_gravity_compensation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_CtrPlatform_gravity_compensation(SimStruct *S)
{
  SFc12_CtrPlatform_gravity_compensationInstanceStruct *chartInstance;
  chartInstance = (SFc12_CtrPlatform_gravity_compensationInstanceStruct *)malloc
    (sizeof(SFc12_CtrPlatform_gravity_compensationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c12_CtrPlatform_gravity_compensation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_CtrPlatform_gravity_compensation;
...
void c12_CtrPlatform_gravity_compensation_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_CtrPlatform_gravity_compensation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_CtrPlatform_gravity_compensation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_CtrPlatform_gravity_compensation_method_dispatcher.\n"
