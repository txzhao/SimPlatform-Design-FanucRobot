...
static void initialize_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void initialize_params_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void enable_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void disable_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void set_sim_state_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void sf_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void c7_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c7_EurlerDynJointVerifyIdn
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static void c7_spat_Jacobian(SFc7_EurlerDynJointVerifyIdnInstanceStruct
  *chartInstance, real_T c7_in1[9], real_T c7_in2[6], real_T c7_b_spat_Jacobian
  [36]);
static void c7_eml_scalar_eg(SFc7_EurlerDynJointVerifyIdnInstanceStruct
  *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_EurlerDynJointVerifyIdnInstanceStruct
  *chartInstance);
static void c7_fwd_kin(SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance,
...
static void c7_emlrt_marshallIn(SFc7_EurlerDynJointVerifyIdnInstanceStruct
  *chartInstance, const mxArray *c7_EndVel, const char_T *c7_name, real_T c7_y[3]);
static uint8_T c7_b_emlrt_marshallIn(SFc7_EurlerDynJointVerifyIdnInstanceStruct *
  chartInstance, const mxArray *c7_b_is_active_c7_EurlerDynJointVerifyIdn, const
  char_T *c7_name);
static void init_dsm_address_info(SFc7_EurlerDynJointVerifyIdnInstanceStruct
  *chartInstance);
  ...
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_EurlerDynJointVerifyIdn = 0U;
}
  ...
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_EurlerDynJointVerifyIdn;
   ...
   )
{
  ...
  chartInstance->c7_is_active_c7_EurlerDynJointVerifyIdn = c7_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_EurlerDynJointVerifyIdn");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_EurlerDynJointVerifyIdn(chartInstance);
  ...
  (SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance)
{
  ...
  c7_c7_EurlerDynJointVerifyIdn(chartInstance);
...
static void c7_fwd_kin(SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance,
  real_T c7_in1[9], real_T c7_in2[6], real_T c7_gst[
  16])
{
...
static const mxArray *c7_sf_marshall(void *chartInstanceVoid, void *c7_u)
{
  ...
  const mxArray *c7_b_y = NULL;
  SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance;
  chartInstance = (SFc7_EurlerDynJointVerifyIdnInstanceStruct *)
    chartInstanceVoid;
  c7_y = NULL;
...
const mxArray *sf_c7_EurlerDynJointVerifyIdn_get_eml_resolved_functions_info
  (void)
{
...
static uint8_T c7_b_emlrt_marshallIn(SFc7_EurlerDynJointVerifyIdnInstanceStruct *
  ...
  c7_b_is_active_c7_EurlerDynJointVerifyIdn, const char_T *c7_name)
{
  uint8_T c7_y;
  uint8_T c7_u0;
  sf_mex_import(c7_name, sf_mex_dup(c7_b_is_active_c7_EurlerDynJointVerifyIdn),
                &c7_u0, 1, 3, 0U, 0, 0U, 0);
  c7_y = c7_u0;
  sf_mex_destroy(&c7_b_is_active_c7_EurlerDynJointVerifyIdn);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_EurlerDynJointVerifyIdn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_EurlerDynJointVerifyIdn_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c7_EurlerDynJointVerifyIdn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c7_EurlerDynJointVerifyIdn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_EurlerDynJointVerifyIdn_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_EurlerDynJointVerifyIdn(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_EurlerDynJointVerifyIdn
    ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*) chartInstanceVar);
  initialize_c7_EurlerDynJointVerifyIdn
    ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_EurlerDynJointVerifyIdn(void *chartInstanceVar)
{
  enable_c7_EurlerDynJointVerifyIdn((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_EurlerDynJointVerifyIdn(void *chartInstanceVar)
{
  disable_c7_EurlerDynJointVerifyIdn((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_EurlerDynJointVerifyIdn(void *chartInstanceVar)
{
  sf_c7_EurlerDynJointVerifyIdn((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c7_EurlerDynJointVerifyIdn(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_EurlerDynJointVerifyIdn
    ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c7_EurlerDynJointVerifyIdn();/* state var info */
...
static void sf_internal_set_sim_state_c7_EurlerDynJointVerifyIdn(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_EurlerDynJointVerifyIdn();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c7_EurlerDynJointVerifyIdn
    ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c7_EurlerDynJointVerifyIdn(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_EurlerDynJointVerifyIdn(S);
}

static void sf_opaque_set_sim_state_c7_EurlerDynJointVerifyIdn(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_EurlerDynJointVerifyIdn(S, st);
}

static void sf_opaque_terminate_c7_EurlerDynJointVerifyIdn(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_EurlerDynJointVerifyIdn
      ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c7_EurlerDynJointVerifyIdn
    ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_EurlerDynJointVerifyIdn(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_EurlerDynJointVerifyIdn
      ((SFc7_EurlerDynJointVerifyIdnInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_EurlerDynJointVerifyIdn(SimStruct *S)
{
...
static void mdlRTW_c7_EurlerDynJointVerifyIdn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_EurlerDynJointVerifyIdn(SimStruct *S)
{
  SFc7_EurlerDynJointVerifyIdnInstanceStruct *chartInstance;
  chartInstance = (SFc7_EurlerDynJointVerifyIdnInstanceStruct *)malloc(sizeof
    (SFc7_EurlerDynJointVerifyIdnInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_EurlerDynJointVerifyIdnInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_EurlerDynJointVerifyIdn;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_EurlerDynJointVerifyIdn;
...
void c7_EurlerDynJointVerifyIdn_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_EurlerDynJointVerifyIdn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_EurlerDynJointVerifyIdn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_EurlerDynJointVerifyIdn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_EurlerDynJointVerifyIdn_method_dispatcher.\n"
