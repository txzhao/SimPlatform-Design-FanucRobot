...
static void initialize_c5_DynJointCon(SFc5_DynJointConInstanceStruct
  *chartInstance);
static void initialize_params_c5_DynJointCon(SFc5_DynJointConInstanceStruct
  *chartInstance);
static void enable_c5_DynJointCon(SFc5_DynJointConInstanceStruct *chartInstance);
static void disable_c5_DynJointCon(SFc5_DynJointConInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_DynJointCon
  (SFc5_DynJointConInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_DynJointCon
  (SFc5_DynJointConInstanceStruct *chartInstance);
static void set_sim_state_c5_DynJointCon(SFc5_DynJointConInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_DynJointCon(SFc5_DynJointConInstanceStruct
  *chartInstance);
static void sf_c5_DynJointCon(SFc5_DynJointConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c5_DynJointCon
  (SFc5_DynJointConInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static void c5_N_d(SFc5_DynJointConInstanceStruct *chartInstance, real_T c5_in1
...
static void c5_emlrt_marshallIn(SFc5_DynJointConInstanceStruct *chartInstance,
  const mxArray *c5_N, const char_T *c5_name, real_T c5_y[6]);
static uint8_T c5_b_emlrt_marshallIn(SFc5_DynJointConInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_DynJointCon, const char_T
  *c5_name);
static void init_dsm_address_info(SFc5_DynJointConInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_DynJointCon = 0U;
}
  ...
  (SFc5_DynJointConInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_DynJointCon;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_DynJointCon = c5_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_DynJointCon");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_DynJointCon(chartInstance);
...
static void c5_N_d(SFc5_DynJointConInstanceStruct *chartInstance, real_T c5_in1
                   [9], real_T c5_in2[6], real_T c5_in3[18], real_T
...
static const mxArray *c5_sf_marshall(void *chartInstanceVoid, void *c5_u)
{
  ...
  const mxArray *c5_b_y = NULL;
  SFc5_DynJointConInstanceStruct *chartInstance;
  chartInstance = (SFc5_DynJointConInstanceStruct *)chartInstanceVoid;
  c5_y = NULL;
...
const mxArray *sf_c5_DynJointCon_get_eml_resolved_functions_info(void)
{
...
static uint8_T c5_b_emlrt_marshallIn(SFc5_DynJointConInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_DynJointCon,
  const char_T *c5_name)
{
  uint8_T c5_y;
  uint8_T c5_u0;
  sf_mex_import(c5_name, sf_mex_dup(c5_b_is_active_c5_DynJointCon), &c5_u0, 1, 3,
                0U, 0, 0U, 0);
  c5_y = c5_u0;
  sf_mex_destroy(&c5_b_is_active_c5_DynJointCon);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_DynJointCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_DynJointCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c5_DynJointCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"N\",},{M[8],M[0],T\"is_active_c5_DynJointCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_DynJointCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_DynJointConInstanceStruct *chartInstance;
    chartInstance = (SFc5_DynJointConInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_DynJointCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_DynJointConInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c5_DynJointCon((SFc5_DynJointConInstanceStruct*)
    chartInstanceVar);
  initialize_c5_DynJointCon((SFc5_DynJointConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_DynJointCon(void *chartInstanceVar)
{
  enable_c5_DynJointCon((SFc5_DynJointConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_DynJointCon(void *chartInstanceVar)
{
  disable_c5_DynJointCon((SFc5_DynJointConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_DynJointCon(void *chartInstanceVar)
{
  sf_c5_DynJointCon((SFc5_DynJointConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c5_DynJointCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_DynJointCon
    ((SFc5_DynJointConInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c5_DynJointCon();/* state var info */
...
static void sf_internal_set_sim_state_c5_DynJointCon(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_DynJointCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c5_DynJointCon((SFc5_DynJointConInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c5_DynJointCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_DynJointCon(S);
}

static void sf_opaque_set_sim_state_c5_DynJointCon(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c5_DynJointCon(S, st);
}

static void sf_opaque_terminate_c5_DynJointCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_DynJointConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_DynJointCon((SFc5_DynJointConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c5_DynJointCon((SFc5_DynJointConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_DynJointCon(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_DynJointCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynJointCon","DynJointCon",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynJointCon","DynJointCon",5,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynJointCon",
      "DynJointCon",5,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynJointCon","DynJointCon",5,1);
      sf_mark_chart_reusable_outputs(S,"DynJointCon","DynJointCon",5,1);
    }

    sf_set_rtw_dwork_info(S,"DynJointCon","DynJointCon",5);
...
static void mdlRTW_c5_DynJointCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynJointCon", "DynJointCon",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_DynJointCon(SimStruct *S)
{
  SFc5_DynJointConInstanceStruct *chartInstance;
  chartInstance = (SFc5_DynJointConInstanceStruct *)malloc(sizeof
    (SFc5_DynJointConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_DynJointConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_DynJointCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_DynJointCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_DynJointCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_DynJointCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_DynJointCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_DynJointCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_DynJointCon;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_DynJointCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_DynJointCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_DynJointCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_DynJointCon;
...
void c5_DynJointCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_DynJointCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_DynJointCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_DynJointCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_DynJointCon_method_dispatcher.\n"
