...
static void initialize_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void initialize_params_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void enable_c2_DynEulerJointVerify(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void disable_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void set_sim_state_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void sf_c2_DynEulerJointVerify(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c2_DynEulerJointVerify
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static void c2_inv_kin(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_gd[16], real_T c2_b_L[9], real_T c2_theta[24], real_T *c2_Num);
static void c2_cross(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
                     real_T c2_a[3], real_T c2_b[3], real_T c2_c[3]);
static boolean_T c2_all(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  boolean_T c2_x[2]);
static void c2_mrdivide(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_A[16], real_T c2_B[16], real_T c2_y[16]);
static real_T c2_power(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_b);
static void c2_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c2_eml_error(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_eps(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c2_A[16], real_T c2_b_A[16], int32_T c2_ipiv[4],
  int32_T *c2_info);
static int32_T c2_eml_ixamax(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[16], int32_T c2_ix0);
static int32_T c2_ceval_ixamax(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[16], int32_T c2_ix0, int32_T c2_incx);
static void c2_ceval_xswap(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[16], int32_T c2_ix0, int32_T c2_incx, int32_T c2_iy0,
  int32_T c2_incy, real_T c2_b_x[16]);
static void c2_ceval_xger(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
...
static void c2_eml_warning(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c2_eml_xtrsm(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_A[16], real_T c2_B[16], real_T c2_b_B[16]);
static void c2_c_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c2_eml_blas_xtrsm(SFc2_DynEulerJointVerifyInstanceStruct
...
static void c2_d_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static real_T c2_atan2(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_y, real_T c2_x);
static boolean_T c2_isInRange(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c2_x, real_T c2_xmin, real_T c2_xmax);
static void c2_expWre(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c2_kx[6], real_T c2_theta, real_T c2_g[16]);
static real_T c2_length(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_eye(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance, real_T
                   c2_I[9]);
static void c2_expRot(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c2_w[3], real_T c2_theta, real_T c2_R[9]);
static void c2_e_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c2_f_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c2_subPro3(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_kx[6], real_T c2_p[4], real_T c2_q[4], real_T c2_d[4], real_T
  c2_theta[2], real_T *c2_Nsol);
static void c2_g_eml_scalar_eg(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static real_T c2_ceval_xdot(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[3], int32_T c2_ix0, int32_T c2_incx,
  real_T c2_y[3], int32_T c2_iy0, int32_T c2_incy);
static real_T c2_mpower(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_a);
static real_T c2_norm(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c2_x[3]);
static real_T c2_ceval_xnrm2(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[3], int32_T c2_ix0, int32_T c2_incx);
static void c2_b_eml_error(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c2_b_isInRange(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_x[2], real_T c2_xmin, real_T c2_xmax, boolean_T c2_isIn[2]);
static boolean_T c2_any(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  boolean_T c2_x[2]);
static real_T c2_subPro1(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_kx[6], real_T c2_p[4], real_T c2_q[4]);
static void c2_subPro2(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_kx1[6], real_T c2_kx2[6], real_T c2_p[4], real_T c2_q[4], real_T
  c2_theta1[2], real_T c2_theta2[2], real_T *c2_Nsol);
static void c2_findCommon(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_w1[3], real_T c2_w2[3], real_T c2_r1[3], real_T c2_r2[3], real_T
  c2_r[3]);
static real_T c2_det(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
                     real_T c2_x[4]);
static void c2_b_eml_matlab_zgetrf(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c2_A[4], real_T c2_b_A[4], int32_T c2_ipiv[2], int32_T *
  c2_info);
static int32_T c2_b_eml_ixamax(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c2_x[4]);
static int32_T c2_b_ceval_ixamax(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[4], int32_T c2_ix0, int32_T c2_incx);
static void c2_b_ceval_xswap(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[4], int32_T c2_ix0, int32_T c2_incx,
  int32_T c2_iy0, int32_T c2_incy, real_T c2_b_x[4]);
static void c2_b_ceval_xger(SFc2_DynEulerJointVerifyInstanceStruct
...
static void c2_c_eml_error(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance);
static real_T c2_b_subPro1(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c2_kx[6], real_T c2_p[4], real_T c2_q[3]);
static real_T c2_c_subPro1(SFc2_DynEulerJointVerifyInstanceStruct *chartInstance,
...
static void c2_emlrt_marshallIn(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *c2_theta, const char_T *c2_name, real_T c2_y[6]);
static uint8_T c2_b_emlrt_marshallIn(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_DynEulerJointVerify, const
  char_T *c2_name);
static void init_dsm_address_info(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance);
  ...
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DynEulerJointVerify = 0U;
}
  ...
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_DynEulerJointVerify;
  ...
  (SFc2_DynEulerJointVerifyInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_DynEulerJointVerify = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_DynEulerJointVerify");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DynEulerJointVerify(chartInstance);
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_DynEulerJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc2_DynEulerJointVerifyInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
...
const mxArray *sf_c2_DynEulerJointVerify_get_eml_resolved_functions_info(void)
{
...
static uint8_T c2_b_emlrt_marshallIn(SFc2_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *
  c2_b_is_active_c2_DynEulerJointVerify, const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u0;
  sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_DynEulerJointVerify),
                &c2_u0, 1, 3, 0U, 0, 0U, 0);
  c2_y = c2_u0;
  sf_mex_destroy(&c2_b_is_active_c2_DynEulerJointVerify);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_DynEulerJointVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_DynEulerJointVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_DynEulerJointVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta\",},{M[8],M[0],T\"is_active_c2_DynEulerJointVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DynEulerJointVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_DynEulerJointVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc2_DynEulerJointVerifyInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c2_DynEulerJointVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_DynEulerJointVerify
    ((SFc2_DynEulerJointVerifyInstanceStruct*) chartInstanceVar);
  initialize_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_DynEulerJointVerify(void *chartInstanceVar)
{
  enable_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_DynEulerJointVerify(void *chartInstanceVar)
{
  disable_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_DynEulerJointVerify(void *chartInstanceVar)
{
  sf_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_DynEulerJointVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_DynEulerJointVerify
    ((SFc2_DynEulerJointVerifyInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_DynEulerJointVerify();/* state var info */
...
static void sf_internal_set_sim_state_c2_DynEulerJointVerify(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_DynEulerJointVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_DynEulerJointVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_DynEulerJointVerify(S);
}

static void sf_opaque_set_sim_state_c2_DynEulerJointVerify(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_DynEulerJointVerify(S, st);
}

static void sf_opaque_terminate_c2_DynEulerJointVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DynEulerJointVerifyInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_DynEulerJointVerify((SFc2_DynEulerJointVerifyInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c2_DynEulerJointVerify
    ((SFc2_DynEulerJointVerifyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DynEulerJointVerify(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_DynEulerJointVerify
      ((SFc2_DynEulerJointVerifyInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DynEulerJointVerify(SimStruct *S)
{
...
static void mdlRTW_c2_DynEulerJointVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynEulerJointVerify", "DynEulerJointVerify",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_DynEulerJointVerify(SimStruct *S)
{
  SFc2_DynEulerJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc2_DynEulerJointVerifyInstanceStruct *)malloc(sizeof
    (SFc2_DynEulerJointVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_DynEulerJointVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_DynEulerJointVerify;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_DynEulerJointVerify;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_DynEulerJointVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_DynEulerJointVerify;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_DynEulerJointVerify;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_DynEulerJointVerify;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_DynEulerJointVerify;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_DynEulerJointVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DynEulerJointVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DynEulerJointVerify;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_DynEulerJointVerify;
...
void c2_DynEulerJointVerify_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DynEulerJointVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DynEulerJointVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DynEulerJointVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DynEulerJointVerify_method_dispatcher.\n"
