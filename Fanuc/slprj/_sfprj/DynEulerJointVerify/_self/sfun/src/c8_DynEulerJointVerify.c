...
static void initialize_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void initialize_params_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void enable_c8_DynEulerJointVerify(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void disable_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void set_sim_state_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void sf_c8_DynEulerJointVerify(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c8_DynEulerJointVerify
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static void c8_inv_kin(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_gd[16], real_T c8_b_L[9], real_T c8_theta[24], real_T *c8_Num);
static void c8_cross(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
                     real_T c8_a[3], real_T c8_b[3], real_T c8_c[3]);
static boolean_T c8_all(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  boolean_T c8_x[2]);
static void c8_mrdivide(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_A[16], real_T c8_B[16], real_T c8_y[16]);
static real_T c8_power(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_a, real_T c8_b);
static void c8_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c8_eml_error(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_eps(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_eml_matlab_zgetrf(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c8_A[16], real_T c8_b_A[16], int32_T c8_ipiv[4],
  int32_T *c8_info);
static int32_T c8_eml_ixamax(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[16], int32_T c8_ix0);
static int32_T c8_ceval_ixamax(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[16], int32_T c8_ix0, int32_T c8_incx);
static void c8_ceval_xswap(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  int32_T c8_n, real_T c8_x[16], int32_T c8_ix0, int32_T c8_incx, int32_T c8_iy0,
  int32_T c8_incy, real_T c8_b_x[16]);
static void c8_ceval_xger(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
...
static void c8_eml_warning(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_b_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c8_eml_xtrsm(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_A[16], real_T c8_B[16], real_T c8_b_B[16]);
static void c8_c_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c8_eml_blas_xtrsm(SFc8_DynEulerJointVerifyInstanceStruct
...
static void c8_d_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static real_T c8_atan2(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_y, real_T c8_x);
static boolean_T c8_isInRange(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c8_x, real_T c8_xmin, real_T c8_xmax);
static void c8_expWre(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c8_kx[6], real_T c8_theta, real_T c8_g[16]);
static real_T c8_length(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_eye(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance, real_T
                   c8_I[9]);
static void c8_expRot(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c8_w[3], real_T c8_theta, real_T c8_R[9]);
static void c8_e_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c8_f_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static void c8_subPro3(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_kx[6], real_T c8_p[4], real_T c8_q[4], real_T c8_d[4], real_T
  c8_theta[2], real_T *c8_Nsol);
static void c8_g_eml_scalar_eg(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
static real_T c8_ceval_xdot(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[3], int32_T c8_ix0, int32_T c8_incx,
  real_T c8_y[3], int32_T c8_iy0, int32_T c8_incy);
static real_T c8_mpower(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_a);
static real_T c8_norm(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
                      real_T c8_x[3]);
static real_T c8_ceval_xnrm2(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[3], int32_T c8_ix0, int32_T c8_incx);
static void c8_b_eml_error(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static void c8_b_isInRange(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_x[2], real_T c8_xmin, real_T c8_xmax, boolean_T c8_isIn[2]);
static boolean_T c8_any(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  boolean_T c8_x[2]);
static real_T c8_subPro1(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_kx[6], real_T c8_p[4], real_T c8_q[4]);
static void c8_subPro2(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_kx1[6], real_T c8_kx2[6], real_T c8_p[4], real_T c8_q[4], real_T
  c8_theta1[2], real_T c8_theta2[2], real_T *c8_Nsol);
static void c8_findCommon(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_w1[3], real_T c8_w2[3], real_T c8_r1[3], real_T c8_r2[3], real_T
  c8_r[3]);
static real_T c8_det(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
                     real_T c8_x[4]);
static void c8_b_eml_matlab_zgetrf(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c8_A[4], real_T c8_b_A[4], int32_T c8_ipiv[2], int32_T *
  c8_info);
static int32_T c8_b_eml_ixamax(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, real_T c8_x[4]);
static int32_T c8_b_ceval_ixamax(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[4], int32_T c8_ix0, int32_T c8_incx);
static void c8_b_ceval_xswap(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, int32_T c8_n, real_T c8_x[4], int32_T c8_ix0, int32_T c8_incx,
  int32_T c8_iy0, int32_T c8_incy, real_T c8_b_x[4]);
static void c8_b_ceval_xger(SFc8_DynEulerJointVerifyInstanceStruct
...
static void c8_c_eml_error(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance);
static real_T c8_b_subPro1(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_kx[6], real_T c8_p[4], real_T c8_q[3]);
static real_T c8_c_subPro1(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
...
static void c8_emlrt_marshallIn(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *c8_theta, const char_T *c8_name, real_T c8_y[6]);
static uint8_T c8_b_emlrt_marshallIn(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_DynEulerJointVerify, const
  char_T *c8_name);
static void init_dsm_address_info(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance);
  ...
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_DynEulerJointVerify = 0U;
}
  ...
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal = chartInstance->c8_is_active_c8_DynEulerJointVerify;
  ...
  (SFc8_DynEulerJointVerifyInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_DynEulerJointVerify = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_DynEulerJointVerify");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_DynEulerJointVerify(chartInstance);
...
static void c8_inv_kin(SFc8_DynEulerJointVerifyInstanceStruct *chartInstance,
  real_T c8_gd[16], real_T c8_b_L[9], real_T c8_theta[24
  ], real_T *c8_Num)
{
...
static const mxArray *c8_sf_marshall(void *chartInstanceVoid, void *c8_u)
{
  ...
  const mxArray *c8_b_y = NULL;
  SFc8_DynEulerJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc8_DynEulerJointVerifyInstanceStruct *)chartInstanceVoid;
  c8_y = NULL;
...
const mxArray *sf_c8_DynEulerJointVerify_get_eml_resolved_functions_info(void)
{
...
static uint8_T c8_b_emlrt_marshallIn(SFc8_DynEulerJointVerifyInstanceStruct
  *chartInstance, const mxArray *
  c8_b_is_active_c8_DynEulerJointVerify, const char_T *c8_name)
{
  uint8_T c8_y;
  uint8_T c8_u0;
  sf_mex_import(c8_name, sf_mex_dup(c8_b_is_active_c8_DynEulerJointVerify),
                &c8_u0, 1, 3, 0U, 0, 0U, 0);
  c8_y = c8_u0;
  sf_mex_destroy(&c8_b_is_active_c8_DynEulerJointVerify);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_DynEulerJointVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_DynEulerJointVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c8_DynEulerJointVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta\",},{M[8],M[0],T\"is_active_c8_DynEulerJointVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_DynEulerJointVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_DynEulerJointVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc8_DynEulerJointVerifyInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c8_DynEulerJointVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_DynEulerJointVerify
    ((SFc8_DynEulerJointVerifyInstanceStruct*) chartInstanceVar);
  initialize_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_DynEulerJointVerify(void *chartInstanceVar)
{
  enable_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_DynEulerJointVerify(void *chartInstanceVar)
{
  disable_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_DynEulerJointVerify(void *chartInstanceVar)
{
  sf_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c8_DynEulerJointVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_DynEulerJointVerify
    ((SFc8_DynEulerJointVerifyInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c8_DynEulerJointVerify();/* state var info */
...
static void sf_internal_set_sim_state_c8_DynEulerJointVerify(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_DynEulerJointVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c8_DynEulerJointVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_DynEulerJointVerify(S);
}

static void sf_opaque_set_sim_state_c8_DynEulerJointVerify(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_DynEulerJointVerify(S, st);
}

static void sf_opaque_terminate_c8_DynEulerJointVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_DynEulerJointVerifyInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_DynEulerJointVerify((SFc8_DynEulerJointVerifyInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c8_DynEulerJointVerify
    ((SFc8_DynEulerJointVerifyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_DynEulerJointVerify(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_DynEulerJointVerify
      ((SFc8_DynEulerJointVerifyInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_DynEulerJointVerify(SimStruct *S)
{
...
static void mdlRTW_c8_DynEulerJointVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynEulerJointVerify", "DynEulerJointVerify",8);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c8_DynEulerJointVerify(SimStruct *S)
{
  SFc8_DynEulerJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc8_DynEulerJointVerifyInstanceStruct *)malloc(sizeof
    (SFc8_DynEulerJointVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_DynEulerJointVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_DynEulerJointVerify;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_DynEulerJointVerify;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_DynEulerJointVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_DynEulerJointVerify;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_DynEulerJointVerify;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_DynEulerJointVerify;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_DynEulerJointVerify;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_DynEulerJointVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_DynEulerJointVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_DynEulerJointVerify;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_DynEulerJointVerify;
...
void c8_DynEulerJointVerify_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_DynEulerJointVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_DynEulerJointVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_DynEulerJointVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_DynEulerJointVerify_method_dispatcher.\n"
