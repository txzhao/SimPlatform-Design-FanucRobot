...
static void initialize_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance);
static void initialize_params_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct
  *chartInstance);
static void enable_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance);
static void disable_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct
  *chartInstance);
static void set_sim_state_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance);
static void sf_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c5_AugPDTask
  (SFc5_AugPDTaskInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static void c5_N_d(SFc5_AugPDTaskInstanceStruct *chartInstance, real_T c5_in1[9],
...
static void c5_emlrt_marshallIn(SFc5_AugPDTaskInstanceStruct *chartInstance,
  const mxArray *c5_N, const char_T *c5_name, real_T c5_y[6]);
static uint8_T c5_b_emlrt_marshallIn(SFc5_AugPDTaskInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_AugPDTask, const char_T *c5_name);
static void init_dsm_address_info(SFc5_AugPDTaskInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c5_AugPDTask(SFc5_AugPDTaskInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c5_is_active_c5_AugPDTask = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_AugPDTask;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_AugPDTask = c5_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "is_active_c5_AugPDTask");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_AugPDTask(chartInstance);
...
static const mxArray *c5_sf_marshall(void *chartInstanceVoid, void *c5_u)
{
  ...
  const mxArray *c5_b_y = NULL;
  SFc5_AugPDTaskInstanceStruct *chartInstance;
  chartInstance = (SFc5_AugPDTaskInstanceStruct *)chartInstanceVoid;
  c5_y = NULL;
...
const mxArray *sf_c5_AugPDTask_get_eml_resolved_functions_info(void)
{
...
static uint8_T c5_b_emlrt_marshallIn(SFc5_AugPDTaskInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_AugPDTask, const
  char_T *c5_name)
{
  uint8_T c5_y;
  uint8_T c5_u0;
  sf_mex_import(c5_name, sf_mex_dup(c5_b_is_active_c5_AugPDTask), &c5_u0, 1, 3,
                0U, 0, 0U, 0);
  c5_y = c5_u0;
  sf_mex_destroy(&c5_b_is_active_c5_AugPDTask);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_AugPDTask_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_AugPDTask_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c5_AugPDTask(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"N\",},{M[8],M[0],T\"is_active_c5_AugPDTask\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_AugPDTask_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_AugPDTaskInstanceStruct *chartInstance;
    chartInstance = (SFc5_AugPDTaskInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_AugPDTask(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*)
    chartInstanceVar);
  initialize_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_AugPDTask(void *chartInstanceVar)
{
  enable_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_AugPDTask(void *chartInstanceVar)
{
  disable_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_AugPDTask(void *chartInstanceVar)
{
  sf_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c5_AugPDTask(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c5_AugPDTask();/* state var info */
...
static void sf_internal_set_sim_state_c5_AugPDTask(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_AugPDTask();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c5_AugPDTask(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_AugPDTask(S);
}

static void sf_opaque_set_sim_state_c5_AugPDTask(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_AugPDTask(S, st);
}

static void sf_opaque_terminate_c5_AugPDTask(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c5_AugPDTask((SFc5_AugPDTaskInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_AugPDTask(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_AugPDTask(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"AugPDTask","AugPDTask",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"AugPDTask","AugPDTask",5,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"AugPDTask","AugPDTask",5,1);
      sf_mark_chart_reusable_outputs(S,"AugPDTask","AugPDTask",5,1);
    }

    sf_set_rtw_dwork_info(S,"AugPDTask","AugPDTask",5);
...
static void mdlRTW_c5_AugPDTask(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "AugPDTask", "AugPDTask",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_AugPDTask(SimStruct *S)
{
  SFc5_AugPDTaskInstanceStruct *chartInstance;
  chartInstance = (SFc5_AugPDTaskInstanceStruct *)malloc(sizeof
    (SFc5_AugPDTaskInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_AugPDTaskInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_AugPDTask;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_AugPDTask;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_AugPDTask;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_AugPDTask;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_AugPDTask;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_AugPDTask;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_AugPDTask;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_AugPDTask;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_AugPDTask;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_AugPDTask;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_AugPDTask;
...
void c5_AugPDTask_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_AugPDTask(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_AugPDTask(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_AugPDTask(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_AugPDTask_method_dispatcher.\n"
