...
#include "c1_CtrPlatform_AdaptiveControl.h"
...
static void initialize_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void initialize_params_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void enable_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void disable_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void set_sim_state_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, const mxArray *
   c1_st);
static void finalize_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void sf_c1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void initSimStructsc1_CtrPlatform_AdaptiveControl
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_Theta, const char_T *c1_identifier, real_T
  c1_y[6]);
static void c1_b_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[9]);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[9]);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_f_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[24]);
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_g_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
...
static void c1_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_i_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[3]);
...
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_j_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[2]);
...
static const mxArray *c1_j_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_k_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
...
static const mxArray *c1_k_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_l_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  boolean_T c1_y[2]);
...
static const mxArray *c1_l_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_m_emlrt_marshallIn(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
...
static void c1_inv_kin(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_gd[16], real_T c1_b_L[9], real_T c1_theta[24],
  real_T *c1_Num);
static void c1_cross(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
                     *chartInstance, real_T c1_a[3], real_T c1_b[3], real_T
                     c1_c[3]);
static boolean_T c1_all(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, boolean_T c1_x[2]);
static void c1_mrdivide(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16], real_T c1_y[16]);
static void c1_realmin(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_eps(SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_CtrPlatform_AdaptiveControlInstanceStruct *
  chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4], int32_T
  *c1_info);
static void c1_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static int32_T c1_eml_ixamax(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static void c1_b_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, int32_T c1_b);
static void c1_c_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void c1_d_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, int32_T c1_a,
   int32_T c1_b);
static void c1_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_eml_warning(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_eml_xtrsm(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16], real_T c1_b_B[16]);
static void c1_below_threshold(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_c_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_e_eml_int_forloop_overflow_check
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance);
static void c1_d_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static real_T c1_atan2(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_y, real_T c1_x);
static boolean_T c1_isInRange(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_x, real_T c1_xmin, real_T c1_xmax);
static void c1_expWre(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
                      *chartInstance, real_T c1_kx[6], real_T c1_theta, real_T
                      c1_g[16]);
static void c1_eye(SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance,
                   real_T c1_I[9]);
static void c1_expRot(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
                      *chartInstance, real_T c1_w[3], real_T c1_theta, real_T
                      c1_R[9]);
static void c1_e_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_f_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_subPro3(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_kx[6], real_T c1_p[4], real_T c1_q[4], real_T c1_d[4],
  real_T c1_theta[2], real_T *c1_Nsol);
static void c1_g_eml_scalar_eg(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static real_T c1_mpower(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_a);
static real_T c1_norm(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
                      *chartInstance, real_T c1_x[3]);
static void c1_eml_error(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static void c1_b_isInRange(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_x[2], real_T c1_xmin, real_T c1_xmax, boolean_T
  c1_isIn[2]);
static boolean_T c1_any(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, boolean_T c1_x[2]);
static real_T c1_subPro1(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_kx[6], real_T c1_p[4], real_T c1_q[4]);
static void c1_subPro2(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
...
static void c1_findCommon(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_w1[3], real_T c1_w2[3], real_T c1_r1[3], real_T
  c1_r2[3], real_T c1_r[3]);
static real_T c1_det(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
                     *chartInstance, real_T c1_x[4]);
static void c1_b_eml_matlab_zgetrf
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, real_T c1_A[4],
   real_T c1_b_A[4], int32_T c1_ipiv[2], int32_T *c1_info);
static void c1_eml_xger(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_alpha1, real_T c1_A[4], real_T c1_b_A[4]);
static void c1_b_eml_error(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
static real_T c1_b_subPro1(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_kx[6], real_T c1_p[4], real_T c1_q[3]);
static real_T c1_c_subPro1(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
...
static uint8_T c1_o_emlrt_marshallIn
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, const mxArray *
   c1_b_is_active_c1_CtrPlatform_AdaptiveControl, const char_T *c1_identifier);
static uint8_T c1_p_emlrt_marshallIn
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, const mxArray *
   c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_eml_matlab_zgetrf
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, real_T c1_A[16],
   int32_T c1_ipiv[4], int32_T *c1_info);
static void c1_b_eml_xtrsm(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_B[16]);
static void c1_d_eml_matlab_zgetrf
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance, real_T c1_A[4],
   int32_T c1_ipiv[2], int32_T *c1_info);
static void c1_b_eml_xger(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance, real_T c1_alpha1, real_T c1_A[4]);
static void init_dsm_address_info(SFc1_CtrPlatform_AdaptiveControlInstanceStruct
  *chartInstance);
  ...
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_CtrPlatform_AdaptiveControl = 0U;
}
  ...
  (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_CtrPlatform_AdaptiveControl;
   ...
   c1_st)
{
  ...
  chartInstance->c1_is_active_c1_CtrPlatform_AdaptiveControl =
    c1_o_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "is_active_c1_CtrPlatform_AdaptiveControl");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_CtrPlatform_AdaptiveControl(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance;
  chartInstance = (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_CtrPlatform_AdaptiveControl_get_eml_resolved_functions_info
  (void)
{
   ...
   c1_b_is_active_c1_CtrPlatform_AdaptiveControl, const char_T *c1_identifier)
{
  ...
  c1_y = c1_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_CtrPlatform_AdaptiveControl), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_CtrPlatform_AdaptiveControl);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_CtrPlatform_AdaptiveControl_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_CtrPlatform_AdaptiveControl_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_CtrPlatform_AdaptiveControl(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Theta\",},{M[8],M[0],T\"is_active_c1_CtrPlatform_AdaptiveControl\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_CtrPlatform_AdaptiveControl_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_CtrPlatform_AdaptiveControl(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
  initialize_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_CtrPlatform_AdaptiveControl(void
  *chartInstanceVar)
{
  enable_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_CtrPlatform_AdaptiveControl(void
  *chartInstanceVar)
{
  disable_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_CtrPlatform_AdaptiveControl(void
  *chartInstanceVar)
{
  sf_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_CtrPlatform_AdaptiveControl
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_CtrPlatform_AdaptiveControl();/* state var info */
...
extern void sf_internal_set_sim_state_c1_CtrPlatform_AdaptiveControl(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_CtrPlatform_AdaptiveControl
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_CtrPlatform_AdaptiveControl(S);
}

static void sf_opaque_set_sim_state_c1_CtrPlatform_AdaptiveControl(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_CtrPlatform_AdaptiveControl(S, st);
}

static void sf_opaque_terminate_c1_CtrPlatform_AdaptiveControl(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_CtrPlatform_AdaptiveControl
      ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_CtrPlatform_AdaptiveControl
    ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_CtrPlatform_AdaptiveControl(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_CtrPlatform_AdaptiveControl
      ((SFc1_CtrPlatform_AdaptiveControlInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_CtrPlatform_AdaptiveControl(SimStruct *S)
{
...
static void mdlRTW_c1_CtrPlatform_AdaptiveControl(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_CtrPlatform_AdaptiveControl(SimStruct *S)
{
  SFc1_CtrPlatform_AdaptiveControlInstanceStruct *chartInstance;
  chartInstance = (SFc1_CtrPlatform_AdaptiveControlInstanceStruct *)malloc
    (sizeof(SFc1_CtrPlatform_AdaptiveControlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_CtrPlatform_AdaptiveControlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_CtrPlatform_AdaptiveControl;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_CtrPlatform_AdaptiveControl;
...
void c1_CtrPlatform_AdaptiveControl_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_CtrPlatform_AdaptiveControl(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_CtrPlatform_AdaptiveControl(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_CtrPlatform_AdaptiveControl(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_CtrPlatform_AdaptiveControl_method_dispatcher.\n"
