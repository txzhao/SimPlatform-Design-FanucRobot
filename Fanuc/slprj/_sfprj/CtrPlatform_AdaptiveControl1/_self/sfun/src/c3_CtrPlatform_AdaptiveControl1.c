...
static void initialize_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void initialize_params_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void enable_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void disable_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void set_sim_state_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void sf_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c3_chartstep_c3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void initSimStructsc3_CtrPlatform_AdaptiveControl1
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *
...
static void c3_e_emlrt_marshallIn
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[36]);
...
static void c3_g_emlrt_marshallIn
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[18]);
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[31]);
static void c3_M_d(SFc3_CtrPlatform_AdaptiveControl1InstanceStruct
...
static real_T c3_power(SFc3_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c3_a);
static void c3_eml_int_forloop_overflow_check
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
...
static uint8_T c3_i_emlrt_marshallIn
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c3_b_is_active_c3_CtrPlatform_AdaptiveControl1, const char_T *c3_identifier);
  ...
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_CtrPlatform_AdaptiveControl1 = 0U;
}
  ...
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_CtrPlatform_AdaptiveControl1;
   ...
   *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_CtrPlatform_AdaptiveControl1 =
    c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "is_active_c3_CtrPlatform_AdaptiveControl1");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_CtrPlatform_AdaptiveControl1(chartInstance);
  ...
  (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_CtrPlatform_AdaptiveControl1(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance;
  chartInstance = (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *)
    chartInstanceVoid;
   ...
   *c3_b_is_active_c3_CtrPlatform_AdaptiveControl1, const char_T *c3_identifier)
{
  ...
  c3_y = c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_CtrPlatform_AdaptiveControl1), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_CtrPlatform_AdaptiveControl1);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_CtrPlatform_AdaptiveControl1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_CtrPlatform_AdaptiveControl1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_CtrPlatform_AdaptiveControl1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"M_Acc\",},{M[8],M[0],T\"is_active_c3_CtrPlatform_AdaptiveControl1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_CtrPlatform_AdaptiveControl1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
  initialize_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  enable_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  disable_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  sf_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_CtrPlatform_AdaptiveControl1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_CtrPlatform_AdaptiveControl1();/* state var info */
...
extern void sf_internal_set_sim_state_c3_CtrPlatform_AdaptiveControl1(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_CtrPlatform_AdaptiveControl1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_CtrPlatform_AdaptiveControl1(S);
}

static void sf_opaque_set_sim_state_c3_CtrPlatform_AdaptiveControl1(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_CtrPlatform_AdaptiveControl1(S, st);
}

static void sf_opaque_terminate_c3_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_CtrPlatform_AdaptiveControl1
      ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_CtrPlatform_AdaptiveControl1
    ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_CtrPlatform_AdaptiveControl1
      ((SFc3_CtrPlatform_AdaptiveControl1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
...
static void mdlRTW_c3_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance;
  chartInstance = (SFc3_CtrPlatform_AdaptiveControl1InstanceStruct *)malloc
    (sizeof(SFc3_CtrPlatform_AdaptiveControl1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_CtrPlatform_AdaptiveControl1;
...
void c3_CtrPlatform_AdaptiveControl1_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_CtrPlatform_AdaptiveControl1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_CtrPlatform_AdaptiveControl1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_CtrPlatform_AdaptiveControl1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_CtrPlatform_AdaptiveControl1_method_dispatcher.\n"
