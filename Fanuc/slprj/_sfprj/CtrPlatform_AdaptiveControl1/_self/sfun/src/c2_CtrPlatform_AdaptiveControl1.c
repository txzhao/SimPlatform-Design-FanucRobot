...
static void initialize_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void initialize_params_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void enable_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void disable_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void set_sim_state_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void sf_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_chartstep_c2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void initSimStructsc2_CtrPlatform_AdaptiveControl1
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *
...
static void c2_e_emlrt_marshallIn
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[36]);
...
static void c2_f_emlrt_marshallIn
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[16]);
...
static void c2_fwd_kin(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_in1[9], real_T c2_in2[6], real_T c2_gst[16]);
static void c2_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_body_Jacobian(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_in1[9], real_T c2_in2[6], real_T c2_b_body_Jacobian
  [36]);
static void c2_b_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_AdjointInv(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_g[16], real_T c2_Adg_inv[36]);
static void c2_eml_scalar_eg(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
static void c2_mldivide(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_A[36], real_T c2_B[36], real_T c2_Y[36]);
static void c2_realmin(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
static void c2_eps(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
                   *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_A[36], real_T c2_b_A[36], int32_T c2_ipiv[6],
  int32_T *c2_info);
static void c2_c_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static int32_T c2_eml_ixamax(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[36], int32_T c2_ix0);
static void c2_d_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, int32_T c2_b);
static void c2_e_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_f_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, int32_T c2_a,
   int32_T c2_b);
static void c2_eml_warning(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
static void c2_eml_xtrsm(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance, real_T c2_A[36], real_T c2_B[36], real_T c2_b_B[36]);
static void c2_below_threshold(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
static void c2_g_eml_int_forloop_overflow_check
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  *chartInstance);
...
static uint8_T c2_k_emlrt_marshallIn
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_CtrPlatform_AdaptiveControl1, const char_T *c2_identifier);
static uint8_T c2_l_emlrt_marshallIn
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_matlab_zgetrf
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance, real_T c2_A
   [36], int32_T c2_ipiv[6], int32_T *c2_info);
static void c2_b_eml_xtrsm(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct
  ...
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_CtrPlatform_AdaptiveControl1 = 0U;
}
  ...
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_CtrPlatform_AdaptiveControl1;
   ...
   *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_CtrPlatform_AdaptiveControl1 =
    c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
    "is_active_c2_CtrPlatform_AdaptiveControl1");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_CtrPlatform_AdaptiveControl1(chartInstance);
  ...
  (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_CtrPlatform_AdaptiveControl1(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance;
  chartInstance = (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_CtrPlatform_AdaptiveControl1_get_eml_resolved_functions_info(void)
{
   ...
   *c2_b_is_active_c2_CtrPlatform_AdaptiveControl1, const char_T *c2_identifier)
{
  ...
  c2_y = c2_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_CtrPlatform_AdaptiveControl1), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_CtrPlatform_AdaptiveControl1);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_CtrPlatform_AdaptiveControl1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_CtrPlatform_AdaptiveControl1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_CtrPlatform_AdaptiveControl1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Omega\",},{M[8],M[0],T\"is_active_c2_CtrPlatform_AdaptiveControl1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_CtrPlatform_AdaptiveControl1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
  initialize_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  enable_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  disable_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  sf_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_CtrPlatform_AdaptiveControl1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_CtrPlatform_AdaptiveControl1();/* state var info */
...
extern void sf_internal_set_sim_state_c2_CtrPlatform_AdaptiveControl1(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_CtrPlatform_AdaptiveControl1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_CtrPlatform_AdaptiveControl1(S);
}

static void sf_opaque_set_sim_state_c2_CtrPlatform_AdaptiveControl1(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_CtrPlatform_AdaptiveControl1(S, st);
}

static void sf_opaque_terminate_c2_CtrPlatform_AdaptiveControl1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_CtrPlatform_AdaptiveControl1
      ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_CtrPlatform_AdaptiveControl1
    ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_CtrPlatform_AdaptiveControl1
      ((SFc2_CtrPlatform_AdaptiveControl1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
...
static void mdlRTW_c2_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_CtrPlatform_AdaptiveControl1(SimStruct *S)
{
  SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *chartInstance;
  chartInstance = (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct *)malloc
    (sizeof(SFc2_CtrPlatform_AdaptiveControl1InstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc2_CtrPlatform_AdaptiveControl1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_CtrPlatform_AdaptiveControl1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_CtrPlatform_AdaptiveControl1;
...
void c2_CtrPlatform_AdaptiveControl1_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_CtrPlatform_AdaptiveControl1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_CtrPlatform_AdaptiveControl1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_CtrPlatform_AdaptiveControl1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_CtrPlatform_AdaptiveControl1_method_dispatcher.\n"
