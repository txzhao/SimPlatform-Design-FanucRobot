...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_CtrPlatform_AdaptiveControl1_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_CtrPlatform_AdaptiveControl1_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_CtrPlatform_AdaptiveControl1_autoinheritance_info( int
  ...
  if (strcmp(machineName, "CtrPlatform_AdaptiveControl1") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_CtrPlatform_AdaptiveControl1_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_CtrPlatform_AdaptiveControl1_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "CtrPlatform_AdaptiveControl1") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_CtrPlatform_AdaptiveControl1_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_CtrPlatform_AdaptiveControl1_method_dispatcher(SimStruct *
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"CtrPlatform_AdaptiveControl1")) {
    return(sf_CtrPlatform_AdaptiveControl1_method_dispatcher(simstructPtr,
...
extern void CtrPlatform_AdaptiveControl1_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    CtrPlatform_AdaptiveControl1_terminator();
    sf_debug_terminate();
  }
...
extern void CtrPlatform_AdaptiveControl1_initializer(void);
extern void CtrPlatform_AdaptiveControl1_register_exported_symbols(SimStruct* S);
extern void CtrPlatform_AdaptiveControl1_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  CtrPlatform_AdaptiveControl1_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      CtrPlatform_AdaptiveControl1_debug_initialize();
    }

    CtrPlatform_AdaptiveControl1_initializer();
  }
