#ifndef __c3_KinCon_h__
#define __c3_KinCon_h__
...
typedef struct {
  SimStruct *S;
  real_T c3_L[9];
  real_T c3_init_Rot[9];
  uint32_T chartNumber;
  uint32_T instanceNumber;
  boolean_T c3_doneDoubleBufferReInit;
  boolean_T c3_isStable;
  uint8_T c3_is_active_c3_KinCon;
...
extern void c3_KinCon_method_dispatcher(SimStruct *S, int_T method, void *data);
