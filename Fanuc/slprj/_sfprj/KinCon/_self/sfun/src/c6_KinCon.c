...
static const char *c6_debug_family_names[10] = { "EndVW", "gd", "EndW", "gd_pos",
  "nargin", "nargout", "Theta", "Omega", "L", "EndVel" };

static const char *c6_b_debug_family_names[64] = { "A1", "A2", "A3", "A4", "A5",
...
static const char *c6_c_debug_family_names[68] = { "A1", "A2", "A3", "A4", "A5",
...
static void initialize_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void initialize_params_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void enable_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void disable_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_KinCon(SFc6_KinConInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_KinCon(SFc6_KinConInstanceStruct
  *chartInstance);
static void set_sim_state_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance,
  const mxArray *c6_st);
static void finalize_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void sf_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void c6_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c6_KinCon(SFc6_KinConInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static void c6_spat_Jacobian(SFc6_KinConInstanceStruct *chartInstance, real_T
  c6_in1[9], real_T c6_in2[6], real_T c6_b_spat_Jacobian[36]);
static void c6_eml_scalar_eg(SFc6_KinConInstanceStruct *chartInstance);
static void c6_b_eml_scalar_eg(SFc6_KinConInstanceStruct *chartInstance);
static void c6_fwd_kin(SFc6_KinConInstanceStruct *chartInstance, real_T c6_in1[9],
  real_T c6_in2[6], real_T c6_gst[16]);
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[59]);
static const mxArray *c6_h_sf_marshall(void *chartInstanceVoid, void *c6_u);
static void c6_emlrt_marshallIn(SFc6_KinConInstanceStruct *chartInstance, const
  mxArray *c6_EndVel, const char_T *c6_name, real_T c6_y[3]);
static uint8_T c6_b_emlrt_marshallIn(SFc6_KinConInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_KinCon, const char_T *c6_name);
static void init_dsm_address_info(SFc6_KinConInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c6_is_active_c6_KinCon = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c6_EndVel)[3];
  c6_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_createcellarray(2));
  for (c6_i1 = 0; c6_i1 < 3; c6_i1 = c6_i1 + 1) {
    c6_hoistedGlobal[c6_i1] = (*c6_EndVel)[c6_i1];
  }
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_KinCon;
  ...
  const mxArray *c6_st)
{
  ...
  for (c6_i3 = 0; c6_i3 < 3; c6_i3 = c6_i3 + 1) {
    (*c6_EndVel)[c6_i3] = c6_dv1[c6_i3];
  }

  chartInstance->c6_is_active_c6_KinCon = c6_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)),
    "is_active_c6_KinCon");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_KinCon(chartInstance);
...
static void sf_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_Theta)[6];
  c6_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_Omega = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c6_i4 = 0; c6_i4 < 6; c6_i4 = c6_i4 + 1) {
    _SFD_DATA_RANGE_CHECK((*c6_Theta)[c6_i4], 0U);
  }

  for (c6_i5 = 0; c6_i5 < 6; c6_i5 = c6_i5 + 1) {
    _SFD_DATA_RANGE_CHECK((*c6_Omega)[c6_i5], 1U);
  }

  for (c6_i6 = 0; c6_i6 < 3; c6_i6 = c6_i6 + 1) {
    _SFD_DATA_RANGE_CHECK((*c6_EndVel)[c6_i6], 2U);
  }
...
static void c6_c6_KinCon(SFc6_KinConInstanceStruct *chartInstance)
{
  ...
  static const char *c6_sv0[10] = { "EndVW", "gd", "EndW", "gd_pos", "nargin",
  ...
  real_T c6_c3;
  int32_T c6_i34;
  real_T (*c6_b_EndVel)[3];
  real_T (*c6_b_Omega)[6];
  real_T (*c6_d_Theta)[6];
  c6_b_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_b_Omega = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 1);
  c6_d_Theta = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5);
  for (c6_i8 = 0; c6_i8 < 6; c6_i8 = c6_i8 + 1) {
    c6_hoistedGlobal[c6_i8] = (*c6_d_Theta)[c6_i8];
  }

  for (c6_i9 = 0; c6_i9 < 6; c6_i9 = c6_i9 + 1) {
    c6_b_hoistedGlobal[c6_i9] = (*c6_b_Omega)[c6_i9];
  }
  ...
  for (c6_i11 = 0; c6_i11 < 6; c6_i11 = c6_i11 + 1) {
    c6_Theta[c6_i11] = c6_hoistedGlobal[c6_i11];
  }

  for (c6_i12 = 0; c6_i12 < 6; c6_i12 = c6_i12 + 1) {
    c6_Omega[c6_i12] = c6_b_hoistedGlobal[c6_i12];
  }
  ...
  sf_debug_symbol_scope_push_eml(0U, 10U, 10U, c6_sv0, c6_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(c6_EndVW, c6_c_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(c6_gd, c6_e_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(c6_EndW, c6_sf_marshall, 2U);
  sf_debug_symbol_scope_add_eml(c6_gd_pos, c6_sf_marshall, 3U);
  sf_debug_symbol_scope_add_eml(&c6_nargin, c6_d_sf_marshall, 4U);
  sf_debug_symbol_scope_add_eml(&c6_nargout, c6_d_sf_marshall, 5U);
  sf_debug_symbol_scope_add_eml(c6_Theta, c6_c_sf_marshall, 6U);
  sf_debug_symbol_scope_add_eml(c6_Omega, c6_c_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(c6_b_L, c6_b_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(c6_EndVel, c6_sf_marshall, 9U);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0, 5);
  for (c6_i14 = 0; c6_i14 < 9; c6_i14 = c6_i14 + 1) {
    c6_c_L[c6_i14] = c6_b_L[c6_i14];
  }

  for (c6_i15 = 0; c6_i15 < 6; c6_i15 = c6_i15 + 1) {
    c6_b_Theta[c6_i15] = c6_Theta[c6_i15];
  }

  c6_spat_Jacobian(chartInstance, c6_c_L, c6_b_Theta, c6_a);
  for (c6_i16 = 0; c6_i16 < 6; c6_i16 = c6_i16 + 1) {
    c6_b[c6_i16] = c6_Omega[c6_i16];
  }

  c6_b_eml_scalar_eg(chartInstance);
  c6_b_eml_scalar_eg(chartInstance);
  for (c6_i17 = 0; c6_i17 < 36; c6_i17 = c6_i17 + 1) {
    c6_A[c6_i17] = c6_a[c6_i17];
  }

  for (c6_i18 = 0; c6_i18 < 6; c6_i18 = c6_i18 + 1) {
    c6_B[c6_i18] = c6_b[c6_i18];
  }

  for (c6_i19 = 0; c6_i19 < 6; c6_i19 = c6_i19 + 1) {
    c6_EndVW[c6_i19] = 0.0;
  }

  for (c6_i20 = 0; c6_i20 < 36; c6_i20 = c6_i20 + 1) {
    c6_b_A[c6_i20] = c6_A[c6_i20];
  }

  for (c6_i21 = 0; c6_i21 < 6; c6_i21 = c6_i21 + 1) {
    c6_b_B[c6_i21] = c6_B[c6_i21];
  }
  ...
  for (c6_i23 = 0; c6_i23 < 6; c6_i23 = c6_i23 + 1) {
    c6_c_B[c6_i23] = c6_b_B[c6_i23];
  }

  for (c6_i24 = 0; c6_i24 < 6; c6_i24 = c6_i24 + 1) {
    c6_EndVW[c6_i24] = 0.0;
    c6_i25 = 0;
    for (c6_i26 = 0; c6_i26 < 6; c6_i26 = c6_i26 + 1) {
      c6_EndVW[c6_i24] = c6_EndVW[c6_i24] + c6_c_A[c6_i25 + c6_i24] *
        c6_c_B[c6_i26];
      c6_i25 = c6_i25 + 6;
    }
  }
  ...
  _SFD_EML_CALL(0, 6);
  for (c6_i27 = 0; c6_i27 < 9; c6_i27 = c6_i27 + 1) {
    c6_d_L[c6_i27] = c6_b_L[c6_i27];
  }

  for (c6_i28 = 0; c6_i28 < 6; c6_i28 = c6_i28 + 1) {
    c6_c_Theta[c6_i28] = c6_Theta[c6_i28];
  }

  c6_fwd_kin(chartInstance, c6_d_L, c6_c_Theta, c6_dv2);
  for (c6_i29 = 0; c6_i29 < 16; c6_i29 = c6_i29 + 1) {
    c6_gd[c6_i29] = c6_dv2[c6_i29];
  }

  _SFD_EML_CALL(0, 7);
  for (c6_i30 = 0; c6_i30 < 3; c6_i30 = c6_i30 + 1) {
    c6_EndW[c6_i30] = c6_EndVW[c6_i30 + 3];
  }

  _SFD_EML_CALL(0, 8);
  for (c6_i31 = 0; c6_i31 < 3; c6_i31 = c6_i31 + 1) {
    c6_gd_pos[c6_i31] = c6_gd[c6_i31 + 12];
  }

  _SFD_EML_CALL(0, 9);
  for (c6_i32 = 0; c6_i32 < 3; c6_i32 = c6_i32 + 1) {
    c6_b_a[c6_i32] = c6_EndW[c6_i32];
  }

  for (c6_i33 = 0; c6_i33 < 3; c6_i33 = c6_i33 + 1) {
    c6_b_b[c6_i33] = c6_gd_pos[c6_i33];
  }
  ...
  c6_d_a = c6_b_a[2];
  c6_d_b = c6_b_b[1];
  c6_b_y = c6_d_a * c6_d_b;
  c6_c1 = c6_y - c6_b_y;
  c6_e_a = c6_b_a[2];
  c6_e_b = c6_b_b[0];
  c6_c_y = c6_e_a * c6_e_b;
  c6_f_a = c6_b_a[0];
  c6_f_b = c6_b_b[2];
  c6_d_y = c6_f_a * c6_f_b;
  c6_c2 = c6_c_y - c6_d_y;
  c6_g_a = c6_b_a[0];
  c6_g_b = c6_b_b[1];
  c6_e_y = c6_g_a * c6_g_b;
  c6_h_a = c6_b_a[1];
  c6_h_b = c6_b_b[0];
  c6_f_y = c6_h_a * c6_h_b;
  c6_c3 = c6_e_y - c6_f_y;
  c6_EndVel[0] = c6_c1;
  c6_EndVel[1] = c6_c2;
  c6_EndVel[2] = c6_c3;
  ...
  for (c6_i34 = 0; c6_i34 < 3; c6_i34 = c6_i34 + 1) {
    (*c6_b_EndVel)[c6_i34] = c6_EndVel[c6_i34];
  }
...
static void c6_spat_Jacobian(SFc6_KinConInstanceStruct *chartInstance, real_T
  c6_in1[9], real_T c6_in2[6], real_T c6_b_spat_Jacobian
  [36])
{
  uint32_T c6_debug_family_var_map[64];
  real_T c6_A1;
  real_T c6_A2;
  real_T c6_A3;
  real_T c6_A4;
  ...
  int32_T c6_k;
  int32_T c6_b_k;
  sf_debug_symbol_scope_push_eml(0U, 64U, 64U, c6_b_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c6_t2, c6_d_sf_marshall, 10U);
  sf_debug_symbol_scope_add_eml(&c6_t3, c6_d_sf_marshall, 11U);
  sf_debug_symbol_scope_add_eml(&c6_t4, c6_d_sf_marshall, 12U);
  sf_debug_symbol_scope_add_eml(&c6_t5, c6_d_sf_marshall, 13U);
  sf_debug_symbol_scope_add_eml(&c6_t6, c6_d_sf_marshall, 14U);
  sf_debug_symbol_scope_add_eml(&c6_t7, c6_d_sf_marshall, 15U);
  sf_debug_symbol_scope_add_eml(&c6_t8, c6_d_sf_marshall, 16U);
  sf_debug_symbol_scope_add_eml(&c6_t9, c6_d_sf_marshall, 17U);
  sf_debug_symbol_scope_add_eml(&c6_t10, c6_d_sf_marshall, 18U);
  sf_debug_symbol_scope_add_eml(&c6_t11, c6_d_sf_marshall, 19U);
  sf_debug_symbol_scope_add_eml(&c6_t12, c6_d_sf_marshall, 20U);
  sf_debug_symbol_scope_add_eml(&c6_t13, c6_d_sf_marshall, 21U);
  sf_debug_symbol_scope_add_eml(&c6_t14, c6_d_sf_marshall, 22U);
  sf_debug_symbol_scope_add_eml(&c6_t15, c6_d_sf_marshall, 23U);
  sf_debug_symbol_scope_add_eml(&c6_t16, c6_d_sf_marshall, 24U);
  sf_debug_symbol_scope_add_eml(&c6_t17, c6_d_sf_marshall, 25U);
  sf_debug_symbol_scope_add_eml(&c6_t18, c6_d_sf_marshall, 26U);
  sf_debug_symbol_scope_add_eml(&c6_t19, c6_d_sf_marshall, 27U);
  sf_debug_symbol_scope_add_eml(&c6_t20, c6_d_sf_marshall, 28U);
  sf_debug_symbol_scope_add_eml(&c6_t21, c6_d_sf_marshall, 29U);
  sf_debug_symbol_scope_add_eml(&c6_t22, c6_d_sf_marshall, 30U);
  sf_debug_symbol_scope_add_eml(&c6_t23, c6_d_sf_marshall, 31U);
  sf_debug_symbol_scope_add_eml(&c6_t24, c6_d_sf_marshall, 32U);
  sf_debug_symbol_scope_add_eml(&c6_t25, c6_d_sf_marshall, 33U);
  sf_debug_symbol_scope_add_eml(&c6_t26, c6_d_sf_marshall, 34U);
  sf_debug_symbol_scope_add_eml(&c6_t27, c6_d_sf_marshall, 35U);
  sf_debug_symbol_scope_add_eml(&c6_t28, c6_d_sf_marshall, 36U);
  sf_debug_symbol_scope_add_eml(&c6_t29, c6_d_sf_marshall, 37U);
  sf_debug_symbol_scope_add_eml(&c6_t30, c6_d_sf_marshall, 38U);
  sf_debug_symbol_scope_add_eml(&c6_t31, c6_d_sf_marshall, 39U);
  sf_debug_symbol_scope_add_eml(&c6_t32, c6_d_sf_marshall, 40U);
  sf_debug_symbol_scope_add_eml(&c6_t33, c6_d_sf_marshall, 41U);
  sf_debug_symbol_scope_add_eml(&c6_t34, c6_d_sf_marshall, 42U);
  sf_debug_symbol_scope_add_eml(&c6_t35, c6_d_sf_marshall, 43U);
  sf_debug_symbol_scope_add_eml(&c6_t36, c6_d_sf_marshall, 44U);
  sf_debug_symbol_scope_add_eml(&c6_t37, c6_d_sf_marshall, 45U);
  sf_debug_symbol_scope_add_eml(&c6_t38, c6_d_sf_marshall, 46U);
  sf_debug_symbol_scope_add_eml(&c6_t47, c6_d_sf_marshall, 47U);
  sf_debug_symbol_scope_add_eml(&c6_t39, c6_d_sf_marshall, 48U);
  sf_debug_symbol_scope_add_eml(&c6_t40, c6_d_sf_marshall, 49U);
  sf_debug_symbol_scope_add_eml(&c6_t41, c6_d_sf_marshall, 50U);
  sf_debug_symbol_scope_add_eml(&c6_t42, c6_d_sf_marshall, 51U);
  sf_debug_symbol_scope_add_eml(&c6_t43, c6_d_sf_marshall, 52U);
  sf_debug_symbol_scope_add_eml(&c6_t44, c6_d_sf_marshall, 53U);
  sf_debug_symbol_scope_add_eml(&c6_t45, c6_d_sf_marshall, 54U);
  sf_debug_symbol_scope_add_eml(&c6_t46, c6_d_sf_marshall, 55U);
  sf_debug_symbol_scope_add_eml(&c6_t48, c6_d_sf_marshall, 56U);
  sf_debug_symbol_scope_add_eml(&c6_t49, c6_d_sf_marshall, 57U);
  sf_debug_symbol_scope_add_eml(&c6_t50, c6_d_sf_marshall, 58U);
  sf_debug_symbol_scope_add_eml(&c6_nargin, c6_d_sf_marshall, 59U);
  sf_debug_symbol_scope_add_eml(&c6_nargout, c6_d_sf_marshall, 60U);
  sf_debug_symbol_scope_add_eml(c6_in1, c6_b_sf_marshall, 61U);
  sf_debug_symbol_scope_add_eml(c6_in2, c6_g_sf_marshall, 62U);
  sf_debug_symbol_scope_add_eml(c6_b_spat_Jacobian, c6_f_sf_marshall, 63U);
  CV_SCRIPT_FCN(0, 0);
  ...
  c6_l_x = c6_t10;
  c6_t10 = c6_l_x;
  c6_t10 = muDoubleScalarSin(c6_t10);
  _SFD_SCRIPT_CALL(0, 27);
  c6_m_x = c6_t3;
  c6_t11 = c6_m_x;
  c6_n_x = c6_t11;
  c6_t11 = c6_n_x;
  c6_t11 = muDoubleScalarSin(c6_t11);
  _SFD_SCRIPT_CALL(0, 28);
  c6_o_x = c6_A4;
  c6_t12 = c6_o_x;
  c6_p_x = c6_t12;
  c6_t12 = c6_p_x;
  c6_t12 = muDoubleScalarCos(c6_t12);
  _SFD_SCRIPT_CALL(0, 29);
  c6_q_x = c6_t3;
  c6_t13 = c6_q_x;
  c6_r_x = c6_t13;
  c6_t13 = c6_r_x;
  c6_t13 = muDoubleScalarCos(c6_t13);
  _SFD_SCRIPT_CALL(0, 30);
  c6_s_x = c6_A4;
  c6_t14 = c6_s_x;
  c6_t_x = c6_t14;
  c6_t14 = c6_t_x;
  c6_t14 = muDoubleScalarSin(c6_t14);
  _SFD_SCRIPT_CALL(0, 31);
  c6_t15 = (c6_L1 + c6_L3) + c6_L4;
  ...
  c6_v_x = c6_t20;
  c6_t20 = c6_v_x;
  c6_t20 = muDoubleScalarCos(c6_t20);
  ...
  c6_x_x = c6_t22;
  c6_t22 = c6_x_x;
  c6_t22 = muDoubleScalarSin(c6_t22);
  ...
  c6_t46 = ((c6_L2 + c6_t43) + c6_t44) + c6_t45;
  _SFD_SCRIPT_CALL(0, 64);
  c6_t48 = c6_t10 * c6_t14;
  _SFD_SCRIPT_CALL(0, 65);
  c6_t49 = c6_t11 * c6_t12 * c6_t2;
  _SFD_SCRIPT_CALL(0, 66);
  c6_t50 = c6_t48 + c6_t49;
  _SFD_SCRIPT_CALL(0, 67);
  c6_a = c6_t14;
  c6_eml_scalar_eg(chartInstance);
  c6_ak = c6_a;
  c6_y = muDoubleScalarPower(c6_ak, 2.0);
  c6_y_x[0] = 0.0;
  c6_y_x[1] = 0.0;
  c6_y_x[2] = 0.0;
  c6_y_x[3] = 0.0;
  c6_y_x[4] = 0.0;
  c6_y_x[5] = 1.0;
  c6_y_x[6] = (-c6_L1) * c6_t2;
  c6_y_x[7] = (-c6_L1) * c6_t10;
  c6_y_x[8] = c6_L2;
  c6_y_x[9] = -c6_t10;
  c6_y_x[10] = c6_t2;
  c6_y_x[11] = 0.0;
  c6_y_x[12] = (-c6_t2) * c6_t41;
  c6_y_x[13] = (-c6_t10) * c6_t41;
  c6_y_x[14] = c6_L2 + c6_t43;
  c6_y_x[15] = -c6_t10;
  c6_y_x[16] = c6_t2;
  c6_y_x[17] = 0.0;
  c6_y_x[18] = (-c6_t10) * c6_t42;
  c6_y_x[19] = c6_t2 * c6_t42;
  c6_y_x[20] = 0.0;
  c6_y_x[21] = c6_t13 * c6_t2;
  c6_y_x[22] = c6_t10 * c6_t13;
  c6_y_x[23] = -c6_t11;
  c6_y_x[24] = ((((-c6_t12) * c6_t34 + c6_t21 * c6_t50) + c6_t13 * c6_t2 * (c6_y
    * c6_t15 + c6_t12 * c6_t15 * c6_t19)) - c6_t13 *
                c6_t15 * c6_t2) - c6_t10 * c6_t14 * c6_t37;
  c6_y_x[25] = (((((((-c6_L1) * c6_t10 * c6_t12 - c6_L5 * c6_t14 * c6_t2) +
                    c6_L1 * c6_t11 * c6_t14 * c6_t2) - c6_L2 * c6_t13 * c6_t14
                   * c6_t2) - c6_L4 * c6_t10 * c6_t12 * c6_t13) + c6_L5 * c6_t10
                 * c6_t11 * c6_t12) - c6_L3 * c6_t10 * c6_t12 * c6_t4) + c6_L3 *
    c6_t14 * c6_t2 * c6_t7;
  c6_y_x[26] = c6_t12 * c6_t46;
  c6_y_x[27] = (-c6_t38) + c6_t47;
  c6_y_x[28] = c6_t12 * c6_t2 + c6_t10 * c6_t11 * c6_t14;
  c6_y_x[29] = c6_t13 * c6_t14;
  c6_y_x[30] = (((-c6_t20) * ((c6_t10 * (((((-c6_L1) - c6_L3) + c6_t16) + c6_t17)
    + c6_t18) - c6_t10 * c6_t15 * c6_t19) + c6_t11 *
    c6_t14 * c6_t15 * c6_t2) - c6_t15 * c6_t39) - c6_t22 * ((c6_t14 * c6_t34 +
    c6_t13 * c6_t2 * (c6_t12 * c6_t14 * c6_t15 - c6_t14 *
                      c6_t15 * c6_t19)) - c6_t10 * c6_t12 * c6_t37)) + c6_t39 *
    (c6_t20 * (c6_t15 * c6_t23 - c6_t21 * c6_t22) + c6_t22 * (c6_t15 * c6_t22
      + c6_t21 * c6_t23));
  c6_y_x[31] = ((((((((((c6_L4 * c6_t2 * c6_t20 - c6_L1 * c6_t10 * c6_t14 *
    c6_t22) + c6_L1 * c6_t13 * c6_t2 * c6_t20) + c6_L2 *
                       c6_t11 * c6_t2 * c6_t20) + c6_L5 * c6_t12 * c6_t2 *
                      c6_t22) + c6_L3 * c6_t2 * c6_t20 * c6_t5) - c6_L1 * c6_t11
                    * c6_t12 * c6_t2 *
                    c6_t22) + c6_L2 * c6_t12 * c6_t13 * c6_t2 * c6_t22) - c6_L4 *
                  c6_t10 * c6_t13 * c6_t14 * c6_t22) + c6_L5 * c6_t10 * c6_t11 *
                 c6_t14
                 * c6_t22) - c6_L3 * c6_t10 * c6_t14 * c6_t22 * c6_t4) - c6_L3 *
    c6_t12 * c6_t2 * c6_t22 * c6_t7;
  c6_y_x[32] = c6_t14 * c6_t22 * c6_t46;
  c6_y_x[33] = (-c6_t22) * c6_t50 + c6_t13 * c6_t2 * c6_t20;
  c6_y_x[34] = c6_t22 * (c6_t14 * c6_t2 - c6_t10 * c6_t11 * c6_t12) + c6_t10 *
    c6_t13 * c6_t20;
  c6_y_x[35] = (-c6_t11) * c6_t20 - c6_t12 * c6_t13 * c6_t22;
  for (c6_k = 1; c6_k < 37; c6_k = c6_k + 1) {
    c6_b_k = c6_k;
    c6_b_spat_Jacobian[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c6_b_k), 1, 36, 1, 0) - 1] = c6_y_x[
  ...
  real_T c6_in2[6], real_T c6_gst[16])
{
  ...
  int32_T c6_k;
  int32_T c6_b_k;
  sf_debug_symbol_scope_push_eml(0U, 68U, 68U, c6_c_debug_family_names,
    c6_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c6_A1, c6_d_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(&c6_A2, c6_d_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(&c6_A3, c6_d_sf_marshall, 2U);
  ...
  sf_debug_symbol_scope_add_eml(c6_in2, c6_g_sf_marshall, 66U);
...
static const mxArray *c6_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  real_T c6_c_u[3];
  const mxArray *c6_b_y = NULL;
  SFc6_KinConInstanceStruct *chartInstance;
  chartInstance = (SFc6_KinConInstanceStruct *)chartInstanceVoid;
  c6_y = NULL;
  for (c6_i35 = 0; c6_i35 < 3; c6_i35 = c6_i35 + 1) {
    c6_b_u[c6_i35] = (*((real_T (*)[3])c6_u))[c6_i35];
  }

  for (c6_i36 = 0; c6_i36 < 3; c6_i36 = c6_i36 + 1) {
    c6_c_u[c6_i36] = c6_b_u[c6_i36];
  }
...
static const mxArray *c6_b_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  chartInstance = (SFc6_KinConInstanceStruct *)chartInstanceVoid;
  c6_y = NULL;
  for (c6_i37 = 0; c6_i37 < 9; c6_i37 = c6_i37 + 1) {
    c6_b_u[c6_i37] = (*((real_T (*)[9])c6_u))[c6_i37];
  }

  for (c6_i38 = 0; c6_i38 < 9; c6_i38 = c6_i38 + 1) {
    c6_c_u[c6_i38] = c6_b_u[c6_i38];
  }
...
static const mxArray *c6_c_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  for (c6_i39 = 0; c6_i39 < 6; c6_i39 = c6_i39 + 1) {
    c6_b_u[c6_i39] = (*((real_T (*)[6])c6_u))[c6_i39];
  }

  for (c6_i40 = 0; c6_i40 < 6; c6_i40 = c6_i40 + 1) {
    c6_c_u[c6_i40] = c6_b_u[c6_i40];
  }
...
static const mxArray *c6_e_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  c6_y = NULL;
  c6_i41 = 0;
  for (c6_i42 = 0; c6_i42 < 4; c6_i42 = c6_i42 + 1) {
    for (c6_i43 = 0; c6_i43 < 4; c6_i43 = c6_i43 + 1) {
      c6_b_u[c6_i43 + c6_i41] = (*((real_T (*)[16])c6_u))[c6_i43 + c6_i41];
    }
  ...
  c6_i44 = 0;
  for (c6_i45 = 0; c6_i45 < 4; c6_i45 = c6_i45 + 1) {
    for (c6_i46 = 0; c6_i46 < 4; c6_i46 = c6_i46 + 1) {
      c6_c_u[c6_i46 + c6_i44] = c6_b_u[c6_i46 + c6_i44];
    }
...
static const mxArray *c6_f_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  for (c6_i48 = 0; c6_i48 < 6; c6_i48 = c6_i48 + 1) {
    for (c6_i49 = 0; c6_i49 < 6; c6_i49 = c6_i49 + 1) {
      c6_b_u[c6_i49 + c6_i47] = (*((real_T (*)[36])c6_u))[c6_i49 + c6_i47];
    }
  ...
  for (c6_i51 = 0; c6_i51 < 6; c6_i51 = c6_i51 + 1) {
    for (c6_i52 = 0; c6_i52 < 6; c6_i52 = c6_i52 + 1) {
      c6_c_u[c6_i52 + c6_i50] = c6_b_u[c6_i52 + c6_i50];
    }
...
static const mxArray *c6_g_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  chartInstance = (SFc6_KinConInstanceStruct *)chartInstanceVoid;
  c6_y = NULL;
  for (c6_i53 = 0; c6_i53 < 6; c6_i53 = c6_i53 + 1) {
    c6_b_u[c6_i53] = (*((real_T (*)[6])c6_u))[c6_i53];
  }

  for (c6_i54 = 0; c6_i54 < 6; c6_i54 = c6_i54 + 1) {
    c6_c_u[c6_i54] = c6_b_u[c6_i54];
  }
...
const mxArray *sf_c6_KinCon_get_eml_resolved_functions_info(void)
{
  const mxArray *c6_nameCaptureInfo = NULL;
  c6_ResolvedFunctionInfo c6_info[59];
  const mxArray *c6_m0 = NULL;
  int32_T c6_i55;
  c6_ResolvedFunctionInfo *c6_r0;
  c6_nameCaptureInfo = NULL;
  c6_info_helper(c6_info);
  sf_mex_assign(&c6_m0, sf_mex_createstruct("nameCaptureInfo", 1, 59));
  for (c6_i55 = 0; c6_i55 < 59; c6_i55 = c6_i55 + 1) {
    c6_r0 = &c6_info[c6_i55];
    sf_mex_addfield(c6_m0, sf_mex_create("nameCaptureInfo", c6_r0->context, 15,
      0U, 0U, 0U, 2, 1, strlen(c6_r0->context)), "context",
                    "nameCaptureInfo", c6_i55);
    sf_mex_addfield(c6_m0, sf_mex_create("nameCaptureInfo", c6_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c6_r0->name)), "name",
                    "nameCaptureInfo", c6_i55);
    sf_mex_addfield(c6_m0, sf_mex_create("nameCaptureInfo", c6_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c6_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c6_i55);
    ...
    sf_mex_addfield(c6_m0, sf_mex_create("nameCaptureInfo", &c6_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c6_i55
                    );
    sf_mex_addfield(c6_m0, sf_mex_create("nameCaptureInfo", &c6_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c6_i55
                    );
  }
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[59])
{
  ...
  c6_info[1].context = "";
  c6_info[1].name = "spat_Jacobian";
  c6_info[1].dominantType = "double";
  c6_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[1].fileLength = 2169U;
  c6_info[1].fileTime1 = 1366807304U;
  c6_info[1].fileTime2 = 0U;
  c6_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[2].name = "cos";
  ...
  c6_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[8].name = "plus";
  c6_info[8].dominantType = "double";
  c6_info[8].resolved = "[B]plus";
  c6_info[8].fileLength = 0U;
  c6_info[8].fileTime1 = 0U;
  c6_info[8].fileTime2 = 0U;
  c6_info[9].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[9].name = "sin";
  c6_info[9].dominantType = "double";
  c6_info[9].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c6_info[9].fileLength = 324U;
  c6_info[9].fileTime1 = 1203422842U;
  c6_info[9].fileTime2 = 0U;
  c6_info[10].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c6_info[10].name = "eml_scalar_sin";
  c6_info[10].dominantType = "double";
  c6_info[10].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c6_info[10].fileLength = 601U;
  c6_info[10].fileTime1 = 1209309190U;
  c6_info[10].fileTime2 = 0U;
  c6_info[11].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[11].name = "minus";
  c6_info[11].dominantType = "double";
  c6_info[11].resolved = "[B]minus";
  c6_info[11].fileLength = 0U;
  c6_info[11].fileTime1 = 0U;
  c6_info[11].fileTime2 = 0U;
  c6_info[12].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[12].name = "times";
  c6_info[12].dominantType = "double";
  c6_info[12].resolved = "[B]times";
  c6_info[12].fileLength = 0U;
  c6_info[12].fileTime1 = 0U;
  c6_info[12].fileTime2 = 0U;
  c6_info[13].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c6_info[14].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[14].name = "power";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[14].fileLength = 5380U;
  c6_info[14].fileTime1 = 1228068698U;
  c6_info[14].fileTime2 = 0U;
  c6_info[15].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[15].name = "isinteger";
  c6_info[15].dominantType = "double";
  c6_info[15].resolved = "[B]isinteger";
  c6_info[15].fileLength = 0U;
  c6_info[15].fileTime1 = 0U;
  c6_info[15].fileTime2 = 0U;
  c6_info[16].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[16].name = "eml_scalar_eg";
  c6_info[16].dominantType = "double";
  c6_info[16].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c6_info[16].fileLength = 3068U;
  c6_info[16].fileTime1 = 1240240410U;
  c6_info[16].fileTime2 = 0U;
  c6_info[17].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m!any_enums";
  c6_info[17].name = "false";
  c6_info[17].dominantType = "";
  c6_info[17].resolved = "[B]false";
  c6_info[17].fileLength = 0U;
  c6_info[17].fileTime1 = 0U;
  c6_info[17].fileTime2 = 0U;
  c6_info[18].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c6_info[18].name = "isstruct";
  c6_info[18].dominantType = "double";
  c6_info[18].resolved = "[B]isstruct";
  ...
  c6_info[24].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c6_info[24].name = "not";
  c6_info[24].dominantType = "logical";
  c6_info[24].resolved = "[B]not";
  c6_info[24].fileLength = 0U;
  c6_info[24].fileTime1 = 0U;
  c6_info[24].fileTime2 = 0U;
  c6_info[25].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[25].name = "lt";
  c6_info[25].dominantType = "double";
  c6_info[25].resolved = "[B]lt";
  ...
  c6_info[26].fileLength = 260U;
  c6_info[26].fileTime1 = 1209309190U;
  ...
  c6_info[28].name = "eml_error";
  c6_info[28].dominantType = "char";
  c6_info[28].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c6_info[28].fileLength = 315U;
  c6_info[28].fileTime1 = 1213905144U;
  c6_info[28].fileTime2 = 0U;
  c6_info[29].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c6_info[29].name = "strcmp";
  c6_info[29].dominantType = "char";
  c6_info[29].resolved = "[B]strcmp";
  c6_info[29].fileLength = 0U;
  c6_info[29].fileTime1 = 0U;
  c6_info[29].fileTime2 = 0U;
  c6_info[30].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c6_info[30].name = "reshape";
  c6_info[30].dominantType = "double";
  c6_info[30].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c6_info[30].fileLength = 4857U;
  c6_info[30].fileTime1 = 1242276774U;
  c6_info[30].fileTime2 = 0U;
  c6_info[31].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c6_info[31].name = "eml_index_class";
  c6_info[31].dominantType = "";
  c6_info[31].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c6_info[31].fileLength = 909U;
  c6_info[31].fileTime1 = 1192445182U;
  c6_info[31].fileTime2 = 0U;
  c6_info[32].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c6_info[32].name = "size";
  c6_info[32].dominantType = "double";
  c6_info[32].resolved = "[B]size";
  ...
  c6_info[33].name = "eml_assert_valid_size_arg";
  c6_info[33].dominantType = "double";
  c6_info[33].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[33].fileLength = 3315U;
  c6_info[33].fileTime1 = 1256367816U;
  c6_info[33].fileTime2 = 0U;
  c6_info[34].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[34].name = "isvector";
  c6_info[34].dominantType = "double";
  c6_info[34].resolved = "[B]isvector";
  c6_info[34].fileLength = 0U;
  c6_info[34].fileTime1 = 0U;
  c6_info[34].fileTime2 = 0U;
  c6_info[35].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isintegral";
  c6_info[35].name = "isinf";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c6_info[35].fileLength = 541U;
  c6_info[35].fileTime1 = 1271383988U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isintegral";
  c6_info[36].name = "true";
  c6_info[36].dominantType = "";
  c6_info[36].resolved = "[B]true";
  ...
  c6_info[39].fileLength = 3425U;
  c6_info[39].fileTime1 = 1251010272U;
  ...
  c6_info[40].fileLength = 1535U;
  c6_info[40].fileTime1 = 1192445128U;
  c6_info[40].fileTime2 = 0U;
  c6_info[41].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[41].name = "ischar";
  c6_info[41].dominantType = "char";
  c6_info[41].resolved = "[B]ischar";
  c6_info[41].fileLength = 0U;
  c6_info[41].fileTime1 = 0U;
  c6_info[41].fileTime2 = 0U;
  c6_info[42].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[42].name = "int32";
  c6_info[42].dominantType = "double";
  c6_info[42].resolved = "[B]int32";
  c6_info[42].fileLength = 0U;
  c6_info[42].fileTime1 = 0U;
  c6_info[42].fileTime2 = 0U;
  c6_info[43].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c6_info[43].name = "ones";
  c6_info[43].dominantType = "char";
  c6_info[43].resolved = "[B]ones";
  c6_info[43].fileLength = 0U;
  c6_info[43].fileTime1 = 0U;
  c6_info[43].fileTime2 = 0U;
  c6_info[44].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[44].name = "ndims";
  c6_info[44].dominantType = "double";
  c6_info[44].resolved = "[B]ndims";
  c6_info[44].fileLength = 0U;
  c6_info[44].fileTime1 = 0U;
  c6_info[44].fileTime2 = 0U;
  c6_info[45].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[45].name = "isempty";
  c6_info[45].dominantType = "double";
  c6_info[45].resolved = "[B]isempty";
  c6_info[45].fileLength = 0U;
  c6_info[45].fileTime1 = 0U;
  c6_info[45].fileTime2 = 0U;
  c6_info[46].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[46].name = "eml_xgemm";
  c6_info[46].dominantType = "int32";
  c6_info[46].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c6_info[46].fileLength = 3184U;
  c6_info[46].fileTime1 = 1209309252U;
  c6_info[46].fileTime2 = 0U;
  c6_info[47].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!itcount";
  c6_info[47].name = "length";
  c6_info[47].dominantType = "double";
  c6_info[47].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[47].fileLength = 326U;
  c6_info[47].fileTime1 = 1226552074U;
  ...
  c6_info[48].fileLength = 362U;
  c6_info[48].fileTime1 = 1245080764U;
  c6_info[48].fileTime2 = 0U;
  c6_info[49].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c6_info[49].name = "nargout";
  c6_info[49].dominantType = "";
  c6_info[49].resolved = "[B]nargout";
  c6_info[49].fileLength = 0U;
  c6_info[49].fileTime1 = 0U;
  c6_info[49].fileTime2 = 0U;
  c6_info[50].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c6_info[50].name = "eml_min_or_max";
  c6_info[50].dominantType = "char";
  c6_info[50].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c6_info[50].fileLength = 9967U;
  ...
  c6_info[53].fileTime1 = 1228068672U;
  ...
  c6_info[54].fileTime1 = 1192445184U;
  ...
  c6_info[55].fileTime1 = 1192445186U;
  ...
  c6_info[56].fileTime1 = 1192445184U;
  c6_info[56].fileTime2 = 0U;
  c6_info[57].context = "";
  c6_info[57].name = "fwd_kin";
  c6_info[57].dominantType = "double";
  c6_info[57].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c6_info[57].fileLength = 3324U;
  c6_info[57].fileTime1 = 1366778959U;
  c6_info[57].fileTime2 = 0U;
  c6_info[58].context = "";
  c6_info[58].name = "cross";
  c6_info[58].dominantType = "double";
  c6_info[58].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c6_info[58].fileLength = 3157U;
  c6_info[58].fileTime1 = 1240240462U;
...
static void c6_emlrt_marshallIn(SFc6_KinConInstanceStruct *chartInstance, const
  mxArray *c6_EndVel, const char_T *c6_name, real_T
  c6_y[3])
{
  real_T c6_dv3[3];
  int32_T c6_i56;
  sf_mex_import(c6_name, sf_mex_dup(c6_EndVel), c6_dv3, 1, 0, 0U, 1, 0U, 1, 3);
  for (c6_i56 = 0; c6_i56 < 3; c6_i56 = c6_i56 + 1) {
    c6_y[c6_i56] = c6_dv3[c6_i56];
  }

  sf_mex_destroy(&c6_EndVel);
}

static uint8_T c6_b_emlrt_marshallIn(SFc6_KinConInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_KinCon, const char_T
  *c6_name)
{
  uint8_T c6_y;
  uint8_T c6_u0;
  sf_mex_import(c6_name, sf_mex_dup(c6_b_is_active_c6_KinCon), &c6_u0, 1, 3, 0U,
                0, 0U, 0);
  c6_y = c6_u0;
  sf_mex_destroy(&c6_b_is_active_c6_KinCon);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_KinCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_KinCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c6_KinCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c6_KinCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_KinCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_KinConInstanceStruct *chartInstance;
    chartInstance = (SFc6_KinConInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c6_Omega);
          _SFD_SET_DATA_VALUE_PTR(2U, *c6_EndVel);
...
static void sf_opaque_initialize_c6_KinCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_KinConInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
  initialize_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_KinCon(void *chartInstanceVar)
{
  enable_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_KinCon(void *chartInstanceVar)
{
  disable_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_KinCon(void *chartInstanceVar)
{
  sf_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c6_KinCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_KinCon((SFc6_KinConInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c6_KinCon();/* state var info */
...
static void sf_internal_set_sim_state_c6_KinCon(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_KinCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c6_KinCon((SFc6_KinConInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c6_KinCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_KinCon(S);
}

static void sf_opaque_set_sim_state_c6_KinCon(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_KinCon(S, st);
}

static void sf_opaque_terminate_c6_KinCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_KinConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_KinCon((SFc6_KinConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c6_KinCon((SFc6_KinConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_KinCon(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_KinCon((SFc6_KinConInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_KinCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"KinCon","KinCon",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"KinCon","KinCon",6,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"KinCon","KinCon",6,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"KinCon","KinCon",6,2);
      sf_mark_chart_reusable_outputs(S,"KinCon","KinCon",6,1);
    }

    sf_set_rtw_dwork_info(S,"KinCon","KinCon",6);
...
static void mdlRTW_c6_KinCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "KinCon", "KinCon",6);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c6_KinCon(SimStruct *S)
{
  SFc6_KinConInstanceStruct *chartInstance;
  chartInstance = (SFc6_KinConInstanceStruct *)malloc(sizeof
    (SFc6_KinConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_KinConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_KinCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_KinCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_KinCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_KinCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_KinCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_KinCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_KinCon;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_KinCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_KinCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_KinCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_KinCon;
...
void c6_KinCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_KinCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_KinCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_KinCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_KinCon_method_dispatcher.\n"
