...
static const char *c10_debug_family_names[10] = { "EndVW", "gd", "EndW",
  "gd_pos", "nargin", "nargout", "Theta", "Omega", "L", "EndVel" };

static const char *c10_b_debug_family_names[64] = { "A1", "A2", "A3", "A4", "A5",
...
static const char *c10_c_debug_family_names[68] = { "A1", "A2", "A3", "A4", "A5",
...
static void initialize_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void initialize_params_c10_KinCon(SFc10_KinConInstanceStruct
  *chartInstance);
static void enable_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void disable_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_KinCon(SFc10_KinConInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c10_KinCon(SFc10_KinConInstanceStruct
  *chartInstance);
static void set_sim_state_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance,
  const mxArray *c10_st);
static void finalize_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void sf_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void c10_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c10_KinCon(SFc10_KinConInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static void c10_spat_Jacobian(SFc10_KinConInstanceStruct *chartInstance, real_T
  c10_in1[9], real_T c10_in2[6], real_T c10_b_spat_Jacobian[36]);
static void c10_eml_scalar_eg(SFc10_KinConInstanceStruct *chartInstance);
static void c10_b_eml_scalar_eg(SFc10_KinConInstanceStruct *chartInstance);
static void c10_fwd_kin(SFc10_KinConInstanceStruct *chartInstance, real_T
...
static void c10_info_helper(c10_ResolvedFunctionInfo c10_info[59]);
static const mxArray *c10_h_sf_marshall(void *chartInstanceVoid, void *c10_u);
static void c10_emlrt_marshallIn(SFc10_KinConInstanceStruct *chartInstance,
  const mxArray *c10_EndVel, const char_T *c10_name, real_T c10_y[3]);
static uint8_T c10_b_emlrt_marshallIn(SFc10_KinConInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_KinCon, const char_T *c10_name);
static void init_dsm_address_info(SFc10_KinConInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c10_is_active_c10_KinCon = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c10_EndVel)[3];
  c10_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_st = NULL;
  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_createcellarray(2));
  for (c10_i1 = 0; c10_i1 < 3; c10_i1 = c10_i1 + 1) {
    c10_hoistedGlobal[c10_i1] = (*c10_EndVel)[c10_i1];
  }
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_KinCon;
  ...
  const mxArray *c10_st)
{
  ...
  for (c10_i3 = 0; c10_i3 < 3; c10_i3 = c10_i3 + 1) {
    (*c10_EndVel)[c10_i3] = c10_dv1[c10_i3];
  }

  chartInstance->c10_is_active_c10_KinCon = c10_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 1)),
    "is_active_c10_KinCon");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_KinCon(chartInstance);
...
static void sf_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance)
{
  ...
  real_T (*c10_Theta)[6];
  c10_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_Omega = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c10_i4 = 0; c10_i4 < 6; c10_i4 = c10_i4 + 1) {
    _SFD_DATA_RANGE_CHECK((*c10_Theta)[c10_i4], 0U);
  }

  for (c10_i5 = 0; c10_i5 < 6; c10_i5 = c10_i5 + 1) {
    _SFD_DATA_RANGE_CHECK((*c10_Omega)[c10_i5], 1U);
  }

  for (c10_i6 = 0; c10_i6 < 3; c10_i6 = c10_i6 + 1) {
    _SFD_DATA_RANGE_CHECK((*c10_EndVel)[c10_i6], 2U);
  }

  for (c10_i7 = 0; c10_i7 < 9; c10_i7 = c10_i7 + 1) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c10_L[c10_i7], 3U);
  }

  c10_previousEvent = _sfEvent_;
  _sfEvent_ = CALL_EVENT;
  c10_c10_KinCon(chartInstance);
...
static void c10_c10_KinCon(SFc10_KinConInstanceStruct *chartInstance)
{
  ...
  static const char *c10_sv0[10] = { "EndVW", "gd", "EndW", "gd_pos", "nargin",
  ...
  real_T c10_c3;
  int32_T c10_i34;
  real_T (*c10_b_EndVel)[3];
  real_T (*c10_b_Omega)[6];
  real_T (*c10_d_Theta)[6];
  c10_b_EndVel = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_b_Omega = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 1);
  c10_d_Theta = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9);
  for (c10_i8 = 0; c10_i8 < 6; c10_i8 = c10_i8 + 1) {
    c10_hoistedGlobal[c10_i8] = (*c10_d_Theta)[c10_i8];
  }

  for (c10_i9 = 0; c10_i9 < 6; c10_i9 = c10_i9 + 1) {
    c10_b_hoistedGlobal[c10_i9] = (*c10_b_Omega)[c10_i9];
  }

  for (c10_i10 = 0; c10_i10 < 9; c10_i10 = c10_i10 + 1) {
    c10_c_hoistedGlobal[c10_i10] = chartInstance->c10_L[c10_i10];
  }

  for (c10_i11 = 0; c10_i11 < 6; c10_i11 = c10_i11 + 1) {
    c10_Theta[c10_i11] = c10_hoistedGlobal[c10_i11];
  }

  for (c10_i12 = 0; c10_i12 < 6; c10_i12 = c10_i12 + 1) {
    c10_Omega[c10_i12] = c10_b_hoistedGlobal[c10_i12];
  }

  for (c10_i13 = 0; c10_i13 < 9; c10_i13 = c10_i13 + 1) {
    c10_b_L[c10_i13] = c10_c_hoistedGlobal[c10_i13];
  }

  sf_debug_symbol_scope_push_eml(0U, 10U, 10U, c10_sv0, c10_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(c10_EndVW, c10_c_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(c10_gd, c10_e_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(c10_EndW, c10_sf_marshall, 2U);
  sf_debug_symbol_scope_add_eml(c10_gd_pos, c10_sf_marshall, 3U);
  sf_debug_symbol_scope_add_eml(&c10_nargin, c10_d_sf_marshall, 4U);
  sf_debug_symbol_scope_add_eml(&c10_nargout, c10_d_sf_marshall, 5U);
  sf_debug_symbol_scope_add_eml(c10_Theta, c10_c_sf_marshall, 6U);
  sf_debug_symbol_scope_add_eml(c10_Omega, c10_c_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(c10_b_L, c10_b_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(c10_EndVel, c10_sf_marshall, 9U);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0, 5);
  for (c10_i14 = 0; c10_i14 < 9; c10_i14 = c10_i14 + 1) {
    c10_c_L[c10_i14] = c10_b_L[c10_i14];
  }

  for (c10_i15 = 0; c10_i15 < 6; c10_i15 = c10_i15 + 1) {
    c10_b_Theta[c10_i15] = c10_Theta[c10_i15];
  }

  c10_spat_Jacobian(chartInstance, c10_c_L, c10_b_Theta, c10_a);
  for (c10_i16 = 0; c10_i16 < 6; c10_i16 = c10_i16 + 1) {
    c10_b[c10_i16] = c10_Omega[c10_i16];
  }

  c10_b_eml_scalar_eg(chartInstance);
  c10_b_eml_scalar_eg(chartInstance);
  for (c10_i17 = 0; c10_i17 < 36; c10_i17 = c10_i17 + 1) {
    c10_A[c10_i17] = c10_a[c10_i17];
  }

  for (c10_i18 = 0; c10_i18 < 6; c10_i18 = c10_i18 + 1) {
    c10_B[c10_i18] = c10_b[c10_i18];
  }

  for (c10_i19 = 0; c10_i19 < 6; c10_i19 = c10_i19 + 1) {
    c10_EndVW[c10_i19] = 0.0;
  }

  for (c10_i20 = 0; c10_i20 < 36; c10_i20 = c10_i20 + 1) {
    c10_b_A[c10_i20] = c10_A[c10_i20];
  }

  for (c10_i21 = 0; c10_i21 < 6; c10_i21 = c10_i21 + 1) {
    c10_b_B[c10_i21] = c10_B[c10_i21];
  }

  for (c10_i22 = 0; c10_i22 < 36; c10_i22 = c10_i22 + 1) {
    c10_c_A[c10_i22] = c10_b_A[c10_i22];
  }

  for (c10_i23 = 0; c10_i23 < 6; c10_i23 = c10_i23 + 1) {
    c10_c_B[c10_i23] = c10_b_B[c10_i23];
  }

  for (c10_i24 = 0; c10_i24 < 6; c10_i24 = c10_i24 + 1) {
    c10_EndVW[c10_i24] = 0.0;
    c10_i25 = 0;
    for (c10_i26 = 0; c10_i26 < 6; c10_i26 = c10_i26 + 1) {
      c10_EndVW[c10_i24] = c10_EndVW[c10_i24] + c10_c_A[c10_i25 + c10_i24] *
        c10_c_B[c10_i26];
      c10_i25 = c10_i25 + 6;
    }
  }
  ...
  _SFD_EML_CALL(0, 6);
  for (c10_i27 = 0; c10_i27 < 9; c10_i27 = c10_i27 + 1) {
    c10_d_L[c10_i27] = c10_b_L[c10_i27];
  }

  for (c10_i28 = 0; c10_i28 < 6; c10_i28 = c10_i28 + 1) {
    c10_c_Theta[c10_i28] = c10_Theta[c10_i28];
  }

  c10_fwd_kin(chartInstance, c10_d_L, c10_c_Theta, c10_dv2);
  for (c10_i29 = 0; c10_i29 < 16; c10_i29 = c10_i29 + 1) {
    c10_gd[c10_i29] = c10_dv2[c10_i29];
  }

  _SFD_EML_CALL(0, 7);
  for (c10_i30 = 0; c10_i30 < 3; c10_i30 = c10_i30 + 1) {
    c10_EndW[c10_i30] = c10_EndVW[c10_i30 + 3];
  }

  _SFD_EML_CALL(0, 8);
  for (c10_i31 = 0; c10_i31 < 3; c10_i31 = c10_i31 + 1) {
    c10_gd_pos[c10_i31] = c10_gd[c10_i31 + 12];
  }

  _SFD_EML_CALL(0, 9);
  for (c10_i32 = 0; c10_i32 < 3; c10_i32 = c10_i32 + 1) {
    c10_b_a[c10_i32] = c10_EndW[c10_i32];
  }

  for (c10_i33 = 0; c10_i33 < 3; c10_i33 = c10_i33 + 1) {
    c10_b_b[c10_i33] = c10_gd_pos[c10_i33];
  }

  c10_c_a = c10_b_a[1];
  c10_c_b = c10_b_b[2];
  c10_y = c10_c_a * c10_c_b;
  c10_d_a = c10_b_a[2];
  c10_d_b = c10_b_b[1];
  c10_b_y = c10_d_a * c10_d_b;
  c10_c1 = c10_y - c10_b_y;
  c10_e_a = c10_b_a[2];
  c10_e_b = c10_b_b[0];
  c10_c_y = c10_e_a * c10_e_b;
  c10_f_a = c10_b_a[0];
  c10_f_b = c10_b_b[2];
  c10_d_y = c10_f_a * c10_f_b;
  c10_c2 = c10_c_y - c10_d_y;
  c10_g_a = c10_b_a[0];
  c10_g_b = c10_b_b[1];
  c10_e_y = c10_g_a * c10_g_b;
  c10_h_a = c10_b_a[1];
  c10_h_b = c10_b_b[0];
  c10_f_y = c10_h_a * c10_h_b;
  ...
  for (c10_i34 = 0; c10_i34 < 3; c10_i34 = c10_i34 + 1) {
    (*c10_b_EndVel)[c10_i34] = c10_EndVel[c10_i34];
  }
...
static void c10_spat_Jacobian(SFc10_KinConInstanceStruct *chartInstance, real_T
  c10_in1[9], real_T c10_in2[6], real_T
  c10_b_spat_Jacobian[36])
{
  uint32_T c10_debug_family_var_map[64];
  real_T c10_A1;
  real_T c10_A2;
  real_T c10_A3;
  real_T c10_A4;
  ...
  int32_T c10_k;
  int32_T c10_b_k;
  sf_debug_symbol_scope_push_eml(0U, 64U, 64U, c10_b_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c10_L1, c10_d_sf_marshall, 5U);
  sf_debug_symbol_scope_add_eml(&c10_L2, c10_d_sf_marshall, 6U);
  sf_debug_symbol_scope_add_eml(&c10_L3, c10_d_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(&c10_L4, c10_d_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(&c10_L5, c10_d_sf_marshall, 9U);
  sf_debug_symbol_scope_add_eml(&c10_t2, c10_d_sf_marshall, 10U);
  sf_debug_symbol_scope_add_eml(&c10_t3, c10_d_sf_marshall, 11U);
  sf_debug_symbol_scope_add_eml(&c10_t4, c10_d_sf_marshall, 12U);
  sf_debug_symbol_scope_add_eml(&c10_t5, c10_d_sf_marshall, 13U);
  sf_debug_symbol_scope_add_eml(&c10_t6, c10_d_sf_marshall, 14U);
  sf_debug_symbol_scope_add_eml(&c10_t7, c10_d_sf_marshall, 15U);
  sf_debug_symbol_scope_add_eml(&c10_t8, c10_d_sf_marshall, 16U);
  sf_debug_symbol_scope_add_eml(&c10_t9, c10_d_sf_marshall, 17U);
  sf_debug_symbol_scope_add_eml(&c10_t10, c10_d_sf_marshall, 18U);
  sf_debug_symbol_scope_add_eml(&c10_t11, c10_d_sf_marshall, 19U);
  sf_debug_symbol_scope_add_eml(&c10_t12, c10_d_sf_marshall, 20U);
  sf_debug_symbol_scope_add_eml(&c10_t13, c10_d_sf_marshall, 21U);
  sf_debug_symbol_scope_add_eml(&c10_t14, c10_d_sf_marshall, 22U);
  sf_debug_symbol_scope_add_eml(&c10_t15, c10_d_sf_marshall, 23U);
  sf_debug_symbol_scope_add_eml(&c10_t16, c10_d_sf_marshall, 24U);
  sf_debug_symbol_scope_add_eml(&c10_t17, c10_d_sf_marshall, 25U);
  sf_debug_symbol_scope_add_eml(&c10_t18, c10_d_sf_marshall, 26U);
  sf_debug_symbol_scope_add_eml(&c10_t19, c10_d_sf_marshall, 27U);
  sf_debug_symbol_scope_add_eml(&c10_t20, c10_d_sf_marshall, 28U);
  sf_debug_symbol_scope_add_eml(&c10_t21, c10_d_sf_marshall, 29U);
  sf_debug_symbol_scope_add_eml(&c10_t22, c10_d_sf_marshall, 30U);
  sf_debug_symbol_scope_add_eml(&c10_t23, c10_d_sf_marshall, 31U);
  sf_debug_symbol_scope_add_eml(&c10_t24, c10_d_sf_marshall, 32U);
  sf_debug_symbol_scope_add_eml(&c10_t25, c10_d_sf_marshall, 33U);
  sf_debug_symbol_scope_add_eml(&c10_t26, c10_d_sf_marshall, 34U);
  sf_debug_symbol_scope_add_eml(&c10_t27, c10_d_sf_marshall, 35U);
  sf_debug_symbol_scope_add_eml(&c10_t28, c10_d_sf_marshall, 36U);
  sf_debug_symbol_scope_add_eml(&c10_t29, c10_d_sf_marshall, 37U);
  sf_debug_symbol_scope_add_eml(&c10_t30, c10_d_sf_marshall, 38U);
  sf_debug_symbol_scope_add_eml(&c10_t31, c10_d_sf_marshall, 39U);
  sf_debug_symbol_scope_add_eml(&c10_t32, c10_d_sf_marshall, 40U);
  sf_debug_symbol_scope_add_eml(&c10_t33, c10_d_sf_marshall, 41U);
  sf_debug_symbol_scope_add_eml(&c10_t34, c10_d_sf_marshall, 42U);
  sf_debug_symbol_scope_add_eml(&c10_t35, c10_d_sf_marshall, 43U);
  sf_debug_symbol_scope_add_eml(&c10_t36, c10_d_sf_marshall, 44U);
  sf_debug_symbol_scope_add_eml(&c10_t37, c10_d_sf_marshall, 45U);
  sf_debug_symbol_scope_add_eml(&c10_t38, c10_d_sf_marshall, 46U);
  sf_debug_symbol_scope_add_eml(&c10_t47, c10_d_sf_marshall, 47U);
  sf_debug_symbol_scope_add_eml(&c10_t39, c10_d_sf_marshall, 48U);
  sf_debug_symbol_scope_add_eml(&c10_t40, c10_d_sf_marshall, 49U);
  sf_debug_symbol_scope_add_eml(&c10_t41, c10_d_sf_marshall, 50U);
  sf_debug_symbol_scope_add_eml(&c10_t42, c10_d_sf_marshall, 51U);
  sf_debug_symbol_scope_add_eml(&c10_t43, c10_d_sf_marshall, 52U);
  sf_debug_symbol_scope_add_eml(&c10_t44, c10_d_sf_marshall, 53U);
  sf_debug_symbol_scope_add_eml(&c10_t45, c10_d_sf_marshall, 54U);
  sf_debug_symbol_scope_add_eml(&c10_t46, c10_d_sf_marshall, 55U);
  sf_debug_symbol_scope_add_eml(&c10_t48, c10_d_sf_marshall, 56U);
  sf_debug_symbol_scope_add_eml(&c10_t49, c10_d_sf_marshall, 57U);
  sf_debug_symbol_scope_add_eml(&c10_t50, c10_d_sf_marshall, 58U);
  sf_debug_symbol_scope_add_eml(&c10_nargin, c10_d_sf_marshall, 59U);
  sf_debug_symbol_scope_add_eml(&c10_nargout, c10_d_sf_marshall, 60U);
  sf_debug_symbol_scope_add_eml(c10_in1, c10_b_sf_marshall, 61U);
  sf_debug_symbol_scope_add_eml(c10_in2, c10_g_sf_marshall, 62U);
  sf_debug_symbol_scope_add_eml(c10_b_spat_Jacobian, c10_f_sf_marshall, 63U);
  CV_SCRIPT_FCN(0, 0);
  ...
  c10_t3 = c10_A2 + c10_A3;
  _SFD_SCRIPT_CALL(0, 20);
  c10_c_x = c10_A2;
  c10_t4 = c10_c_x;
  c10_d_x = c10_t4;
  c10_t4 = c10_d_x;
  c10_t4 = muDoubleScalarCos(c10_t4);
  ...
  c10_l_x = c10_t10;
  c10_t10 = c10_l_x;
  c10_t10 = muDoubleScalarSin(c10_t10);
  _SFD_SCRIPT_CALL(0, 27);
  c10_m_x = c10_t3;
  c10_t11 = c10_m_x;
  c10_n_x = c10_t11;
  c10_t11 = c10_n_x;
  c10_t11 = muDoubleScalarSin(c10_t11);
  _SFD_SCRIPT_CALL(0, 28);
  c10_o_x = c10_A4;
  c10_t12 = c10_o_x;
  c10_p_x = c10_t12;
  c10_t12 = c10_p_x;
  c10_t12 = muDoubleScalarCos(c10_t12);
  _SFD_SCRIPT_CALL(0, 29);
  c10_q_x = c10_t3;
  c10_t13 = c10_q_x;
  c10_r_x = c10_t13;
  c10_t13 = c10_r_x;
  c10_t13 = muDoubleScalarCos(c10_t13);
  _SFD_SCRIPT_CALL(0, 30);
  c10_s_x = c10_A4;
  c10_t14 = c10_s_x;
  c10_t_x = c10_t14;
  c10_t14 = c10_t_x;
  c10_t14 = muDoubleScalarSin(c10_t14);
  _SFD_SCRIPT_CALL(0, 31);
  c10_t15 = (c10_L1 + c10_L3) + c10_L4;
  _SFD_SCRIPT_CALL(0, 32);
  c10_t16 = c10_L2 * c10_t11;
  _SFD_SCRIPT_CALL(0, 33);
  c10_t17 = c10_L3 * c10_t5;
  _SFD_SCRIPT_CALL(0, 34);
  c10_t18 = c10_L1 * c10_t13;
  ...
  c10_v_x = c10_t20;
  c10_t20 = c10_v_x;
  c10_t20 = muDoubleScalarCos(c10_t20);
  _SFD_SCRIPT_CALL(0, 37);
  c10_t21 = c10_L2 + c10_L5;
  _SFD_SCRIPT_CALL(0, 38);
  c10_w_x = c10_A5;
  c10_t22 = c10_w_x;
  c10_x_x = c10_t22;
  c10_t22 = c10_x_x;
  c10_t22 = muDoubleScalarSin(c10_t22);
  _SFD_SCRIPT_CALL(0, 39);
  c10_t23 = c10_t20 - 1.0;
  _SFD_SCRIPT_CALL(0, 40);
  c10_t24 = c10_L2 * c10_t6;
  _SFD_SCRIPT_CALL(0, 41);
  c10_t25 = c10_t4 - 1.0;
  _SFD_SCRIPT_CALL(0, 42);
  c10_t26 = c10_t24 - c10_L1 * c10_t25;
  _SFD_SCRIPT_CALL(0, 43);
  c10_t27 = c10_t2 * c10_t26;
  _SFD_SCRIPT_CALL(0, 44);
  c10_t28 = c10_L2 * c10_t7;
  _SFD_SCRIPT_CALL(0, 45);
  c10_t29 = c10_t2 * c10_t4 * (c10_t28 - c10_t8 * c10_t9);
  _SFD_SCRIPT_CALL(0, 46);
  c10_t30 = c10_t7 * c10_t8;
  _SFD_SCRIPT_CALL(0, 47);
  c10_t31 = c10_L2 * c10_t9;
  _SFD_SCRIPT_CALL(0, 48);
  c10_t32 = c10_t30 + c10_t31;
  _SFD_SCRIPT_CALL(0, 49);
  c10_t33 = c10_t2 * c10_t32 * c10_t6;
  _SFD_SCRIPT_CALL(0, 50);
  c10_t34 = (c10_t27 + c10_t29) + c10_t33;
  _SFD_SCRIPT_CALL(0, 51);
  c10_t35 = c10_L1 * c10_t11;
  _SFD_SCRIPT_CALL(0, 52);
  c10_t36 = c10_L3 * c10_t7;
  _SFD_SCRIPT_CALL(0, 53);
  c10_t37 = ((c10_L2 + c10_t35) + c10_t36) - c10_L2 * c10_t13;
  _SFD_SCRIPT_CALL(0, 54);
  c10_t38 = c10_t10 * c10_t12;
  _SFD_SCRIPT_CALL(0, 55);
  c10_t47 = c10_t11 * c10_t14 * c10_t2;
  _SFD_SCRIPT_CALL(0, 56);
  c10_t39 = c10_t38 - c10_t47;
  _SFD_SCRIPT_CALL(0, 57);
  c10_t40 = c10_L3 * c10_t4;
  _SFD_SCRIPT_CALL(0, 58);
  c10_t41 = c10_L1 + c10_t40;
  _SFD_SCRIPT_CALL(0, 59);
  c10_t42 = ((c10_L4 + c10_t16) + c10_t17) + c10_t18;
  _SFD_SCRIPT_CALL(0, 60);
  c10_t43 = c10_L3 * c10_t6;
  _SFD_SCRIPT_CALL(0, 61);
  c10_t44 = c10_L4 * c10_t11;
  _SFD_SCRIPT_CALL(0, 62);
  c10_t45 = c10_L5 * c10_t13;
  _SFD_SCRIPT_CALL(0, 63);
  c10_t46 = ((c10_L2 + c10_t43) + c10_t44) + c10_t45;
  _SFD_SCRIPT_CALL(0, 64);
  c10_t48 = c10_t10 * c10_t14;
  _SFD_SCRIPT_CALL(0, 65);
  c10_t49 = c10_t11 * c10_t12 * c10_t2;
  _SFD_SCRIPT_CALL(0, 66);
  c10_t50 = c10_t48 + c10_t49;
  _SFD_SCRIPT_CALL(0, 67);
  c10_a = c10_t14;
  c10_eml_scalar_eg(chartInstance);
  c10_ak = c10_a;
  c10_y = muDoubleScalarPower(c10_ak, 2.0);
  c10_y_x[0] = 0.0;
  c10_y_x[1] = 0.0;
  c10_y_x[2] = 0.0;
  c10_y_x[3] = 0.0;
  c10_y_x[4] = 0.0;
  c10_y_x[5] = 1.0;
  c10_y_x[6] = (-c10_L1) * c10_t2;
  c10_y_x[7] = (-c10_L1) * c10_t10;
  c10_y_x[8] = c10_L2;
  c10_y_x[9] = -c10_t10;
  c10_y_x[10] = c10_t2;
  c10_y_x[11] = 0.0;
  c10_y_x[12] = (-c10_t2) * c10_t41;
  c10_y_x[13] = (-c10_t10) * c10_t41;
  c10_y_x[14] = c10_L2 + c10_t43;
  c10_y_x[15] = -c10_t10;
  c10_y_x[16] = c10_t2;
  c10_y_x[17] = 0.0;
  c10_y_x[18] = (-c10_t10) * c10_t42;
  c10_y_x[19] = c10_t2 * c10_t42;
  c10_y_x[20] = 0.0;
  c10_y_x[21] = c10_t13 * c10_t2;
  c10_y_x[22] = c10_t10 * c10_t13;
  c10_y_x[23] = -c10_t11;
  c10_y_x[24] = ((((-c10_t12) * c10_t34 + c10_t21 * c10_t50) + c10_t13 * c10_t2 *
                  (c10_y * c10_t15 + c10_t12 * c10_t15 * c10_t19)) -
                 c10_t13 * c10_t15 * c10_t2) - c10_t10 * c10_t14 * c10_t37;
  c10_y_x[25] = (((((((-c10_L1) * c10_t10 * c10_t12 - c10_L5 * c10_t14 * c10_t2)
                     + c10_L1 * c10_t11 * c10_t14 * c10_t2) - c10_L2 *
                    c10_t13 * c10_t14 * c10_t2) - c10_L4 * c10_t10 * c10_t12 *
                   c10_t13) + c10_L5 * c10_t10 * c10_t11 * c10_t12) - c10_L3 *
                 c10_t10 *
                 c10_t12 * c10_t4) + c10_L3 * c10_t14 * c10_t2 * c10_t7;
  c10_y_x[26] = c10_t12 * c10_t46;
  c10_y_x[27] = (-c10_t38) + c10_t47;
  c10_y_x[28] = c10_t12 * c10_t2 + c10_t10 * c10_t11 * c10_t14;
  c10_y_x[29] = c10_t13 * c10_t14;
  c10_y_x[30] = (((-c10_t20) * ((c10_t10 * (((((-c10_L1) - c10_L3) + c10_t16) +
    c10_t17) + c10_t18) - c10_t10 * c10_t15 * c10_t19) +
    c10_t11 * c10_t14 * c10_t15 * c10_t2) - c10_t15 * c10_t39) - c10_t22 *
                 ((c10_t14 * c10_t34 + c10_t13 * c10_t2 * (c10_t12 * c10_t14
    * c10_t15 - c10_t14 * c10_t15 * c10_t19)) - c10_t10 * c10_t12 * c10_t37)) +
    c10_t39 * (c10_t20 * (c10_t15 * c10_t23 - c10_t21 *
    c10_t22) + c10_t22 * (c10_t15 * c10_t22 + c10_t21 * c10_t23));
  c10_y_x[31] = ((((((((((c10_L4 * c10_t2 * c10_t20 - c10_L1 * c10_t10 * c10_t14
    * c10_t22) + c10_L1 * c10_t13 * c10_t2 * c10_t20) +
                        c10_L2 * c10_t11 * c10_t2 * c10_t20) + c10_L5 * c10_t12 *
                       c10_t2 * c10_t22) + c10_L3 * c10_t2 * c10_t20 * c10_t5) -
                     c10_L1 * c10_t11
                     * c10_t12 * c10_t2 * c10_t22) + c10_L2 * c10_t12 * c10_t13 *
                    c10_t2 * c10_t22) - c10_L4 * c10_t10 * c10_t13 * c10_t14 *
                   c10_t22) +
                  c10_L5 * c10_t10 * c10_t11 * c10_t14 * c10_t22) - c10_L3 *
                 c10_t10 * c10_t14 * c10_t22 * c10_t4) - c10_L3 * c10_t12 *
    c10_t2 *
    c10_t22 * c10_t7;
  c10_y_x[32] = c10_t14 * c10_t22 * c10_t46;
  c10_y_x[33] = (-c10_t22) * c10_t50 + c10_t13 * c10_t2 * c10_t20;
  c10_y_x[34] = c10_t22 * (c10_t14 * c10_t2 - c10_t10 * c10_t11 * c10_t12) +
    c10_t10 * c10_t13 * c10_t20;
  c10_y_x[35] = (-c10_t11) * c10_t20 - c10_t12 * c10_t13 * c10_t22;
  for (c10_k = 1; c10_k < 37; c10_k = c10_k + 1) {
    c10_b_k = c10_k;
    c10_b_spat_Jacobian[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c10_b_k), 1, 36, 1, 0) - 1] = c10_y_x[
  ...
  c10_in1[9], real_T c10_in2[6], real_T c10_gst[16])
{
  ...
  int32_T c10_k;
  int32_T c10_b_k;
  sf_debug_symbol_scope_push_eml(0U, 68U, 68U, c10_c_debug_family_names,
    c10_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c10_A1, c10_d_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(&c10_A2, c10_d_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(&c10_A3, c10_d_sf_marshall, 2U);
  ...
  sf_debug_symbol_scope_add_eml(c10_in2, c10_g_sf_marshall, 66U);
...
static const mxArray *c10_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  real_T c10_c_u[3];
  const mxArray *c10_b_y = NULL;
  SFc10_KinConInstanceStruct *chartInstance;
  chartInstance = (SFc10_KinConInstanceStruct *)chartInstanceVoid;
  c10_y = NULL;
  for (c10_i35 = 0; c10_i35 < 3; c10_i35 = c10_i35 + 1) {
    c10_b_u[c10_i35] = (*((real_T (*)[3])c10_u))[c10_i35];
  }

  for (c10_i36 = 0; c10_i36 < 3; c10_i36 = c10_i36 + 1) {
    c10_c_u[c10_i36] = c10_b_u[c10_i36];
  }
...
static const mxArray *c10_b_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  chartInstance = (SFc10_KinConInstanceStruct *)chartInstanceVoid;
  c10_y = NULL;
  for (c10_i37 = 0; c10_i37 < 9; c10_i37 = c10_i37 + 1) {
    c10_b_u[c10_i37] = (*((real_T (*)[9])c10_u))[c10_i37];
  }

  for (c10_i38 = 0; c10_i38 < 9; c10_i38 = c10_i38 + 1) {
    c10_c_u[c10_i38] = c10_b_u[c10_i38];
  }
...
static const mxArray *c10_c_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  for (c10_i39 = 0; c10_i39 < 6; c10_i39 = c10_i39 + 1) {
    c10_b_u[c10_i39] = (*((real_T (*)[6])c10_u))[c10_i39];
  }

  for (c10_i40 = 0; c10_i40 < 6; c10_i40 = c10_i40 + 1) {
    c10_c_u[c10_i40] = c10_b_u[c10_i40];
  }
...
static const mxArray *c10_e_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  c10_y = NULL;
  c10_i41 = 0;
  for (c10_i42 = 0; c10_i42 < 4; c10_i42 = c10_i42 + 1) {
    for (c10_i43 = 0; c10_i43 < 4; c10_i43 = c10_i43 + 1) {
      c10_b_u[c10_i43 + c10_i41] = (*((real_T (*)[16])c10_u))[c10_i43 + c10_i41];
    }
  ...
  c10_i44 = 0;
  for (c10_i45 = 0; c10_i45 < 4; c10_i45 = c10_i45 + 1) {
    for (c10_i46 = 0; c10_i46 < 4; c10_i46 = c10_i46 + 1) {
      c10_c_u[c10_i46 + c10_i44] = c10_b_u[c10_i46 + c10_i44];
    }
...
static const mxArray *c10_f_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  c10_y = NULL;
  c10_i47 = 0;
  for (c10_i48 = 0; c10_i48 < 6; c10_i48 = c10_i48 + 1) {
    for (c10_i49 = 0; c10_i49 < 6; c10_i49 = c10_i49 + 1) {
      c10_b_u[c10_i49 + c10_i47] = (*((real_T (*)[36])c10_u))[c10_i49 + c10_i47];
    }
  ...
  c10_i50 = 0;
  for (c10_i51 = 0; c10_i51 < 6; c10_i51 = c10_i51 + 1) {
    for (c10_i52 = 0; c10_i52 < 6; c10_i52 = c10_i52 + 1) {
      c10_c_u[c10_i52 + c10_i50] = c10_b_u[c10_i52 + c10_i50];
    }
  ...
  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", c10_c_u, 0, 0U, 1U, 0U, 2, 6, 6));
  sf_mex_assign(&c10_y, c10_b_y);
  return c10_y;
}
...
static const mxArray *c10_g_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  chartInstance = (SFc10_KinConInstanceStruct *)chartInstanceVoid;
  c10_y = NULL;
  for (c10_i53 = 0; c10_i53 < 6; c10_i53 = c10_i53 + 1) {
    c10_b_u[c10_i53] = (*((real_T (*)[6])c10_u))[c10_i53];
  }

  for (c10_i54 = 0; c10_i54 < 6; c10_i54 = c10_i54 + 1) {
    c10_c_u[c10_i54] = c10_b_u[c10_i54];
  }
...
const mxArray *sf_c10_KinCon_get_eml_resolved_functions_info(void)
{
  const mxArray *c10_nameCaptureInfo = NULL;
  c10_ResolvedFunctionInfo c10_info[59];
  const mxArray *c10_m0 = NULL;
  int32_T c10_i55;
  c10_ResolvedFunctionInfo *c10_r0;
  c10_nameCaptureInfo = NULL;
  c10_info_helper(c10_info);
  sf_mex_assign(&c10_m0, sf_mex_createstruct("nameCaptureInfo", 1, 59));
  for (c10_i55 = 0; c10_i55 < 59; c10_i55 = c10_i55 + 1) {
    c10_r0 = &c10_info[c10_i55];
    sf_mex_addfield(c10_m0, sf_mex_create("nameCaptureInfo", c10_r0->context, 15,
      0U, 0U, 0U, 2, 1, strlen(c10_r0->context)), "context"
                    , "nameCaptureInfo", c10_i55);
...
static void c10_info_helper(c10_ResolvedFunctionInfo c10_info[59])
{
  ...
  c10_info[1].context = "";
  c10_info[1].name = "spat_Jacobian";
  c10_info[1].dominantType = "double";
  c10_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[1].fileLength = 2169U;
  c10_info[1].fileTime1 = 1366807304U;
  c10_info[1].fileTime2 = 0U;
  c10_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[2].name = "cos";
  ...
  c10_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[8].name = "plus";
  c10_info[8].dominantType = "double";
  c10_info[8].resolved = "[B]plus";
  c10_info[8].fileLength = 0U;
  c10_info[8].fileTime1 = 0U;
  c10_info[8].fileTime2 = 0U;
  c10_info[9].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[9].name = "sin";
  c10_info[9].dominantType = "double";
  c10_info[9].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c10_info[9].fileLength = 324U;
  c10_info[9].fileTime1 = 1203422842U;
  c10_info[9].fileTime2 = 0U;
  c10_info[10].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c10_info[10].name = "eml_scalar_sin";
  c10_info[10].dominantType = "double";
  c10_info[10].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c10_info[10].fileLength = 601U;
  c10_info[10].fileTime1 = 1209309190U;
  c10_info[10].fileTime2 = 0U;
  c10_info[11].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[11].name = "minus";
  c10_info[11].dominantType = "double";
  c10_info[11].resolved = "[B]minus";
  c10_info[11].fileLength = 0U;
  c10_info[11].fileTime1 = 0U;
  c10_info[11].fileTime2 = 0U;
  c10_info[12].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[12].name = "times";
  c10_info[12].dominantType = "double";
  c10_info[12].resolved = "[B]times";
  c10_info[12].fileLength = 0U;
  c10_info[12].fileTime1 = 0U;
  c10_info[12].fileTime2 = 0U;
  c10_info[13].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c10_info[14].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[14].name = "power";
  c10_info[14].dominantType = "double";
  c10_info[14].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[14].fileLength = 5380U;
  c10_info[14].fileTime1 = 1228068698U;
  c10_info[14].fileTime2 = 0U;
  c10_info[15].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  ...
  c10_info[16].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[16].name = "eml_scalar_eg";
  c10_info[16].dominantType = "double";
  c10_info[16].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c10_info[16].fileLength = 3068U;
  c10_info[16].fileTime1 = 1240240410U;
  c10_info[16].fileTime2 = 0U;
  c10_info[17].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m!any_enums";
  c10_info[17].name = "false";
  c10_info[17].dominantType = "";
  c10_info[17].resolved = "[B]false";
  c10_info[17].fileLength = 0U;
  c10_info[17].fileTime1 = 0U;
  c10_info[17].fileTime2 = 0U;
  c10_info[18].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c10_info[18].name = "isstruct";
  c10_info[18].dominantType = "double";
  c10_info[18].resolved = "[B]isstruct";
  ...
  c10_info[21].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m!zerosum";
  c10_info[21].name = "cast";
  c10_info[21].dominantType = "double";
  c10_info[21].resolved = "[B]cast";
  c10_info[21].fileLength = 0U;
  c10_info[21].fileTime1 = 0U;
  c10_info[21].fileTime2 = 0U;
  c10_info[22].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[22].name = "eml_scalexp_alloc";
  c10_info[22].dominantType = "double";
  c10_info[22].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c10_info[22].fileLength = 932U;
  c10_info[22].fileTime1 = 1261926670U;
  c10_info[22].fileTime2 = 0U;
  c10_info[23].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c10_info[23].name = "isscalar";
  c10_info[23].dominantType = "double";
  c10_info[23].resolved = "[B]isscalar";
  c10_info[23].fileLength = 0U;
  c10_info[23].fileTime1 = 0U;
  c10_info[23].fileTime2 = 0U;
  c10_info[24].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c10_info[24].name = "not";
  c10_info[24].dominantType = "logical";
  c10_info[24].resolved = "[B]not";
  c10_info[24].fileLength = 0U;
  c10_info[24].fileTime1 = 0U;
  c10_info[24].fileTime2 = 0U;
  c10_info[25].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[25].name = "lt";
  c10_info[25].dominantType = "double";
  c10_info[25].resolved = "[B]lt";
  c10_info[25].fileLength = 0U;
  c10_info[25].fileTime1 = 0U;
  c10_info[25].fileTime2 = 0U;
  c10_info[26].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[26].name = "eml_scalar_floor";
  c10_info[26].dominantType = "double";
  c10_info[26].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c10_info[26].fileLength = 260U;
  c10_info[26].fileTime1 = 1209309190U;
  c10_info[26].fileTime2 = 0U;
  c10_info[27].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[27].name = "ne";
  c10_info[27].dominantType = "double";
  c10_info[27].resolved = "[B]ne";
  c10_info[27].fileLength = 0U;
  c10_info[27].fileTime1 = 0U;
  c10_info[27].fileTime2 = 0U;
  c10_info[28].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c10_info[28].name = "eml_error";
  c10_info[28].dominantType = "char";
  c10_info[28].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c10_info[28].fileLength = 315U;
  c10_info[28].fileTime1 = 1213905144U;
  c10_info[28].fileTime2 = 0U;
  c10_info[29].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c10_info[29].name = "strcmp";
  c10_info[29].dominantType = "char";
  c10_info[29].resolved = "[B]strcmp";
  c10_info[29].fileLength = 0U;
  c10_info[29].fileTime1 = 0U;
  c10_info[29].fileTime2 = 0U;
  c10_info[30].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c10_info[30].name = "reshape";
  c10_info[30].dominantType = "double";
  c10_info[30].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c10_info[30].fileLength = 4857U;
  c10_info[30].fileTime1 = 1242276774U;
  ...
  c10_info[31].fileLength = 909U;
  c10_info[31].fileTime1 = 1192445182U;
  c10_info[31].fileTime2 = 0U;
  c10_info[32].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c10_info[32].name = "size";
  c10_info[32].dominantType = "double";
  c10_info[32].resolved = "[B]size";
  ...
  c10_info[37].resolved = "[B]le";
  c10_info[37].fileLength = 0U;
  c10_info[37].fileTime1 = 0U;
  c10_info[37].fileTime2 = 0U;
  c10_info[38].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!numel_for_size";
  c10_info[38].name = "double";
  c10_info[38].dominantType = "double";
  c10_info[38].resolved = "[B]double";
  c10_info[38].fileLength = 0U;
  c10_info[38].fileTime1 = 0U;
  c10_info[38].fileTime2 = 0U;
  c10_info[39].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!numel_for_size";
  c10_info[39].name = "mtimes";
  c10_info[39].dominantType = "double";
  c10_info[39].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c10_info[39].fileLength = 3425U;
  c10_info[39].fileTime1 = 1251010272U;
  c10_info[39].fileTime2 = 0U;
  c10_info[40].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c10_info[40].name = "intmax";
  c10_info[40].dominantType = "char";
  c10_info[40].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c10_info[40].fileLength = 1535U;
  c10_info[40].fileTime1 = 1192445128U;
  c10_info[40].fileTime2 = 0U;
  c10_info[41].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c10_info[41].name = "ischar";
  c10_info[41].dominantType = "char";
  c10_info[41].resolved = "[B]ischar";
  c10_info[41].fileLength = 0U;
  c10_info[41].fileTime1 = 0U;
  c10_info[41].fileTime2 = 0U;
  c10_info[42].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c10_info[42].name = "int32";
  c10_info[42].dominantType = "double";
  c10_info[42].resolved = "[B]int32";
  c10_info[42].fileLength = 0U;
  c10_info[42].fileTime1 = 0U;
  c10_info[42].fileTime2 = 0U;
  c10_info[43].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c10_info[43].name = "ones";
  c10_info[43].dominantType = "char";
  c10_info[43].resolved = "[B]ones";
  c10_info[43].fileLength = 0U;
  c10_info[43].fileTime1 = 0U;
  c10_info[43].fileTime2 = 0U;
  c10_info[44].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c10_info[44].name = "ndims";
  c10_info[44].dominantType = "double";
  c10_info[44].resolved = "[B]ndims";
  c10_info[44].fileLength = 0U;
  c10_info[44].fileTime1 = 0U;
  c10_info[44].fileTime2 = 0U;
  c10_info[45].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c10_info[45].name = "isempty";
  c10_info[45].dominantType = "double";
  c10_info[45].resolved = "[B]isempty";
  c10_info[45].fileLength = 0U;
  c10_info[45].fileTime1 = 0U;
  c10_info[45].fileTime2 = 0U;
  c10_info[46].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c10_info[46].name = "eml_xgemm";
  c10_info[46].dominantType = "int32";
  c10_info[46].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c10_info[46].fileLength = 3184U;
  c10_info[46].fileTime1 = 1209309252U;
  c10_info[46].fileTime2 = 0U;
  c10_info[47].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!itcount";
  c10_info[47].name = "length";
  c10_info[47].dominantType = "double";
  c10_info[47].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c10_info[47].fileLength = 326U;
  c10_info[47].fileTime1 = 1226552074U;
  c10_info[47].fileTime2 = 0U;
  c10_info[48].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!itcount";
  c10_info[48].name = "min";
  c10_info[48].dominantType = "double";
  c10_info[48].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c10_info[48].fileLength = 362U;
  c10_info[48].fileTime1 = 1245080764U;
  c10_info[48].fileTime2 = 0U;
  c10_info[49].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c10_info[49].name = "nargout";
  c10_info[49].dominantType = "";
  c10_info[49].resolved = "[B]nargout";
  c10_info[49].fileLength = 0U;
  c10_info[49].fileTime1 = 0U;
  c10_info[49].fileTime2 = 0U;
  c10_info[50].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c10_info[50].name = "eml_min_or_max";
  c10_info[50].dominantType = "char";
  c10_info[50].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c10_info[50].fileLength = 9967U;
  c10_info[50].fileTime1 = 1261926670U;
  c10_info[50].fileTime2 = 0U;
  c10_info[51].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c10_info[51].name = "isnumeric";
  c10_info[51].dominantType = "double";
  c10_info[51].resolved = "[B]isnumeric";
  c10_info[51].fileLength = 0U;
  c10_info[51].fileTime1 = 0U;
  c10_info[51].fileTime2 = 0U;
  c10_info[52].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m!eml_bin_extremum";
  c10_info[52].name = "islogical";
  c10_info[52].dominantType = "double";
  c10_info[52].resolved = "[B]islogical";
  c10_info[52].fileLength = 0U;
  c10_info[52].fileTime1 = 0U;
  c10_info[52].fileTime2 = 0U;
  c10_info[53].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m";
  c10_info[53].name = "eml_refblas_xgemm";
  c10_info[53].dominantType = "int32";
  c10_info[53].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c10_info[53].fileLength = 5748U;
  c10_info[53].fileTime1 = 1228068672U;
  c10_info[53].fileTime2 = 0U;
  c10_info[54].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c10_info[54].name = "eml_index_minus";
  c10_info[54].dominantType = "int32";
  c10_info[54].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  c10_info[54].fileLength = 277U;
  c10_info[54].fileTime1 = 1192445184U;
  c10_info[54].fileTime2 = 0U;
  c10_info[55].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c10_info[55].name = "eml_index_times";
  c10_info[55].dominantType = "int32";
  c10_info[55].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  c10_info[55].fileLength = 280U;
  c10_info[55].fileTime1 = 1192445186U;
  c10_info[55].fileTime2 = 0U;
  c10_info[56].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c10_info[56].name = "eml_index_plus";
  c10_info[56].dominantType = "int32";
  c10_info[56].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c10_info[56].fileLength = 272U;
  c10_info[56].fileTime1 = 1192445184U;
  c10_info[56].fileTime2 = 0U;
  c10_info[57].context = "";
  c10_info[57].name = "fwd_kin";
  c10_info[57].dominantType = "double";
  c10_info[57].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c10_info[57].fileLength = 3324U;
  c10_info[57].fileTime1 = 1366778959U;
  c10_info[57].fileTime2 = 0U;
  c10_info[58].context = "";
  c10_info[58].name = "cross";
  c10_info[58].dominantType = "double";
  c10_info[58].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m";
  c10_info[58].fileLength = 3157U;
  c10_info[58].fileTime1 = 1240240462U;
...
static void c10_emlrt_marshallIn(SFc10_KinConInstanceStruct *chartInstance,
  const mxArray *c10_EndVel, const char_T *c10_name,
  real_T c10_y[3])
{
  real_T c10_dv3[3];
  int32_T c10_i56;
  sf_mex_import(c10_name, sf_mex_dup(c10_EndVel), c10_dv3, 1, 0, 0U, 1, 0U, 1, 3);
  for (c10_i56 = 0; c10_i56 < 3; c10_i56 = c10_i56 + 1) {
    c10_y[c10_i56] = c10_dv3[c10_i56];
  }

  sf_mex_destroy(&c10_EndVel);
}

static uint8_T c10_b_emlrt_marshallIn(SFc10_KinConInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_KinCon, const
  char_T *c10_name)
{
  uint8_T c10_y;
  uint8_T c10_u0;
  sf_mex_import(c10_name, sf_mex_dup(c10_b_is_active_c10_KinCon), &c10_u0, 1, 3,
                0U, 0, 0U, 0);
  c10_y = c10_u0;
  sf_mex_destroy(&c10_b_is_active_c10_KinCon);
  return c10_y;
}
...
/* SFunction Glue Code */
void sf_c10_KinCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_KinCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c10_KinCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c10_KinCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_KinCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_KinConInstanceStruct *chartInstance;
    chartInstance = (SFc10_KinConInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c10_Omega);
          _SFD_SET_DATA_VALUE_PTR(2U, *c10_EndVel);
...
static void sf_opaque_initialize_c10_KinCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_KinConInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
  initialize_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_KinCon(void *chartInstanceVar)
{
  enable_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_KinCon(void *chartInstanceVar)
{
  disable_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_KinCon(void *chartInstanceVar)
{
  sf_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c10_KinCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_KinCon((SFc10_KinConInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c10_KinCon();/* state var info */
...
static void sf_internal_set_sim_state_c10_KinCon(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_KinCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c10_KinCon((SFc10_KinConInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c10_KinCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_KinCon(S);
}

static void sf_opaque_set_sim_state_c10_KinCon(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_KinCon(S, st);
}

static void sf_opaque_terminate_c10_KinCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_KinConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_KinCon((SFc10_KinConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c10_KinCon((SFc10_KinConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_KinCon(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_KinCon((SFc10_KinConInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_KinCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"KinCon","KinCon",10);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"KinCon","KinCon",10,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"KinCon","KinCon",10,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"KinCon","KinCon",10,2);
      sf_mark_chart_reusable_outputs(S,"KinCon","KinCon",10,1);
    }

    sf_set_rtw_dwork_info(S,"KinCon","KinCon",10);
...
static void mdlRTW_c10_KinCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "KinCon", "KinCon",10);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c10_KinCon(SimStruct *S)
{
  SFc10_KinConInstanceStruct *chartInstance;
  chartInstance = (SFc10_KinConInstanceStruct *)malloc(sizeof
    (SFc10_KinConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_KinConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_KinCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_KinCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_KinCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_KinCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_KinCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_KinCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_KinCon;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_KinCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_KinCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_KinCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_KinCon;
...
void c10_KinCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_KinCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_KinCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_KinCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_KinCon_method_dispatcher.\n"
