...
static void initialize_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct
  *chartInstance);
static void initialize_params_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct *
  chartInstance);
static void enable_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct
  *chartInstance);
static void disable_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_EulerPIDJoint
  (SFc5_EulerPIDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_EulerPIDJoint
  (SFc5_EulerPIDJointInstanceStruct *chartInstance);
static void set_sim_state_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct
  *chartInstance);
static void sf_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct *chartInstance);
static void c5_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c5_EulerPIDJoint
  (SFc5_EulerPIDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static void c5_logspace(SFc5_EulerPIDJointInstanceStruct *chartInstance, real_T
  c5_d1, real_T c5_d2, real_T c5_y[50]);
static void c5_eml_warning(SFc5_EulerPIDJointInstanceStruct *chartInstance);
static void c5_eml_scalar_eg(SFc5_EulerPIDJointInstanceStruct *chartInstance);
...
static real_T c5_emlrt_marshallIn(SFc5_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c5_Amp, const char_T *c5_name);
static uint8_T c5_b_emlrt_marshallIn(SFc5_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_EulerPIDJoint, const char_T
  *c5_name);
static void init_dsm_address_info(SFc5_EulerPIDJointInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_EulerPIDJoint = 0U;
}
  ...
  (SFc5_EulerPIDJointInstanceStruct *chartInstance)
{
  ...
  c5_f_hoistedGlobal = chartInstance->c5_is_active_c5_EulerPIDJoint;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  *c5_Ramp = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    4)), "Ramp");
  chartInstance->c5_is_active_c5_EulerPIDJoint = c5_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 5)),
     "is_active_c5_EulerPIDJoint");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_EulerPIDJoint(chartInstance);
...
static void sf_c5_EulerPIDJoint(SFc5_EulerPIDJointInstanceStruct *chartInstance)
{
  ...
  c5_c5_EulerPIDJoint(chartInstance);
...
static const mxArray *c5_sf_marshall(void *chartInstanceVoid, void *c5_u)
{
  ...
  const mxArray *c5_b_y = NULL;
  SFc5_EulerPIDJointInstanceStruct *chartInstance;
  chartInstance = (SFc5_EulerPIDJointInstanceStruct *)chartInstanceVoid;
  c5_y = NULL;
  c5_b_u = *((real_T *)c5_u);
  c5_b_y = NULL;
...
const mxArray *sf_c5_EulerPIDJoint_get_eml_resolved_functions_info(void)
{
...
static uint8_T c5_b_emlrt_marshallIn(SFc5_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_EulerPIDJoint
  , const char_T *c5_name)
{
  uint8_T c5_y;
  uint8_T c5_u0;
  sf_mex_import(c5_name, sf_mex_dup(c5_b_is_active_c5_EulerPIDJoint), &c5_u0, 1,
                3, 0U, 0, 0U, 0);
  c5_y = c5_u0;
  sf_mex_destroy(&c5_b_is_active_c5_EulerPIDJoint);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_EulerPIDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_EulerPIDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c5_EulerPIDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"Amp\",},{M[1],M[9],T\"CounterOut\",},{M[1],M[4],T\"Frq\",},{M[1],M[7],T\"PeriodFlag\",},{M[1],M[11],T\"Ramp\",},{M[8],M[0],T\"is_active_c5_EulerPIDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_EulerPIDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_EulerPIDJointInstanceStruct *chartInstance;
    chartInstance = (SFc5_EulerPIDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_EulerPIDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_EulerPIDJointInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_EulerPIDJoint(void *chartInstanceVar)
{
  enable_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_EulerPIDJoint(void *chartInstanceVar)
{
  disable_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_EulerPIDJoint(void *chartInstanceVar)
{
  sf_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c5_EulerPIDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_EulerPIDJoint
    ((SFc5_EulerPIDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c5_EulerPIDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c5_EulerPIDJoint(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_EulerPIDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c5_EulerPIDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_EulerPIDJoint(S);
}

static void sf_opaque_set_sim_state_c5_EulerPIDJoint(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c5_EulerPIDJoint(S, st);
}

static void sf_opaque_terminate_c5_EulerPIDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_EulerPIDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_EulerPIDJoint((SFc5_EulerPIDJointInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c5_EulerPIDJoint
    ((SFc5_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_EulerPIDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_EulerPIDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerPIDJoint","EulerPIDJoint",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerPIDJoint","EulerPIDJoint",5,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerPIDJoint",
      "EulerPIDJoint",5,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerPIDJoint","EulerPIDJoint",5,3);
      sf_mark_chart_reusable_outputs(S,"EulerPIDJoint","EulerPIDJoint",5,5);
    }

    sf_set_rtw_dwork_info(S,"EulerPIDJoint","EulerPIDJoint",5);
...
static void mdlRTW_c5_EulerPIDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerPIDJoint", "EulerPIDJoint",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_EulerPIDJoint(SimStruct *S)
{
  SFc5_EulerPIDJointInstanceStruct *chartInstance;
  chartInstance = (SFc5_EulerPIDJointInstanceStruct *)malloc(sizeof
    (SFc5_EulerPIDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_EulerPIDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_EulerPIDJoint;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_EulerPIDJoint;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_EulerPIDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_EulerPIDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_EulerPIDJoint;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_EulerPIDJoint;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_EulerPIDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_EulerPIDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_EulerPIDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_EulerPIDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_EulerPIDJoint;
...
void c5_EulerPIDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_EulerPIDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_EulerPIDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_EulerPIDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_EulerPIDJoint_method_dispatcher.\n"
