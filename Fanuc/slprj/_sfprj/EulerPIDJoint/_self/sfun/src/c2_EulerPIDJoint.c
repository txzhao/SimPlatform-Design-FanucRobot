...
static void initialize_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct
  *chartInstance);
static void initialize_params_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct *
  chartInstance);
static void enable_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct
  *chartInstance);
static void disable_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_EulerPIDJoint
  (SFc2_EulerPIDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_EulerPIDJoint
  (SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void set_sim_state_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct
  *chartInstance);
static void sf_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void c2_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c2_EulerPIDJoint
  (SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static void c2_fwd_kin(SFc2_EulerPIDJointInstanceStruct *chartInstance, real_T
  c2_in1[9], real_T c2_in2[6], real_T c2_gst[16]);
static void c2_body_Jacobian(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  real_T c2_in1[9], real_T c2_in2[6], real_T c2_b_body_Jacobian[36]);
static void c2_AdjointInv(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  real_T c2_g[16], real_T c2_Adg_inv[36]);
static void c2_eml_scalar_eg(SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void c2_eps(SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  real_T c2_A[36], real_T c2_b_A[36], int32_T c2_ipiv[6], int32_T *c2_info);
static int32_T c2_eml_ixamax(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[36], int32_T c2_ix0);
static int32_T c2_ceval_ixamax(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[36], int32_T c2_ix0, int32_T c2_incx);
static void c2_ceval_xswap(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[36], int32_T c2_ix0, int32_T c2_incx, int32_T c2_iy0,
  int32_T c2_incy, real_T c2_b_x[36]);
static void c2_ceval_xger(SFc2_EulerPIDJointInstanceStruct *chartInstance,
...
static void c2_eml_warning(SFc2_EulerPIDJointInstanceStruct *chartInstance);
static void c2_eml_blas_xtrsm(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  ...
  c2_b_B[36]);
static void c2_ceval_xtrsm(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_alpha1, real_T c2_A[36], int32_T c2_ia0,
  int32_T c2_lda, real_T c2_B[36], int32_T c2_ib0, int32_T c2_ldb, real_T
  c2_b_B[36]);
static void c2_b_eml_blas_xtrsm(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_alpha1, real_T c2_A[36], int32_T c2_ia0,
  int32_T c2_lda, real_T c2_B[36], int32_T c2_ib0, int32_T c2_ldb, real_T
  c2_b_B[36]);
static void c2_b_ceval_xtrsm(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_alpha1, real_T c2_A[36], int32_T c2_ia0,
  int32_T c2_lda, real_T c2_B[36], int32_T c2_ib0, int32_T c2_ldb, real_T
  c2_b_B[36]);
static void c2_b_eml_scalar_eg(SFc2_EulerPIDJointInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  const mxArray *c2_Omega, const char_T *c2_name, real_T c2_y[6]);
static uint8_T c2_b_emlrt_marshallIn(SFc2_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_EulerPIDJoint, const char_T
  *c2_name);
static void init_dsm_address_info(SFc2_EulerPIDJointInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_EulerPIDJoint = 0U;
}
  ...
  (SFc2_EulerPIDJointInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_EulerPIDJoint;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_EulerPIDJoint = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_EulerPIDJoint");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_EulerPIDJoint(chartInstance);
...
static void sf_c2_EulerPIDJoint(SFc2_EulerPIDJointInstanceStruct *chartInstance)
{
  ...
  c2_c2_EulerPIDJoint(chartInstance);
...
static void c2_eml_matlab_zgetrf(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  real_T c2_A[36], real_T c2_b_A[36], int32_T
...
static void c2_ceval_xswap(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[36], int32_T c2_ix0, int32_T
  c2_incx, int32_T c2_iy0, int32_T c2_incy, real_T c2_b_x[36])
{
  int32_T c2_i120;
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_EulerPIDJointInstanceStruct *chartInstance;
  chartInstance = (SFc2_EulerPIDJointInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
...
const mxArray *sf_c2_EulerPIDJoint_get_eml_resolved_functions_info(void)
{
...
static void c2_emlrt_marshallIn(SFc2_EulerPIDJointInstanceStruct *chartInstance,
  const mxArray *c2_Omega, const char_T *c2_name,
  real_T c2_y[6])
{
  real_T c2_dv5[6];
  int32_T c2_i159;
...
static uint8_T c2_b_emlrt_marshallIn(SFc2_EulerPIDJointInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_EulerPIDJoint
  , const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u0;
  sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_EulerPIDJoint), &c2_u0, 1,
                3, 0U, 0, 0U, 0);
  c2_y = c2_u0;
  sf_mex_destroy(&c2_b_is_active_c2_EulerPIDJoint);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_EulerPIDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_EulerPIDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_EulerPIDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Omega\",},{M[8],M[0],T\"is_active_c2_EulerPIDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_EulerPIDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_EulerPIDJointInstanceStruct *chartInstance;
    chartInstance = (SFc2_EulerPIDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_EulerPIDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_EulerPIDJointInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_EulerPIDJoint(void *chartInstanceVar)
{
  enable_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_EulerPIDJoint(void *chartInstanceVar)
{
  disable_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_EulerPIDJoint(void *chartInstanceVar)
{
  sf_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_EulerPIDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_EulerPIDJoint
    ((SFc2_EulerPIDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_EulerPIDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c2_EulerPIDJoint(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_EulerPIDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_EulerPIDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_EulerPIDJoint(S);
}

static void sf_opaque_set_sim_state_c2_EulerPIDJoint(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_EulerPIDJoint(S, st);
}

static void sf_opaque_terminate_c2_EulerPIDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_EulerPIDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_EulerPIDJoint((SFc2_EulerPIDJointInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c2_EulerPIDJoint
    ((SFc2_EulerPIDJointInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_EulerPIDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_EulerPIDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerPIDJoint","EulerPIDJoint",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerPIDJoint","EulerPIDJoint",2,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerPIDJoint",
      "EulerPIDJoint",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerPIDJoint","EulerPIDJoint",2,2);
      sf_mark_chart_reusable_outputs(S,"EulerPIDJoint","EulerPIDJoint",2,1);
    }

    sf_set_rtw_dwork_info(S,"EulerPIDJoint","EulerPIDJoint",2);
...
static void mdlRTW_c2_EulerPIDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerPIDJoint", "EulerPIDJoint",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_EulerPIDJoint(SimStruct *S)
{
  SFc2_EulerPIDJointInstanceStruct *chartInstance;
  chartInstance = (SFc2_EulerPIDJointInstanceStruct *)malloc(sizeof
    (SFc2_EulerPIDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_EulerPIDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_EulerPIDJoint;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_EulerPIDJoint;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_EulerPIDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_EulerPIDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_EulerPIDJoint;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_EulerPIDJoint;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_EulerPIDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_EulerPIDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_EulerPIDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_EulerPIDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_EulerPIDJoint;
...
void c2_EulerPIDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_EulerPIDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_EulerPIDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_EulerPIDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_EulerPIDJoint_method_dispatcher.\n"
