...
static void initialize_c1_KinConSimp(SFc1_KinConSimpInstanceStruct
  *chartInstance);
static void initialize_params_c1_KinConSimp(SFc1_KinConSimpInstanceStruct
  *chartInstance);
static void enable_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance);
static void disable_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_KinConSimp(SFc1_KinConSimpInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *
  chartInstance);
static void set_sim_state_c1_KinConSimp(SFc1_KinConSimpInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance);
static void sf_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance);
static void c1_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c1_KinConSimp
  (SFc1_KinConSimpInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static void c1_fwd_kin(SFc1_KinConSimpInstanceStruct *chartInstance, real_T
  c1_in1[9], real_T c1_in2[6], real_T c1_gst[16]);
static void c1_body_Jacobian(SFc1_KinConSimpInstanceStruct *chartInstance,
  real_T c1_in1[9], real_T c1_in2[6], real_T c1_b_body_Jacobian[36]);
static void c1_AdjointInv(SFc1_KinConSimpInstanceStruct *chartInstance, real_T
  c1_g[16], real_T c1_Adg_inv[36]);
static void c1_eml_scalar_eg(SFc1_KinConSimpInstanceStruct *chartInstance);
static void c1_eps(SFc1_KinConSimpInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_KinConSimpInstanceStruct *chartInstance,
  real_T c1_A[36], real_T c1_b_A[36], int32_T c1_ipiv[6], int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_KinConSimpInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[36], int32_T c1_ix0);
static int32_T c1_ceval_ixamax(SFc1_KinConSimpInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[36], int32_T c1_ix0, int32_T c1_incx);
static void c1_ceval_xswap(SFc1_KinConSimpInstanceStruct *chartInstance, int32_T
  c1_n, real_T c1_x[36], int32_T c1_ix0, int32_T c1_incx, int32_T c1_iy0,
  int32_T c1_incy, real_T c1_b_x[36]);
static void c1_ceval_xger(SFc1_KinConSimpInstanceStruct *chartInstance, int32_T
  ...
  real_T c1_b_A[36]);
static void c1_eml_warning(SFc1_KinConSimpInstanceStruct *chartInstance);
static void c1_eml_blas_xtrsm(SFc1_KinConSimpInstanceStruct *chartInstance,
  ...
  c1_b_B[36]);
static void c1_ceval_xtrsm(SFc1_KinConSimpInstanceStruct *chartInstance, int32_T
...
static void c1_b_eml_blas_xtrsm(SFc1_KinConSimpInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_alpha1, real_T c1_A[36], int32_T c1_ia0,
  int32_T c1_lda, real_T c1_B[36], int32_T c1_ib0, int32_T c1_ldb, real_T
  c1_b_B[36]);
static void c1_b_ceval_xtrsm(SFc1_KinConSimpInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_alpha1, real_T c1_A[36], int32_T c1_ia0,
  int32_T c1_lda, real_T c1_B[36], int32_T c1_ib0, int32_T c1_ldb, real_T
  c1_b_B[36]);
static void c1_b_eml_scalar_eg(SFc1_KinConSimpInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_KinConSimpInstanceStruct *chartInstance,
  const mxArray *c1_Omega, const char_T *c1_name, real_T c1_y[6]);
static uint8_T c1_b_emlrt_marshallIn(SFc1_KinConSimpInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_KinConSimp, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_KinConSimpInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_KinConSimp = 0U;
}
  ...
  chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_KinConSimp;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_KinConSimp = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_KinConSimp");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_KinConSimp(chartInstance);
...
static void sf_c1_KinConSimp(SFc1_KinConSimpInstanceStruct *chartInstance)
{
  ...
  c1_c1_KinConSimp(chartInstance);
...
static void c1_ceval_xtrsm(SFc1_KinConSimpInstanceStruct *chartInstance, int32_T
  c1_m, int32_T c1_n, real_T c1_alpha1, real_T c1_A[
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_KinConSimpInstanceStruct *chartInstance;
  chartInstance = (SFc1_KinConSimpInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
...
const mxArray *sf_c1_KinConSimp_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[100])
{
  ...
  c1_info[55].fileTime1 = 1367337907U;
...
static uint8_T c1_b_emlrt_marshallIn(SFc1_KinConSimpInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_KinConSimp,
  const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_KinConSimp), &c1_u0, 1, 3,
                0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_KinConSimp);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_KinConSimp_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_KinConSimp_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_KinConSimp(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Omega\",},{M[8],M[0],T\"is_active_c1_KinConSimp\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_KinConSimp_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_KinConSimpInstanceStruct *chartInstance;
    chartInstance = (SFc1_KinConSimpInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_KinConSimp(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_KinConSimpInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*)
    chartInstanceVar);
  initialize_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_KinConSimp(void *chartInstanceVar)
{
  enable_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_KinConSimp(void *chartInstanceVar)
{
  disable_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_KinConSimp(void *chartInstanceVar)
{
  sf_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_KinConSimp(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_KinConSimp
    ((SFc1_KinConSimpInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_KinConSimp();/* state var info */
...
static void sf_internal_set_sim_state_c1_KinConSimp(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_KinConSimp();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_KinConSimp(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_KinConSimp(S);
}

static void sf_opaque_set_sim_state_c1_KinConSimp(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_KinConSimp(S, st);
}

static void sf_opaque_terminate_c1_KinConSimp(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_KinConSimpInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_KinConSimp((SFc1_KinConSimpInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_KinConSimp(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_KinConSimp(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"KinConSimp","KinConSimp",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"KinConSimp","KinConSimp",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"KinConSimp",
      "KinConSimp",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"KinConSimp","KinConSimp",1,2);
      sf_mark_chart_reusable_outputs(S,"KinConSimp","KinConSimp",1,1);
    }

    sf_set_rtw_dwork_info(S,"KinConSimp","KinConSimp",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(2585652611U));
  ssSetChecksum1(S,(250976236U));
  ssSetChecksum2(S,(3611893055U));
  ssSetChecksum3(S,(3930097536U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_KinConSimp(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "KinConSimp", "KinConSimp",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_KinConSimp(SimStruct *S)
{
  SFc1_KinConSimpInstanceStruct *chartInstance;
  chartInstance = (SFc1_KinConSimpInstanceStruct *)malloc(sizeof
    (SFc1_KinConSimpInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_KinConSimpInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_KinConSimp;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_KinConSimp;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_KinConSimp;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_KinConSimp;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_KinConSimp;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_KinConSimp;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_KinConSimp;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_KinConSimp;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_KinConSimp;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_KinConSimp;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_KinConSimp;
...
void c1_KinConSimp_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_KinConSimp(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_KinConSimp(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_KinConSimp(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_KinConSimp_method_dispatcher.\n"
