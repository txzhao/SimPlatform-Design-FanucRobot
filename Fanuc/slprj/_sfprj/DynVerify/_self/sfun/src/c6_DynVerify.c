...
static void initialize_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance);
static void initialize_params_c6_DynVerify(SFc6_DynVerifyInstanceStruct
  *chartInstance);
static void enable_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance);
static void disable_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_DynVerify(SFc6_DynVerifyInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_DynVerify(SFc6_DynVerifyInstanceStruct
  *chartInstance);
static void set_sim_state_c6_DynVerify(SFc6_DynVerifyInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance);
static void sf_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c6_DynVerify
  (SFc6_DynVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static void c6_fwd_kin(SFc6_DynVerifyInstanceStruct *chartInstance, real_T
...
static void c6_emlrt_marshallIn(SFc6_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c6_EndPos, const char_T *c6_name, real_T c6_y[3]);
static uint8_T c6_b_emlrt_marshallIn(SFc6_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_DynVerify, const char_T *c6_name);
static void init_dsm_address_info(SFc6_DynVerifyInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c6_DynVerify(SFc6_DynVerifyInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c6_is_active_c6_DynVerify = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_DynVerify;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_DynVerify = c6_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)),
    "is_active_c6_DynVerify");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_DynVerify(chartInstance);
...
static const mxArray *c6_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  const mxArray *c6_b_y = NULL;
  SFc6_DynVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc6_DynVerifyInstanceStruct *)chartInstanceVoid;
  c6_y = NULL;
...
const mxArray *sf_c6_DynVerify_get_eml_resolved_functions_info(void)
{
...
static void c6_emlrt_marshallIn(SFc6_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c6_EndPos, const char_T *c6_name, real_T
  c6_y[3])
{
  real_T c6_dv3[3];
  int32_T c6_i31;
...
static uint8_T c6_b_emlrt_marshallIn(SFc6_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_DynVerify, const
  char_T *c6_name)
{
  uint8_T c6_y;
  uint8_T c6_u0;
  sf_mex_import(c6_name, sf_mex_dup(c6_b_is_active_c6_DynVerify), &c6_u0, 1, 3,
                0U, 0, 0U, 0);
  c6_y = c6_u0;
  sf_mex_destroy(&c6_b_is_active_c6_DynVerify);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_DynVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_DynVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c6_DynVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c6_DynVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_DynVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_DynVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc6_DynVerifyInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_DynVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_DynVerifyInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c6_DynVerify((SFc6_DynVerifyInstanceStruct*)
    chartInstanceVar);
  initialize_c6_DynVerify((SFc6_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_DynVerify(void *chartInstanceVar)
{
  enable_c6_DynVerify((SFc6_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_DynVerify(void *chartInstanceVar)
{
  disable_c6_DynVerify((SFc6_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_DynVerify(void *chartInstanceVar)
{
  sf_c6_DynVerify((SFc6_DynVerifyInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c6_DynVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_DynVerify((SFc6_DynVerifyInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c6_DynVerify();/* state var info */
...
static void sf_internal_set_sim_state_c6_DynVerify(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_DynVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c6_DynVerify((SFc6_DynVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c6_DynVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_DynVerify(S);
}

static void sf_opaque_set_sim_state_c6_DynVerify(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_DynVerify(S, st);
}

static void sf_opaque_terminate_c6_DynVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_DynVerifyInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_DynVerify((SFc6_DynVerifyInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c6_DynVerify((SFc6_DynVerifyInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_DynVerify(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_DynVerify(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynVerify","DynVerify",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynVerify","DynVerify",6,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"DynVerify","DynVerify",6,1);
      sf_mark_chart_reusable_outputs(S,"DynVerify","DynVerify",6,1);
    }

    sf_set_rtw_dwork_info(S,"DynVerify","DynVerify",6);
...
static void mdlRTW_c6_DynVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynVerify", "DynVerify",6);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c6_DynVerify(SimStruct *S)
{
  SFc6_DynVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc6_DynVerifyInstanceStruct *)malloc(sizeof
    (SFc6_DynVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_DynVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_DynVerify;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_DynVerify;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_DynVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_DynVerify;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_DynVerify;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_DynVerify;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_DynVerify;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_DynVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_DynVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_DynVerify;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_DynVerify;
...
void c6_DynVerify_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_DynVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_DynVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_DynVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_DynVerify_method_dispatcher.\n"
