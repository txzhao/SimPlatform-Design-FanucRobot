...
static void initialize_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void initialize_params_c7_DynVerify(SFc7_DynVerifyInstanceStruct
  *chartInstance);
static void enable_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void disable_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_DynVerify(SFc7_DynVerifyInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c7_DynVerify(SFc7_DynVerifyInstanceStruct
  *chartInstance);
static void set_sim_state_c7_DynVerify(SFc7_DynVerifyInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void finalize_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void sf_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void c7_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c7_DynVerify
  (SFc7_DynVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static void c7_spat_Jacobian(SFc7_DynVerifyInstanceStruct *chartInstance, real_T
  c7_in1[9], real_T c7_in2[6], real_T c7_b_spat_Jacobian[36]);
static void c7_eml_scalar_eg(SFc7_DynVerifyInstanceStruct *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_DynVerifyInstanceStruct *chartInstance);
static void c7_fwd_kin(SFc7_DynVerifyInstanceStruct *chartInstance, real_T
...
static void c7_emlrt_marshallIn(SFc7_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c7_EndVel, const char_T *c7_name, real_T c7_y[3]);
static uint8_T c7_b_emlrt_marshallIn(SFc7_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c7_b_is_active_c7_DynVerify, const char_T *c7_name);
static void init_dsm_address_info(SFc7_DynVerifyInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c7_DynVerify(SFc7_DynVerifyInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c7_is_active_c7_DynVerify = 0U;
}
  ...
  *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_DynVerify;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_DynVerify = c7_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c7_u, 1)),
    "is_active_c7_DynVerify");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_DynVerify(chartInstance);
...
static const mxArray *c7_sf_marshall(void *chartInstanceVoid, void *c7_u)
{
  ...
  const mxArray *c7_b_y = NULL;
  SFc7_DynVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc7_DynVerifyInstanceStruct *)chartInstanceVoid;
  c7_y = NULL;
...
const mxArray *sf_c7_DynVerify_get_eml_resolved_functions_info(void)
{
...
static void c7_emlrt_marshallIn(SFc7_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c7_EndVel, const char_T *c7_name, real_T
  c7_y[3])
{
  real_T c7_dv3[3];
  int32_T c7_i56;
...
static uint8_T c7_b_emlrt_marshallIn(SFc7_DynVerifyInstanceStruct *chartInstance,
  const mxArray *c7_b_is_active_c7_DynVerify, const
  char_T *c7_name)
{
  uint8_T c7_y;
  uint8_T c7_u0;
  sf_mex_import(c7_name, sf_mex_dup(c7_b_is_active_c7_DynVerify), &c7_u0, 1, 3,
                0U, 0, 0U, 0);
  c7_y = c7_u0;
  sf_mex_destroy(&c7_b_is_active_c7_DynVerify);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_DynVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_DynVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c7_DynVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c7_DynVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_DynVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_DynVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc7_DynVerifyInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c7_DynVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_DynVerifyInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c7_DynVerify((SFc7_DynVerifyInstanceStruct*)
    chartInstanceVar);
  initialize_c7_DynVerify((SFc7_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_DynVerify(void *chartInstanceVar)
{
  enable_c7_DynVerify((SFc7_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_DynVerify(void *chartInstanceVar)
{
  disable_c7_DynVerify((SFc7_DynVerifyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_DynVerify(void *chartInstanceVar)
{
  sf_c7_DynVerify((SFc7_DynVerifyInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c7_DynVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_DynVerify((SFc7_DynVerifyInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c7_DynVerify();/* state var info */
...
static void sf_internal_set_sim_state_c7_DynVerify(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_DynVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c7_DynVerify((SFc7_DynVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c7_DynVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_DynVerify(S);
}

static void sf_opaque_set_sim_state_c7_DynVerify(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_DynVerify(S, st);
}

static void sf_opaque_terminate_c7_DynVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_DynVerifyInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_DynVerify((SFc7_DynVerifyInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c7_DynVerify((SFc7_DynVerifyInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_DynVerify(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_DynVerify(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynVerify","DynVerify",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynVerify","DynVerify",7,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"DynVerify","DynVerify",7,2);
      sf_mark_chart_reusable_outputs(S,"DynVerify","DynVerify",7,1);
    }

    sf_set_rtw_dwork_info(S,"DynVerify","DynVerify",7);
...
static void mdlRTW_c7_DynVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynVerify", "DynVerify",7);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c7_DynVerify(SimStruct *S)
{
  SFc7_DynVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc7_DynVerifyInstanceStruct *)malloc(sizeof
    (SFc7_DynVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_DynVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_DynVerify;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_DynVerify;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_DynVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_DynVerify;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_DynVerify;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_DynVerify;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_DynVerify;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c7_DynVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_DynVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_DynVerify;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_DynVerify;
...
void c7_DynVerify_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_DynVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_DynVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_DynVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_DynVerify_method_dispatcher.\n"
