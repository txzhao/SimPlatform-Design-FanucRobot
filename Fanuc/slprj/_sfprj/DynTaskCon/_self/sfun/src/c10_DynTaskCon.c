...
static void initialize_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct
  *chartInstance);
static void initialize_params_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct
  *chartInstance);
static void enable_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct *chartInstance);
static void disable_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_DynTaskCon
  (SFc10_DynTaskConInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_DynTaskCon
  (SFc10_DynTaskConInstanceStruct *chartInstance);
static void set_sim_state_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct
  *chartInstance);
static void sf_c10_DynTaskCon(SFc10_DynTaskConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c10_DynTaskCon
  (SFc10_DynTaskConInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static void c10_fwd_kin(SFc10_DynTaskConInstanceStruct *chartInstance, real_T
...
static void c10_emlrt_marshallIn(SFc10_DynTaskConInstanceStruct *chartInstance,
  const mxArray *c10_EndPos, const char_T *c10_name, real_T c10_y[3]);
static uint8_T c10_b_emlrt_marshallIn(SFc10_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_DynTaskCon, const char_T
  *c10_name);
static void init_dsm_address_info(SFc10_DynTaskConInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_DynTaskCon = 0U;
}
  ...
  (SFc10_DynTaskConInstanceStruct *chartInstance)
{
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_DynTaskCon;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_DynTaskCon = c10_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_DynTaskCon");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_DynTaskCon(chartInstance);
...
static const mxArray *c10_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  const mxArray *c10_b_y = NULL;
  SFc10_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc10_DynTaskConInstanceStruct *)chartInstanceVoid;
  c10_y = NULL;
...
const mxArray *sf_c10_DynTaskCon_get_eml_resolved_functions_info(void)
{
...
static void c10_info_helper(c10_ResolvedFunctionInfo c10_info[39])
{
  ...
  c10_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c10_info[1].fileLength = 3324U;
  c10_info[1].fileTime1 = 1366778959U;
  c10_info[1].fileTime2 = 0U;
  c10_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c10_info[2].name = "cos";
  ...
  c10_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c10_info[8].name = "sin";
  ...
  c10_info[10].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  ...
  c10_info[11].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  ...
  c10_info[12].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  ...
  c10_info[13].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  ...
  c10_info[14].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
...
static uint8_T c10_b_emlrt_marshallIn(SFc10_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_DynTaskCon,
  const char_T *c10_name)
{
  uint8_T c10_y;
  uint8_T c10_u0;
  sf_mex_import(c10_name, sf_mex_dup(c10_b_is_active_c10_DynTaskCon), &c10_u0, 1,
                3, 0U, 0, 0U, 0);
  c10_y = c10_u0;
  sf_mex_destroy(&c10_b_is_active_c10_DynTaskCon);
  return c10_y;
}
...
/* SFunction Glue Code */
void sf_c10_DynTaskCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_DynTaskCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c10_DynTaskCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c10_DynTaskCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_DynTaskCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_DynTaskConInstanceStruct *chartInstance;
    chartInstance = (SFc10_DynTaskConInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_DynTaskCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_DynTaskConInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*)
    chartInstanceVar);
  initialize_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_DynTaskCon(void *chartInstanceVar)
{
  enable_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_DynTaskCon(void *chartInstanceVar)
{
  disable_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_DynTaskCon(void *chartInstanceVar)
{
  sf_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c10_DynTaskCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_DynTaskCon
    ((SFc10_DynTaskConInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c10_DynTaskCon();/* state var info */
...
static void sf_internal_set_sim_state_c10_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_DynTaskCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c10_DynTaskCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_DynTaskCon(S);
}

static void sf_opaque_set_sim_state_c10_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c10_DynTaskCon(S, st);
}

static void sf_opaque_terminate_c10_DynTaskCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_DynTaskConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c10_DynTaskCon((SFc10_DynTaskConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_DynTaskCon(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_DynTaskCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynTaskCon","DynTaskCon",10);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynTaskCon","DynTaskCon",10,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynTaskCon",
      "DynTaskCon",10,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynTaskCon","DynTaskCon",10,1);
      sf_mark_chart_reusable_outputs(S,"DynTaskCon","DynTaskCon",10,1);
    }

    sf_set_rtw_dwork_info(S,"DynTaskCon","DynTaskCon",10);
...
static void mdlRTW_c10_DynTaskCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynTaskCon", "DynTaskCon",10);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c10_DynTaskCon(SimStruct *S)
{
  SFc10_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc10_DynTaskConInstanceStruct *)malloc(sizeof
    (SFc10_DynTaskConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_DynTaskConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_DynTaskCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_DynTaskCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_DynTaskCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_DynTaskCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_DynTaskCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_DynTaskCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_DynTaskCon;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_DynTaskCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_DynTaskCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_DynTaskCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_DynTaskCon;
...
void c10_DynTaskCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_DynTaskCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_DynTaskCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_DynTaskCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_DynTaskCon_method_dispatcher.\n"
