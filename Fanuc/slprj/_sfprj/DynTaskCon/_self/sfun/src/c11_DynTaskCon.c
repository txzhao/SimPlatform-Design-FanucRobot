...
static void initialize_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct
  *chartInstance);
static void initialize_params_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct
  *chartInstance);
static void enable_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct *chartInstance);
static void disable_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_DynTaskCon
  (SFc11_DynTaskConInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_DynTaskCon
  (SFc11_DynTaskConInstanceStruct *chartInstance);
static void set_sim_state_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c11_st);
static void finalize_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct
  *chartInstance);
static void sf_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct *chartInstance);
static void c11_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c11_DynTaskCon
  (SFc11_DynTaskConInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber);
static void c11_spat_Jacobian(SFc11_DynTaskConInstanceStruct *chartInstance,
  real_T c11_in1[9], real_T c11_in2[6], real_T c11_b_spat_Jacobian[36]);
static void c11_eml_scalar_eg(SFc11_DynTaskConInstanceStruct *chartInstance);
static void c11_b_eml_scalar_eg(SFc11_DynTaskConInstanceStruct *chartInstance);
static void c11_fwd_kin(SFc11_DynTaskConInstanceStruct *chartInstance, real_T
...
static void c11_emlrt_marshallIn(SFc11_DynTaskConInstanceStruct *chartInstance,
  const mxArray *c11_EndVel, const char_T *c11_name, real_T c11_y[3]);
static uint8_T c11_b_emlrt_marshallIn(SFc11_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_DynTaskCon, const char_T
  *c11_name);
static void init_dsm_address_info(SFc11_DynTaskConInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_DynTaskCon = 0U;
}
  ...
  (SFc11_DynTaskConInstanceStruct *chartInstance)
{
  ...
  c11_b_hoistedGlobal = chartInstance->c11_is_active_c11_DynTaskCon;
  ...
  *chartInstance, const mxArray *c11_st)
{
  ...
  chartInstance->c11_is_active_c11_DynTaskCon = c11_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_DynTaskCon");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_DynTaskCon(chartInstance);
...
static void sf_c11_DynTaskCon(SFc11_DynTaskConInstanceStruct *chartInstance)
{
  ...
  c11_c11_DynTaskCon(chartInstance);
...
static const mxArray *c11_sf_marshall(void *chartInstanceVoid, void *c11_u)
{
  ...
  const mxArray *c11_b_y = NULL;
  SFc11_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc11_DynTaskConInstanceStruct *)chartInstanceVoid;
  c11_y = NULL;
...
const mxArray *sf_c11_DynTaskCon_get_eml_resolved_functions_info(void)
{
...
static void c11_info_helper(c11_ResolvedFunctionInfo c11_info[59])
{
  ...
  c11_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c11_info[1].fileLength = 2169U;
  c11_info[1].fileTime1 = 1366807304U;
  c11_info[1].fileTime2 = 0U;
  c11_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c11_info[2].name = "cos";
  ...
  c11_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[9].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c11_info[9].name = "sin";
  ...
  c11_info[11].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[12].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[13].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[14].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[30].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c11_info[57].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
...
static void c11_emlrt_marshallIn(SFc11_DynTaskConInstanceStruct *chartInstance,
  const mxArray *c11_EndVel, const char_T *c11_name,
  real_T c11_y[3])
{
  real_T c11_dv3[3];
  int32_T c11_i56;
...
static uint8_T c11_b_emlrt_marshallIn(SFc11_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_DynTaskCon,
  const char_T *c11_name)
{
  uint8_T c11_y;
  uint8_T c11_u0;
  sf_mex_import(c11_name, sf_mex_dup(c11_b_is_active_c11_DynTaskCon), &c11_u0, 1,
                3, 0U, 0, 0U, 0);
  c11_y = c11_u0;
  sf_mex_destroy(&c11_b_is_active_c11_DynTaskCon);
  return c11_y;
}
...
/* SFunction Glue Code */
void sf_c11_DynTaskCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_DynTaskCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c11_DynTaskCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c11_DynTaskCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_DynTaskCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_DynTaskConInstanceStruct *chartInstance;
    chartInstance = (SFc11_DynTaskConInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c11_DynTaskCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_DynTaskConInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*)
    chartInstanceVar);
  initialize_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_DynTaskCon(void *chartInstanceVar)
{
  enable_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_DynTaskCon(void *chartInstanceVar)
{
  disable_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_DynTaskCon(void *chartInstanceVar)
{
  sf_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c11_DynTaskCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_DynTaskCon
    ((SFc11_DynTaskConInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c11_DynTaskCon();/* state var info */
...
static void sf_internal_set_sim_state_c11_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_DynTaskCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c11_DynTaskCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c11_DynTaskCon(S);
}

static void sf_opaque_set_sim_state_c11_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c11_DynTaskCon(S, st);
}

static void sf_opaque_terminate_c11_DynTaskCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_DynTaskConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c11_DynTaskCon((SFc11_DynTaskConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_DynTaskCon(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c11_DynTaskCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynTaskCon","DynTaskCon",11);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynTaskCon","DynTaskCon",11,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynTaskCon",
      "DynTaskCon",11,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynTaskCon","DynTaskCon",11,2);
      sf_mark_chart_reusable_outputs(S,"DynTaskCon","DynTaskCon",11,1);
    }

    sf_set_rtw_dwork_info(S,"DynTaskCon","DynTaskCon",11);
...
static void mdlRTW_c11_DynTaskCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynTaskCon", "DynTaskCon",11);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c11_DynTaskCon(SimStruct *S)
{
  SFc11_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc11_DynTaskConInstanceStruct *)malloc(sizeof
    (SFc11_DynTaskConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_DynTaskConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c11_DynTaskCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c11_DynTaskCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c11_DynTaskCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_DynTaskCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c11_DynTaskCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c11_DynTaskCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c11_DynTaskCon;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_DynTaskCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_DynTaskCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_DynTaskCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c11_DynTaskCon;
...
void c11_DynTaskCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_DynTaskCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_DynTaskCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_DynTaskCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_DynTaskCon_method_dispatcher.\n"
