...
static void initialize_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct
  *chartInstance);
static void initialize_params_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct
  *chartInstance);
static void enable_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct *chartInstance);
static void disable_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_DynTaskCon
  (SFc15_DynTaskConInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_DynTaskCon
  (SFc15_DynTaskConInstanceStruct *chartInstance);
static void set_sim_state_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c15_st);
static void finalize_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct
  *chartInstance);
static void sf_c15_DynTaskCon(SFc15_DynTaskConInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c15_DynTaskCon
  (SFc15_DynTaskConInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c15_machineNumber, uint32_T
  c15_chartNumber);
static void c15_N_d(SFc15_DynTaskConInstanceStruct *chartInstance, real_T
...
static void c15_emlrt_marshallIn(SFc15_DynTaskConInstanceStruct *chartInstance,
  const mxArray *c15_N, const char_T *c15_name, real_T c15_y[6]);
static uint8_T c15_b_emlrt_marshallIn(SFc15_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_DynTaskCon, const char_T
  *c15_name);
static void init_dsm_address_info(SFc15_DynTaskConInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_DynTaskCon = 0U;
}
  ...
  (SFc15_DynTaskConInstanceStruct *chartInstance)
{
  ...
  c15_b_hoistedGlobal = chartInstance->c15_is_active_c15_DynTaskCon;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_DynTaskCon = c15_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_active_c15_DynTaskCon");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_DynTaskCon(chartInstance);
...
static const mxArray *c15_sf_marshall(void *chartInstanceVoid, void *c15_u)
{
  ...
  const mxArray *c15_b_y = NULL;
  SFc15_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc15_DynTaskConInstanceStruct *)chartInstanceVoid;
  c15_y = NULL;
...
const mxArray *sf_c15_DynTaskCon_get_eml_resolved_functions_info(void)
{
...
static void c15_emlrt_marshallIn(SFc15_DynTaskConInstanceStruct *chartInstance,
  const mxArray *c15_N, const char_T *c15_name, real_T
  c15_y[6])
{
  real_T c15_dv9[6];
  int32_T c15_i31;
...
static uint8_T c15_b_emlrt_marshallIn(SFc15_DynTaskConInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_DynTaskCon,
  const char_T *c15_name)
{
  uint8_T c15_y;
  uint8_T c15_u0;
  sf_mex_import(c15_name, sf_mex_dup(c15_b_is_active_c15_DynTaskCon), &c15_u0, 1,
                3, 0U, 0, 0U, 0);
  c15_y = c15_u0;
  sf_mex_destroy(&c15_b_is_active_c15_DynTaskCon);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_DynTaskCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_DynTaskCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c15_DynTaskCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"N\",},{M[8],M[0],T\"is_active_c15_DynTaskCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_DynTaskCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_DynTaskConInstanceStruct *chartInstance;
    chartInstance = (SFc15_DynTaskConInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c15_DynTaskCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_DynTaskConInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*)
    chartInstanceVar);
  initialize_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_DynTaskCon(void *chartInstanceVar)
{
  enable_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_DynTaskCon(void *chartInstanceVar)
{
  disable_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_DynTaskCon(void *chartInstanceVar)
{
  sf_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c15_DynTaskCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_DynTaskCon
    ((SFc15_DynTaskConInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c15_DynTaskCon();/* state var info */
...
static void sf_internal_set_sim_state_c15_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_DynTaskCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c15_DynTaskCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_DynTaskCon(S);
}

static void sf_opaque_set_sim_state_c15_DynTaskCon(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c15_DynTaskCon(S, st);
}

static void sf_opaque_terminate_c15_DynTaskCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_DynTaskConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c15_DynTaskCon((SFc15_DynTaskConInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_DynTaskCon(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_DynTaskCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynTaskCon","DynTaskCon",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynTaskCon","DynTaskCon",15,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynTaskCon",
      "DynTaskCon",15,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynTaskCon","DynTaskCon",15,1);
      sf_mark_chart_reusable_outputs(S,"DynTaskCon","DynTaskCon",15,1);
    }

    sf_set_rtw_dwork_info(S,"DynTaskCon","DynTaskCon",15);
...
static void mdlRTW_c15_DynTaskCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynTaskCon", "DynTaskCon",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_DynTaskCon(SimStruct *S)
{
  SFc15_DynTaskConInstanceStruct *chartInstance;
  chartInstance = (SFc15_DynTaskConInstanceStruct *)malloc(sizeof
    (SFc15_DynTaskConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_DynTaskConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_DynTaskCon;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_DynTaskCon;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_DynTaskCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_DynTaskCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_DynTaskCon;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_DynTaskCon;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_DynTaskCon;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_DynTaskCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_DynTaskCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_DynTaskCon;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_DynTaskCon;
...
void c15_DynTaskCon_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_DynTaskCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_DynTaskCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_DynTaskCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_DynTaskCon_method_dispatcher.\n"
