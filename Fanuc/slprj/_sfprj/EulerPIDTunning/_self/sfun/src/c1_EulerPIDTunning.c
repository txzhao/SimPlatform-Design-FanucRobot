...
static void initialize_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
static void initialize_params_c1_EulerPIDTunning
  (SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void enable_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
static void disable_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_EulerPIDTunning
  (SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_EulerPIDTunning
  (SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void set_sim_state_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
static void sf_c1_EulerPIDTunning(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c1_EulerPIDTunning
  (SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static void c1_inv_kin(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
  c1_gd[16], real_T c1_b_L[9], real_T c1_theta[24], real_T *c1_Num);
static void c1_cross(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                     c1_a[3], real_T c1_b[3], real_T c1_c[3]);
static boolean_T c1_all(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  boolean_T c1_x[2]);
static void c1_mrdivide(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_A[16], real_T c1_B[16], real_T c1_y[16]);
static real_T c1_power(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
  c1_a, real_T c1_b);
static void c1_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eps(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4],
  int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static int32_T c1_ceval_ixamax(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx);
static void c1_ceval_xswap(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx, int32_T c1_iy0,
  int32_T c1_incy, real_T c1_b_x[16]);
static void c1_ceval_xger(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
...
static void c1_eml_warning(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eml_xtrsm(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_A[16], real_T c1_B[16], real_T c1_b_B[16]);
static void c1_c_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eml_blas_xtrsm(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  ...
  c1_b_B[16]);
static void c1_d_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static real_T c1_atan2(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
  c1_y, real_T c1_x);
static boolean_T c1_isInRange(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_x, real_T c1_xmin, real_T c1_xmax);
static void c1_expWre(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                      c1_kx[6], real_T c1_theta, real_T c1_g[16]);
static real_T c1_length(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_eye(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                   c1_I[9]);
static void c1_expRot(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                      c1_w[3], real_T c1_theta, real_T c1_R[9]);
static void c1_e_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_f_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_subPro3(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
  c1_kx[6], real_T c1_p[4], real_T c1_q[4], real_T c1_d[4], real_T c1_theta[2],
  real_T *c1_Nsol);
static void c1_g_eml_scalar_eg(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static real_T c1_ceval_xdot(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[3], int32_T c1_ix0, int32_T c1_incx, real_T c1_y[3],
  int32_T c1_iy0, int32_T c1_incy);
static real_T c1_mpower(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_a);
static real_T c1_norm(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                      c1_x[3]);
static real_T c1_ceval_xnrm2(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[3], int32_T c1_ix0, int32_T c1_incx);
static void c1_b_eml_error(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static void c1_b_isInRange(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_x[2], real_T c1_xmin, real_T c1_xmax, boolean_T c1_isIn[2]);
static boolean_T c1_any(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  boolean_T c1_x[2]);
static real_T c1_subPro1(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_kx[6], real_T c1_p[4], real_T c1_q[4]);
static void c1_subPro2(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
  c1_kx1[6], real_T c1_kx2[6], real_T c1_p[4], real_T c1_q[4], real_T c1_theta1
  [2], real_T c1_theta2[2], real_T *c1_Nsol);
static void c1_findCommon(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_w1[3], real_T c1_w2[3], real_T c1_r1[3], real_T c1_r2[3], real_T
  c1_r[3]);
static real_T c1_det(SFc1_EulerPIDTunningInstanceStruct *chartInstance, real_T
                     c1_x[4]);
static void c1_b_eml_matlab_zgetrf(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, real_T c1_A[4], real_T c1_b_A[4], int32_T c1_ipiv[2], int32_T *
  c1_info);
static int32_T c1_b_eml_ixamax(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_x[4]);
static int32_T c1_b_ceval_ixamax(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[4], int32_T c1_ix0, int32_T c1_incx);
static void c1_b_ceval_xswap(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[4], int32_T c1_ix0, int32_T c1_incx, int32_T c1_iy0,
  int32_T c1_incy, real_T c1_b_x[4]);
static void c1_b_ceval_xger(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0, int32_T c1_incx,
  int32_T c1_iy0, int32_T c1_incy, real_T c1_A[4], int32_T c1_ia0, int32_T
  c1_lda, real_T c1_b_A[4]);
static void c1_c_eml_error(SFc1_EulerPIDTunningInstanceStruct *chartInstance);
static real_T c1_b_subPro1(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
  real_T c1_kx[6], real_T c1_p[4], real_T c1_q[3]);
static real_T c1_c_subPro1(SFc1_EulerPIDTunningInstanceStruct *chartInstance,
...
static void c1_emlrt_marshallIn(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, const mxArray *c1_Theta, const char_T *c1_name, real_T c1_y[6]);
static uint8_T c1_b_emlrt_marshallIn(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_EulerPIDTunning, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_EulerPIDTunning = 0U;
}
  ...
  (SFc1_EulerPIDTunningInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_EulerPIDTunning;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_EulerPIDTunning = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_EulerPIDTunning");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_EulerPIDTunning(chartInstance);
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_EulerPIDTunningInstanceStruct *chartInstance;
  chartInstance = (SFc1_EulerPIDTunningInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
...
const mxArray *sf_c1_EulerPIDTunning_get_eml_resolved_functions_info(void)
{
...
static uint8_T c1_b_emlrt_marshallIn(SFc1_EulerPIDTunningInstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_EulerPIDTunning, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_EulerPIDTunning), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_EulerPIDTunning);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_EulerPIDTunning_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_EulerPIDTunning_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_EulerPIDTunning(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Theta\",},{M[8],M[0],T\"is_active_c1_EulerPIDTunning\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_EulerPIDTunning_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_EulerPIDTunningInstanceStruct *chartInstance;
    chartInstance = (SFc1_EulerPIDTunningInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_EulerPIDTunning(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_EulerPIDTunningInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
    chartInstanceVar);
  initialize_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_EulerPIDTunning(void *chartInstanceVar)
{
  enable_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_EulerPIDTunning(void *chartInstanceVar)
{
  disable_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_EulerPIDTunning(void *chartInstanceVar)
{
  sf_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_EulerPIDTunning(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_EulerPIDTunning
    ((SFc1_EulerPIDTunningInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_EulerPIDTunning();/* state var info */
...
static void sf_internal_set_sim_state_c1_EulerPIDTunning(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_EulerPIDTunning();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_EulerPIDTunning(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_EulerPIDTunning(S);
}

static void sf_opaque_set_sim_state_c1_EulerPIDTunning(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_EulerPIDTunning(S, st);
}

static void sf_opaque_terminate_c1_EulerPIDTunning(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_EulerPIDTunningInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_EulerPIDTunning((SFc1_EulerPIDTunningInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_EulerPIDTunning
    ((SFc1_EulerPIDTunningInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_EulerPIDTunning(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_EulerPIDTunning(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerPIDTunning","EulerPIDTunning",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerPIDTunning","EulerPIDTunning",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerPIDTunning",
      "EulerPIDTunning",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerPIDTunning","EulerPIDTunning",
        1,1);
      sf_mark_chart_reusable_outputs(S,"EulerPIDTunning","EulerPIDTunning",1,1);
    }

    sf_set_rtw_dwork_info(S,"EulerPIDTunning","EulerPIDTunning",1);
...
static void mdlRTW_c1_EulerPIDTunning(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerPIDTunning", "EulerPIDTunning",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_EulerPIDTunning(SimStruct *S)
{
  SFc1_EulerPIDTunningInstanceStruct *chartInstance;
  chartInstance = (SFc1_EulerPIDTunningInstanceStruct *)malloc(sizeof
    (SFc1_EulerPIDTunningInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_EulerPIDTunningInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_EulerPIDTunning;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_EulerPIDTunning;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_EulerPIDTunning;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_EulerPIDTunning;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_EulerPIDTunning;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_EulerPIDTunning;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_EulerPIDTunning;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_EulerPIDTunning;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_EulerPIDTunning;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_EulerPIDTunning;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_EulerPIDTunning;
...
void c1_EulerPIDTunning_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_EulerPIDTunning(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_EulerPIDTunning(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_EulerPIDTunning(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_EulerPIDTunning_method_dispatcher.\n"
