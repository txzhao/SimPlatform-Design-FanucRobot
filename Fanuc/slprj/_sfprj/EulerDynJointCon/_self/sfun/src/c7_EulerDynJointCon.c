...
static void initialize_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void initialize_params_c7_EulerDynJointCon
  (SFc7_EulerDynJointConInstanceStruct *chartInstance);
static void enable_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void disable_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_EulerDynJointCon
  (SFc7_EulerDynJointConInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_EulerDynJointCon
  (SFc7_EulerDynJointConInstanceStruct *chartInstance);
static void set_sim_state_c7_EulerDynJointCon
  (SFc7_EulerDynJointConInstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void sf_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void c7_c7_EulerDynJointCon(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c7_EulerDynJointCon
  (SFc7_EulerDynJointConInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static void c7_spat_Jacobian(SFc7_EulerDynJointConInstanceStruct *chartInstance,
  real_T c7_in1[9], real_T c7_in2[6], real_T c7_b_spat_Jacobian[36]);
static void c7_eml_scalar_eg(SFc7_EulerDynJointConInstanceStruct *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
static void c7_fwd_kin(SFc7_EulerDynJointConInstanceStruct *chartInstance,
...
static void c7_emlrt_marshallIn(SFc7_EulerDynJointConInstanceStruct
  *chartInstance, const mxArray *c7_EndVel, const char_T *c7_name, real_T c7_y[3]);
static uint8_T c7_b_emlrt_marshallIn(SFc7_EulerDynJointConInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_EulerDynJointCon, const
  char_T *c7_name);
static void init_dsm_address_info(SFc7_EulerDynJointConInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_EulerDynJointCon = 0U;
}
  ...
  (SFc7_EulerDynJointConInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_EulerDynJointCon;
  ...
  (SFc7_EulerDynJointConInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_EulerDynJointCon = c7_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_EulerDynJointCon");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_EulerDynJointCon(chartInstance);
  ...
  *chartInstance)
{
  ...
  c7_c7_EulerDynJointCon(chartInstance);
...
static const mxArray *c7_sf_marshall(void *chartInstanceVoid, void *c7_u)
{
  ...
  const mxArray *c7_b_y = NULL;
  SFc7_EulerDynJointConInstanceStruct *chartInstance;
  chartInstance = (SFc7_EulerDynJointConInstanceStruct *)chartInstanceVoid;
  c7_y = NULL;
...
const mxArray *sf_c7_EulerDynJointCon_get_eml_resolved_functions_info(void)
{
...
static void c7_emlrt_marshallIn(SFc7_EulerDynJointConInstanceStruct
  *chartInstance, const mxArray *c7_EndVel, const char_T *c7_name
  , real_T c7_y[3])
{
  real_T c7_dv3[3];
  int32_T c7_i56;
...
static uint8_T c7_b_emlrt_marshallIn(SFc7_EulerDynJointConInstanceStruct
  *chartInstance, const mxArray *
  c7_b_is_active_c7_EulerDynJointCon, const char_T *c7_name)
{
  uint8_T c7_y;
  uint8_T c7_u0;
  sf_mex_import(c7_name, sf_mex_dup(c7_b_is_active_c7_EulerDynJointCon), &c7_u0,
                1, 3, 0U, 0, 0U, 0);
  c7_y = c7_u0;
  sf_mex_destroy(&c7_b_is_active_c7_EulerDynJointCon);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_EulerDynJointCon_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_EulerDynJointCon_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c7_EulerDynJointCon(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c7_EulerDynJointCon\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_EulerDynJointCon_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_EulerDynJointConInstanceStruct *chartInstance;
    chartInstance = (SFc7_EulerDynJointConInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c7_EulerDynJointCon(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_EulerDynJointConInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
    chartInstanceVar);
  initialize_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_EulerDynJointCon(void *chartInstanceVar)
{
  enable_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_EulerDynJointCon(void *chartInstanceVar)
{
  disable_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_EulerDynJointCon(void *chartInstanceVar)
{
  sf_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c7_EulerDynJointCon(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_EulerDynJointCon
    ((SFc7_EulerDynJointConInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c7_EulerDynJointCon();/* state var info */
...
static void sf_internal_set_sim_state_c7_EulerDynJointCon(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_EulerDynJointCon();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c7_EulerDynJointCon(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_EulerDynJointCon(S);
}

static void sf_opaque_set_sim_state_c7_EulerDynJointCon(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_EulerDynJointCon(S, st);
}

static void sf_opaque_terminate_c7_EulerDynJointCon(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_EulerDynJointConInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_EulerDynJointCon((SFc7_EulerDynJointConInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c7_EulerDynJointCon
    ((SFc7_EulerDynJointConInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_EulerDynJointCon(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_EulerDynJointCon(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerDynJointCon","EulerDynJointCon",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerDynJointCon","EulerDynJointCon",7,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerDynJointCon",
      "EulerDynJointCon",7,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerDynJointCon",
        "EulerDynJointCon",7,2);
      sf_mark_chart_reusable_outputs(S,"EulerDynJointCon","EulerDynJointCon",7,1);
    }

    sf_set_rtw_dwork_info(S,"EulerDynJointCon","EulerDynJointCon",7);
...
static void mdlRTW_c7_EulerDynJointCon(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerDynJointCon", "EulerDynJointCon",7);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c7_EulerDynJointCon(SimStruct *S)
{
  SFc7_EulerDynJointConInstanceStruct *chartInstance;
  chartInstance = (SFc7_EulerDynJointConInstanceStruct *)malloc(sizeof
    (SFc7_EulerDynJointConInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_EulerDynJointConInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_EulerDynJointCon;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_EulerDynJointCon;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_EulerDynJointCon;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_EulerDynJointCon;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_EulerDynJointCon;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_EulerDynJointCon;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_EulerDynJointCon;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_EulerDynJointCon;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_EulerDynJointCon;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_EulerDynJointCon;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_EulerDynJointCon;
...
void c7_EulerDynJointCon_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_EulerDynJointCon(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_EulerDynJointCon(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_EulerDynJointCon(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_EulerDynJointCon_method_dispatcher.\n"
