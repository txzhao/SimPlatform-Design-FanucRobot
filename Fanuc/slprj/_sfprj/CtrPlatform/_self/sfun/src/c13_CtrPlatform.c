...
static void initialize_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void initialize_params_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void enable_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void disable_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_CtrPlatform
  (SFc13_CtrPlatformInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_CtrPlatform
  (SFc13_CtrPlatformInstanceStruct *chartInstance);
static void set_sim_state_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void sf_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct *chartInstance);
static void c13_chartstep_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void initSimStructsc13_CtrPlatform(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct *chartInstance,
  const mxArray *c13_EndVel, const char_T *c13_identifier, real_T c13_y[3]);
static void c13_b_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_c_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  real_T c13_y[9]);
...
static const mxArray *c13_d_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_d_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_e_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_e_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  real_T c13_y[16]);
static void c13_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static void c13_f_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  real_T c13_y[6]);
...
static const mxArray *c13_f_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_g_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  real_T c13_y[36]);
...
static const mxArray *c13_g_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_h_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  real_T c13_y[6]);
...
static void c13_spat_Jacobian(SFc13_CtrPlatformInstanceStruct *chartInstance,
  real_T c13_in1[9], real_T c13_in2[6], real_T c13_b_spat_Jacobian[36]);
static real_T c13_power(SFc13_CtrPlatformInstanceStruct *chartInstance, real_T
  c13_a);
static void c13_eml_int_forloop_overflow_check(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static void c13_eml_scalar_eg(SFc13_CtrPlatformInstanceStruct *chartInstance);
static void c13_fwd_kin(SFc13_CtrPlatformInstanceStruct *chartInstance, real_T
  c13_in1[9], real_T c13_in2[6], real_T c13_gst[16]);
static void c13_b_eml_int_forloop_overflow_check(SFc13_CtrPlatformInstanceStruct
  *chartInstance);
static const mxArray *c13_h_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_i_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_j_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_CtrPlatform, const char_T
  *c13_identifier);
static uint8_T c13_k_emlrt_marshallIn(SFc13_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_CtrPlatformInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_CtrPlatform = 0U;
}
  ...
  (SFc13_CtrPlatformInstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal = chartInstance->c13_is_active_c13_CtrPlatform;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_CtrPlatform = c13_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_CtrPlatform");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_CtrPlatform(chartInstance);
...
static void sf_c13_CtrPlatform(SFc13_CtrPlatformInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_sfEvent = CALL_EVENT;
  c13_chartstep_c13_CtrPlatform(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_CtrPlatformInstanceStruct *chartInstance;
  chartInstance = (SFc13_CtrPlatformInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_CtrPlatform_get_eml_resolved_functions_info(void)
{
  ...
  *c13_identifier)
{
  ...
  c13_y = c13_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_CtrPlatform), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_CtrPlatform);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_CtrPlatform_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_CtrPlatform_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_CtrPlatform(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c13_CtrPlatform\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_CtrPlatform_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc13_CtrPlatformInstanceStruct *chartInstance;
    chartInstance = (SFc13_CtrPlatformInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c13_CtrPlatform(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_CtrPlatformInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*)
    chartInstanceVar);
  initialize_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_CtrPlatform(void *chartInstanceVar)
{
  enable_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_CtrPlatform(void *chartInstanceVar)
{
  disable_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_CtrPlatform(void *chartInstanceVar)
{
  sf_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_CtrPlatform(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_CtrPlatform
    ((SFc13_CtrPlatformInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_CtrPlatform();/* state var info */
...
extern void sf_internal_set_sim_state_c13_CtrPlatform(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_CtrPlatform(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_CtrPlatform(S);
}

static void sf_opaque_set_sim_state_c13_CtrPlatform(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c13_CtrPlatform(S, st);
}

static void sf_opaque_terminate_c13_CtrPlatform(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_CtrPlatform((SFc13_CtrPlatformInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_CtrPlatform(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_CtrPlatform(SimStruct *S)
{
...
static void mdlRTW_c13_CtrPlatform(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_CtrPlatform(SimStruct *S)
{
  SFc13_CtrPlatformInstanceStruct *chartInstance;
  chartInstance = (SFc13_CtrPlatformInstanceStruct *)malloc(sizeof
    (SFc13_CtrPlatformInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_CtrPlatformInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_CtrPlatform;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_CtrPlatform;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_CtrPlatform;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_CtrPlatform;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_CtrPlatform;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_CtrPlatform;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_CtrPlatform;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_CtrPlatform;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_CtrPlatform;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_CtrPlatform;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_CtrPlatform;
...
void c13_CtrPlatform_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_CtrPlatform(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_CtrPlatform(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_CtrPlatform(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_CtrPlatform_method_dispatcher.\n"
