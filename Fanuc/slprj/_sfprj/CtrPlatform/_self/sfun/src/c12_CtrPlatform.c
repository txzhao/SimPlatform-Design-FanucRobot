...
static void initialize_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void initialize_params_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void enable_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void disable_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_CtrPlatform
  (SFc12_CtrPlatformInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_CtrPlatform
  (SFc12_CtrPlatformInstanceStruct *chartInstance);
static void set_sim_state_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_st);
static void finalize_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void sf_c12_CtrPlatform(SFc12_CtrPlatformInstanceStruct *chartInstance);
static void initSimStructsc12_CtrPlatform(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct *chartInstance,
  const mxArray *c12_EndPos, const char_T *c12_identifier, real_T c12_y[3]);
static void c12_b_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
...
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[9]);
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_d_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_e_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_e_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[16]);
...
static const mxArray *c12_f_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_f_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[6]);
...
static void c12_fwd_kin(SFc12_CtrPlatformInstanceStruct *chartInstance, real_T
  c12_in1[9], real_T c12_in2[6], real_T c12_gst[16]);
static void c12_eml_int_forloop_overflow_check(SFc12_CtrPlatformInstanceStruct
  *chartInstance);
static const mxArray *c12_g_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_g_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_h_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_CtrPlatform, const char_T
  *c12_identifier);
static uint8_T c12_i_emlrt_marshallIn(SFc12_CtrPlatformInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_CtrPlatformInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_CtrPlatform = 0U;
}
  ...
  (SFc12_CtrPlatformInstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_CtrPlatform;
  ...
  *chartInstance, const mxArray *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_CtrPlatform = c12_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_CtrPlatform");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_CtrPlatform(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_CtrPlatformInstanceStruct *chartInstance;
  chartInstance = (SFc12_CtrPlatformInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_CtrPlatform_get_eml_resolved_functions_info(void)
{
  ...
  *c12_identifier)
{
  ...
  c12_y = c12_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_CtrPlatform), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_CtrPlatform);
  return c12_y;
}
...
/* SFunction Glue Code */
void sf_c12_CtrPlatform_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_CtrPlatform_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_CtrPlatform(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c12_CtrPlatform\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_CtrPlatform_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_CtrPlatformInstanceStruct *chartInstance;
    chartInstance = (SFc12_CtrPlatformInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c12_CtrPlatform(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_CtrPlatformInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*)
    chartInstanceVar);
  initialize_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_CtrPlatform(void *chartInstanceVar)
{
  enable_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_CtrPlatform(void *chartInstanceVar)
{
  disable_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_CtrPlatform(void *chartInstanceVar)
{
  sf_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_CtrPlatform(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_CtrPlatform
    ((SFc12_CtrPlatformInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_CtrPlatform();/* state var info */
...
extern void sf_internal_set_sim_state_c12_CtrPlatform(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_CtrPlatform(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_CtrPlatform(S);
}

static void sf_opaque_set_sim_state_c12_CtrPlatform(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c12_CtrPlatform(S, st);
}

static void sf_opaque_terminate_c12_CtrPlatform(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_CtrPlatform((SFc12_CtrPlatformInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_CtrPlatform(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_CtrPlatform(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4201753773U));
  ssSetChecksum1(S,(3418975249U));
  ssSetChecksum2(S,(2007648123U));
  ssSetChecksum3(S,(3436869394U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c12_CtrPlatform(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_CtrPlatform(SimStruct *S)
{
  SFc12_CtrPlatformInstanceStruct *chartInstance;
  chartInstance = (SFc12_CtrPlatformInstanceStruct *)malloc(sizeof
    (SFc12_CtrPlatformInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_CtrPlatformInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_CtrPlatform;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_CtrPlatform;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_CtrPlatform;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_CtrPlatform;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_CtrPlatform;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_CtrPlatform;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_CtrPlatform;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_CtrPlatform;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_CtrPlatform;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_CtrPlatform;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_CtrPlatform;
...
void c12_CtrPlatform_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_CtrPlatform(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_CtrPlatform(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_CtrPlatform(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_CtrPlatform_method_dispatcher.\n"
