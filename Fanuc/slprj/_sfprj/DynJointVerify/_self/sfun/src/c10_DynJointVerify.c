...
static void initialize_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void initialize_params_c10_DynJointVerify
  (SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void enable_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void disable_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_DynJointVerify
  (SFc10_DynJointVerifyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_DynJointVerify
  (SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void set_sim_state_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct *
  chartInstance, const mxArray *c10_st);
static void finalize_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void sf_c10_DynJointVerify(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c10_DynJointVerify
  (SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static void c10_inv_kin(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_gd[16], real_T c10_b_L[9], real_T c10_theta[24], real_T *c10_Num);
static void c10_cross(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
                      c10_a[3], real_T c10_b[3], real_T c10_c[3]);
static boolean_T c10_all(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  boolean_T c10_x[2]);
static void c10_mrdivide(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_A[16], real_T c10_B[16], real_T c10_y[16]);
static real_T c10_power(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_a, real_T c10_b);
static void c10_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_eml_error(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_eps(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_eml_matlab_zgetrf(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, real_T c10_A[16], real_T c10_b_A[16], int32_T c10_ipiv[4],
  int32_T *c10_info);
static int32_T c10_eml_ixamax(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_n, real_T c10_x[16], int32_T c10_ix0);
static int32_T c10_ceval_ixamax(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, int32_T c10_n, real_T c10_x[16], int32_T c10_ix0, int32_T
  c10_incx);
static void c10_ceval_xswap(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_n, real_T c10_x[16], int32_T c10_ix0, int32_T c10_incx, int32_T
  c10_iy0, int32_T c10_incy, real_T c10_b_x[16]);
static void c10_ceval_xger(SFc10_DynJointVerifyInstanceStruct *chartInstance,
...
static void c10_eml_warning(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_b_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void c10_eml_xtrsm(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_A[16], real_T c10_B[16], real_T c10_b_B[16]);
static void c10_c_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void c10_eml_blas_xtrsm(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  ...
  real_T c10_b_B[16]);
static void c10_d_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static real_T c10_atan2(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_y, real_T c10_x);
static boolean_T c10_isInRange(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_x, real_T c10_xmin, real_T c10_xmax);
static void c10_expWre(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
  c10_kx[6], real_T c10_theta, real_T c10_g[16]);
static real_T c10_length(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_eye(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
                    c10_I[9]);
static void c10_expRot(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
  c10_w[3], real_T c10_theta, real_T c10_R[9]);
static void c10_e_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void c10_f_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static void c10_subPro3(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_kx[6], real_T c10_p[4], real_T c10_q[4], real_T c10_d[4], real_T
  c10_theta[2], real_T *c10_Nsol);
static void c10_g_eml_scalar_eg(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
static real_T c10_ceval_xdot(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_n, real_T c10_x[3], int32_T c10_ix0, int32_T c10_incx, real_T
  c10_y[3], int32_T c10_iy0, int32_T c10_incy);
static real_T c10_mpower(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_a);
static real_T c10_norm(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
  c10_x[3]);
static real_T c10_ceval_xnrm2(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_n, real_T c10_x[3], int32_T c10_ix0, int32_T c10_incx);
static void c10_b_eml_error(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static void c10_b_isInRange(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_x[2], real_T c10_xmin, real_T c10_xmax, boolean_T c10_isIn[2]);
static boolean_T c10_any(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  boolean_T c10_x[2]);
static real_T c10_subPro1(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_kx[6], real_T c10_p[4], real_T c10_q[4]);
static void c10_subPro2(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_kx1[6], real_T c10_kx2[6], real_T c10_p[4], real_T c10_q[4], real_T
  c10_theta1[2], real_T c10_theta2[2], real_T *c10_Nsol);
static void c10_findCommon(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_w1[3], real_T c10_w2[3], real_T c10_r1[3], real_T c10_r2[3], real_T
  c10_r[3]);
static real_T c10_det(SFc10_DynJointVerifyInstanceStruct *chartInstance, real_T
                      c10_x[4]);
static void c10_b_eml_matlab_zgetrf(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, real_T c10_A[4], real_T c10_b_A[4], int32_T c10_ipiv[2],
  int32_T *c10_info);
static int32_T c10_b_eml_ixamax(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, real_T c10_x[4]);
static int32_T c10_b_ceval_ixamax(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, int32_T c10_n, real_T c10_x[4], int32_T c10_ix0, int32_T
  c10_incx);
static void c10_b_ceval_xswap(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_n, real_T c10_x[4], int32_T c10_ix0, int32_T c10_incx, int32_T
  c10_iy0, int32_T c10_incy, real_T c10_b_x[4]);
static void c10_b_ceval_xger(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  int32_T c10_m, int32_T c10_n, real_T c10_alpha1, int32_T c10_ix0, int32_T
  c10_incx, int32_T c10_iy0, int32_T c10_incy, real_T c10_A[4], int32_T c10_ia0,
  int32_T c10_lda, real_T c10_b_A[4]);
static void c10_c_eml_error(SFc10_DynJointVerifyInstanceStruct *chartInstance);
static real_T c10_b_subPro1(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_kx[6], real_T c10_p[4], real_T c10_q[3]);
static real_T c10_c_subPro1(SFc10_DynJointVerifyInstanceStruct *chartInstance,
...
static void c10_emlrt_marshallIn(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c10_theta, const char_T *c10_name, real_T
  c10_y[6]);
static uint8_T c10_b_emlrt_marshallIn(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_DynJointVerify, const
  char_T *c10_name);
static void init_dsm_address_info(SFc10_DynJointVerifyInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_DynJointVerify = 0U;
}
  ...
  (SFc10_DynJointVerifyInstanceStruct *chartInstance)
{
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_DynJointVerify;
  ...
  chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_DynJointVerify = c10_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_DynJointVerify");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_DynJointVerify(chartInstance);
...
static void c10_inv_kin(SFc10_DynJointVerifyInstanceStruct *chartInstance,
  real_T c10_gd[16], real_T c10_b_L[9], real_T c10_theta[24
  ], real_T *c10_Num)
{
...
static const mxArray *c10_sf_marshall(void *chartInstanceVoid, void *c10_u)
{
  ...
  const mxArray *c10_b_y = NULL;
  SFc10_DynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc10_DynJointVerifyInstanceStruct *)chartInstanceVoid;
  c10_y = NULL;
...
const mxArray *sf_c10_DynJointVerify_get_eml_resolved_functions_info(void)
{
...
static uint8_T c10_b_emlrt_marshallIn(SFc10_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *
  c10_b_is_active_c10_DynJointVerify, const char_T *c10_name)
{
  uint8_T c10_y;
  uint8_T c10_u0;
  sf_mex_import(c10_name, sf_mex_dup(c10_b_is_active_c10_DynJointVerify),
                &c10_u0, 1, 3, 0U, 0, 0U, 0);
  c10_y = c10_u0;
  sf_mex_destroy(&c10_b_is_active_c10_DynJointVerify);
  return c10_y;
}
...
/* SFunction Glue Code */
void sf_c10_DynJointVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_DynJointVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c10_DynJointVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta\",},{M[8],M[0],T\"is_active_c10_DynJointVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_DynJointVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_DynJointVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc10_DynJointVerifyInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_DynJointVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_DynJointVerifyInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
  initialize_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_DynJointVerify(void *chartInstanceVar)
{
  enable_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_DynJointVerify(void *chartInstanceVar)
{
  disable_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_DynJointVerify(void *chartInstanceVar)
{
  sf_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c10_DynJointVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_DynJointVerify
    ((SFc10_DynJointVerifyInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c10_DynJointVerify();/* state var info */
...
static void sf_internal_set_sim_state_c10_DynJointVerify(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_DynJointVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c10_DynJointVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_DynJointVerify(S);
}

static void sf_opaque_set_sim_state_c10_DynJointVerify(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_DynJointVerify(S, st);
}

static void sf_opaque_terminate_c10_DynJointVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_DynJointVerifyInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_DynJointVerify((SFc10_DynJointVerifyInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c10_DynJointVerify
    ((SFc10_DynJointVerifyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_DynJointVerify(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_DynJointVerify(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynJointVerify","DynJointVerify",10);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynJointVerify","DynJointVerify",10,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynJointVerify",
      "DynJointVerify",10,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynJointVerify","DynJointVerify",10,
        1);
      sf_mark_chart_reusable_outputs(S,"DynJointVerify","DynJointVerify",10,1);
    }

    sf_set_rtw_dwork_info(S,"DynJointVerify","DynJointVerify",10);
...
static void mdlRTW_c10_DynJointVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynJointVerify", "DynJointVerify",10);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c10_DynJointVerify(SimStruct *S)
{
  SFc10_DynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc10_DynJointVerifyInstanceStruct *)malloc(sizeof
    (SFc10_DynJointVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_DynJointVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_DynJointVerify;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_DynJointVerify;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_DynJointVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_DynJointVerify;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_DynJointVerify;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_DynJointVerify;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_DynJointVerify;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_DynJointVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_DynJointVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_DynJointVerify;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_DynJointVerify;
...
void c10_DynJointVerify_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_DynJointVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_DynJointVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_DynJointVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_DynJointVerify_method_dispatcher.\n"
