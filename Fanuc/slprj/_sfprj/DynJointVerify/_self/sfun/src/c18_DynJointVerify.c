...
static void initialize_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
static void initialize_params_c18_DynJointVerify
  (SFc18_DynJointVerifyInstanceStruct *chartInstance);
static void enable_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
static void disable_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
static void c18_update_debugger_state_c18_DynJointVerify
  (SFc18_DynJointVerifyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_DynJointVerify
  (SFc18_DynJointVerifyInstanceStruct *chartInstance);
static void set_sim_state_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct *
  chartInstance, const mxArray *c18_st);
static void finalize_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
static void sf_c18_DynJointVerify(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c18_DynJointVerify
  (SFc18_DynJointVerifyInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c18_machineNumber, uint32_T
  c18_chartNumber);
static void c18_fwd_kin(SFc18_DynJointVerifyInstanceStruct *chartInstance,
...
static void c18_emlrt_marshallIn(SFc18_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c18_EndPos, const char_T *c18_name, real_T
  c18_y[3]);
static uint8_T c18_b_emlrt_marshallIn(SFc18_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_DynJointVerify, const
  char_T *c18_name);
static void init_dsm_address_info(SFc18_DynJointVerifyInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_DynJointVerify = 0U;
}
  ...
  (SFc18_DynJointVerifyInstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_DynJointVerify;
  ...
  chartInstance, const mxArray *c18_st)
{
  ...
  chartInstance->c18_is_active_c18_DynJointVerify = c18_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_DynJointVerify");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_DynJointVerify(chartInstance);
...
static const mxArray *c18_sf_marshall(void *chartInstanceVoid, void *c18_u)
{
  ...
  const mxArray *c18_b_y = NULL;
  SFc18_DynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc18_DynJointVerifyInstanceStruct *)chartInstanceVoid;
  c18_y = NULL;
...
const mxArray *sf_c18_DynJointVerify_get_eml_resolved_functions_info(void)
{
...
static uint8_T c18_b_emlrt_marshallIn(SFc18_DynJointVerifyInstanceStruct
  *chartInstance, const mxArray *
  c18_b_is_active_c18_DynJointVerify, const char_T *c18_name)
{
  uint8_T c18_y;
  uint8_T c18_u0;
  sf_mex_import(c18_name, sf_mex_dup(c18_b_is_active_c18_DynJointVerify),
                &c18_u0, 1, 3, 0U, 0, 0U, 0);
  c18_y = c18_u0;
  sf_mex_destroy(&c18_b_is_active_c18_DynJointVerify);
  return c18_y;
}
...
/* SFunction Glue Code */
void sf_c18_DynJointVerify_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_DynJointVerify_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c18_DynJointVerify(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c18_DynJointVerify\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_DynJointVerify_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_DynJointVerifyInstanceStruct *chartInstance;
    chartInstance = (SFc18_DynJointVerifyInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c18_DynJointVerify(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_DynJointVerifyInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
  initialize_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_DynJointVerify(void *chartInstanceVar)
{
  enable_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_DynJointVerify(void *chartInstanceVar)
{
  disable_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_DynJointVerify(void *chartInstanceVar)
{
  sf_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c18_DynJointVerify(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_DynJointVerify
    ((SFc18_DynJointVerifyInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c18_DynJointVerify();/* state var info */
...
static void sf_internal_set_sim_state_c18_DynJointVerify(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_DynJointVerify();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c18_DynJointVerify(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_DynJointVerify(S);
}

static void sf_opaque_set_sim_state_c18_DynJointVerify(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_DynJointVerify(S, st);
}

static void sf_opaque_terminate_c18_DynJointVerify(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_DynJointVerifyInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c18_DynJointVerify((SFc18_DynJointVerifyInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c18_DynJointVerify
    ((SFc18_DynJointVerifyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_DynJointVerify(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_DynJointVerify(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DynJointVerify","DynJointVerify",18);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DynJointVerify","DynJointVerify",18,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DynJointVerify",
      "DynJointVerify",18,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DynJointVerify","DynJointVerify",18,
        1);
      sf_mark_chart_reusable_outputs(S,"DynJointVerify","DynJointVerify",18,1);
    }

    sf_set_rtw_dwork_info(S,"DynJointVerify","DynJointVerify",18);
...
static void mdlRTW_c18_DynJointVerify(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DynJointVerify", "DynJointVerify",18);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c18_DynJointVerify(SimStruct *S)
{
  SFc18_DynJointVerifyInstanceStruct *chartInstance;
  chartInstance = (SFc18_DynJointVerifyInstanceStruct *)malloc(sizeof
    (SFc18_DynJointVerifyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_DynJointVerifyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_DynJointVerify;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_DynJointVerify;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_DynJointVerify;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_DynJointVerify;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_DynJointVerify;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_DynJointVerify;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_DynJointVerify;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_DynJointVerify;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_DynJointVerify;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_DynJointVerify;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_DynJointVerify;
...
void c18_DynJointVerify_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_DynJointVerify(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_DynJointVerify(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_DynJointVerify(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_DynJointVerify_method_dispatcher.\n"
