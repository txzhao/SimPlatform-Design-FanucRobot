...
static void initialize_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct
  *chartInstance);
static void initialize_params_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct
  *chartInstance);
static void enable_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct *chartInstance);
static void disable_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_AugPDJoint
  (SFc13_AugPDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_AugPDJoint
  (SFc13_AugPDJointInstanceStruct *chartInstance);
static void set_sim_state_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct
  *chartInstance);
static void sf_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct *chartInstance);
static void c13_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c13_AugPDJoint
  (SFc13_AugPDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static void c13_spat_Jacobian(SFc13_AugPDJointInstanceStruct *chartInstance,
  real_T c13_in1[9], real_T c13_in2[6], real_T c13_b_spat_Jacobian[36]);
static void c13_eml_scalar_eg(SFc13_AugPDJointInstanceStruct *chartInstance);
static void c13_b_eml_scalar_eg(SFc13_AugPDJointInstanceStruct *chartInstance);
static void c13_fwd_kin(SFc13_AugPDJointInstanceStruct *chartInstance, real_T
  c13_in1[9], real_T c13_in2[6], real_T c13_gst[16]);
...
static void c13_emlrt_marshallIn(SFc13_AugPDJointInstanceStruct *chartInstance,
  const mxArray *c13_EndVel, const char_T *c13_name, real_T c13_y[3]);
static uint8_T c13_b_emlrt_marshallIn(SFc13_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_AugPDJoint, const char_T
  *c13_name);
static void init_dsm_address_info(SFc13_AugPDJointInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_AugPDJoint = 0U;
}
  ...
  (SFc13_AugPDJointInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal = chartInstance->c13_is_active_c13_AugPDJoint;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_AugPDJoint = c13_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_AugPDJoint");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_AugPDJoint(chartInstance);
...
static void sf_c13_AugPDJoint(SFc13_AugPDJointInstanceStruct *chartInstance)
{
  ...
  c13_c13_AugPDJoint(chartInstance);
...
static const mxArray *c13_sf_marshall(void *chartInstanceVoid, void *c13_u)
{
  ...
  const mxArray *c13_b_y = NULL;
  SFc13_AugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc13_AugPDJointInstanceStruct *)chartInstanceVoid;
  c13_y = NULL;
...
const mxArray *sf_c13_AugPDJoint_get_eml_resolved_functions_info(void)
{
...
static void c13_info_helper(c13_ResolvedFunctionInfo c13_info[59])
{
  ...
  c13_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c13_info[1].fileLength = 2169U;
  c13_info[1].fileTime1 = 1366807304U;
  c13_info[1].fileTime2 = 0U;
  c13_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c13_info[2].name = "cos";
  ...
  c13_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[9].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  c13_info[9].name = "sin";
  ...
  c13_info[11].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[12].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[13].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[14].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[30].context = "[E]D:/Learn/MatlabProgram/Fanuc/spat_Jacobian.m";
  ...
  c13_info[57].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
...
static void c13_emlrt_marshallIn(SFc13_AugPDJointInstanceStruct *chartInstance,
  const mxArray *c13_EndVel, const char_T *c13_name,
  real_T c13_y[3])
{
  real_T c13_dv3[3];
  int32_T c13_i56;
...
static uint8_T c13_b_emlrt_marshallIn(SFc13_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_AugPDJoint,
  const char_T *c13_name)
{
  uint8_T c13_y;
  uint8_T c13_u0;
  sf_mex_import(c13_name, sf_mex_dup(c13_b_is_active_c13_AugPDJoint), &c13_u0, 1,
                3, 0U, 0, 0U, 0);
  c13_y = c13_u0;
  sf_mex_destroy(&c13_b_is_active_c13_AugPDJoint);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_AugPDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_AugPDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c13_AugPDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndVel\",},{M[8],M[0],T\"is_active_c13_AugPDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_AugPDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc13_AugPDJointInstanceStruct *chartInstance;
    chartInstance = (SFc13_AugPDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c13_AugPDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_AugPDJointInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_AugPDJoint(void *chartInstanceVar)
{
  enable_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_AugPDJoint(void *chartInstanceVar)
{
  disable_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_AugPDJoint(void *chartInstanceVar)
{
  sf_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c13_AugPDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_AugPDJoint
    ((SFc13_AugPDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c13_AugPDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c13_AugPDJoint(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_AugPDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c13_AugPDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_AugPDJoint(S);
}

static void sf_opaque_set_sim_state_c13_AugPDJoint(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c13_AugPDJoint(S, st);
}

static void sf_opaque_terminate_c13_AugPDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_AugPDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c13_AugPDJoint((SFc13_AugPDJointInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_AugPDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_AugPDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"AugPDJoint","AugPDJoint",13);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"AugPDJoint","AugPDJoint",13,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"AugPDJoint",
      "AugPDJoint",13,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"AugPDJoint","AugPDJoint",13,2);
      sf_mark_chart_reusable_outputs(S,"AugPDJoint","AugPDJoint",13,1);
    }

    sf_set_rtw_dwork_info(S,"AugPDJoint","AugPDJoint",13);
...
static void mdlRTW_c13_AugPDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "AugPDJoint", "AugPDJoint",13);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c13_AugPDJoint(SimStruct *S)
{
  SFc13_AugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc13_AugPDJointInstanceStruct *)malloc(sizeof
    (SFc13_AugPDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_AugPDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_AugPDJoint;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c13_AugPDJoint;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_AugPDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_AugPDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_AugPDJoint;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_AugPDJoint;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_AugPDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_AugPDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_AugPDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_AugPDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_AugPDJoint;
...
void c13_AugPDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_AugPDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_AugPDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_AugPDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_AugPDJoint_method_dispatcher.\n"
