...
static void initialize_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct
  *chartInstance);
static void initialize_params_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct
  *chartInstance);
static void enable_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct *chartInstance);
static void disable_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct *
  chartInstance);
static void set_sim_state_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct *chartInstance);
static void sf_c1_AugPDJoint(SFc1_AugPDJointInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c1_AugPDJoint
  (SFc1_AugPDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static void c1_fwd_kin(SFc1_AugPDJointInstanceStruct *chartInstance, real_T
...
static void c1_emlrt_marshallIn(SFc1_AugPDJointInstanceStruct *chartInstance,
  const mxArray *c1_EndPos, const char_T *c1_name, real_T c1_y[3]);
static uint8_T c1_b_emlrt_marshallIn(SFc1_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_AugPDJoint, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_AugPDJointInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_AugPDJoint = 0U;
}
  ...
  chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_AugPDJoint;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_AugPDJoint = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_AugPDJoint");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_AugPDJoint(chartInstance);
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_AugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc1_AugPDJointInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
...
const mxArray *sf_c1_AugPDJoint_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[39])
{
  ...
  c1_info[1].resolved = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c1_info[1].fileLength = 3324U;
  c1_info[1].fileTime1 = 1366778959U;
  c1_info[1].fileTime2 = 0U;
  c1_info[2].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c1_info[2].name = "cos";
  ...
  c1_info[8].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
  c1_info[8].name = "sin";
  ...
  c1_info[10].context = "[E]D:/Learn/MatlabProgram/Fanuc/fwd_kin.m";
...
static void c1_emlrt_marshallIn(SFc1_AugPDJointInstanceStruct *chartInstance,
  const mxArray *c1_EndPos, const char_T *c1_name,
  real_T c1_y[3])
{
  real_T c1_dv3[3];
  int32_T c1_i31;
...
static uint8_T c1_b_emlrt_marshallIn(SFc1_AugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_AugPDJoint,
  const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_AugPDJoint), &c1_u0, 1, 3,
                0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_AugPDJoint);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_AugPDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_AugPDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_AugPDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c1_AugPDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_AugPDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_AugPDJointInstanceStruct *chartInstance;
    chartInstance = (SFc1_AugPDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_AugPDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_AugPDJointInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_AugPDJoint(void *chartInstanceVar)
{
  enable_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_AugPDJoint(void *chartInstanceVar)
{
  disable_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_AugPDJoint(void *chartInstanceVar)
{
  sf_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_AugPDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_AugPDJoint
    ((SFc1_AugPDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_AugPDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c1_AugPDJoint(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_AugPDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_AugPDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_AugPDJoint(S);
}

static void sf_opaque_set_sim_state_c1_AugPDJoint(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_AugPDJoint(S, st);
}

static void sf_opaque_terminate_c1_AugPDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_AugPDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_AugPDJoint((SFc1_AugPDJointInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_AugPDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_AugPDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"AugPDJoint","AugPDJoint",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"AugPDJoint","AugPDJoint",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"AugPDJoint",
      "AugPDJoint",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"AugPDJoint","AugPDJoint",1,1);
      sf_mark_chart_reusable_outputs(S,"AugPDJoint","AugPDJoint",1,1);
    }

    sf_set_rtw_dwork_info(S,"AugPDJoint","AugPDJoint",1);
...
static void mdlRTW_c1_AugPDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "AugPDJoint", "AugPDJoint",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_AugPDJoint(SimStruct *S)
{
  SFc1_AugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc1_AugPDJointInstanceStruct *)malloc(sizeof
    (SFc1_AugPDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_AugPDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_AugPDJoint;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_AugPDJoint;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_AugPDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_AugPDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_AugPDJoint;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_AugPDJoint;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_AugPDJoint;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_AugPDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_AugPDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_AugPDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_AugPDJoint;
...
void c1_AugPDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_AugPDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_AugPDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_AugPDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_AugPDJoint_method_dispatcher.\n"
