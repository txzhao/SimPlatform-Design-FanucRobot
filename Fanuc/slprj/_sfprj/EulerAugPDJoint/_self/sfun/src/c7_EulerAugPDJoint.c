...
static void initialize_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void initialize_params_c7_EulerAugPDJoint
  (SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void enable_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void disable_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_EulerAugPDJoint
  (SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_EulerAugPDJoint
  (SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void set_sim_state_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct *
  chartInstance, const mxArray *c7_st);
static void finalize_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void sf_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void c7_c7_EulerAugPDJoint(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c7_EulerAugPDJoint
  (SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static void c7_fwd_kin(SFc7_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c7_in1[9], real_T c7_in2[6], real_T c7_gst[16]);
static void c7_body_Jacobian(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c7_in1[9], real_T c7_in2[6], real_T c7_b_body_Jacobian[36]);
static void c7_AdjointInv(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c7_g[16], real_T c7_Adg_inv[36]);
static void c7_eml_scalar_eg(SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void c7_eps(SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void c7_eml_matlab_zgetrf(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_b_A[36], int32_T c7_ipiv[6],
  int32_T *c7_info);
static int32_T c7_eml_ixamax(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c7_n, real_T c7_x[36], int32_T c7_ix0);
static int32_T c7_ceval_ixamax(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c7_n, real_T c7_x[36], int32_T c7_ix0, int32_T c7_incx);
static void c7_ceval_xswap(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c7_n, real_T c7_x[36], int32_T c7_ix0, int32_T c7_incx, int32_T c7_iy0,
  int32_T c7_incy, real_T c7_b_x[36]);
static void c7_ceval_xger(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
...
static void c7_eml_warning(SFc7_EulerAugPDJointInstanceStruct *chartInstance);
static void c7_eml_blas_xtrsm(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  ...
  c7_b_B[36]);
static void c7_ceval_xtrsm(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c7_m, int32_T c7_n, real_T c7_alpha1, real_T c7_A[36], int32_T c7_ia0,
  int32_T c7_lda, real_T c7_B[36], int32_T c7_ib0, int32_T c7_ldb, real_T
  c7_b_B[36]);
static void c7_b_eml_blas_xtrsm(SFc7_EulerAugPDJointInstanceStruct
...
static void c7_b_ceval_xtrsm(SFc7_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c7_m, int32_T c7_n, real_T c7_alpha1, real_T c7_A[36], int32_T c7_ia0,
  int32_T c7_lda, real_T c7_B[36], int32_T c7_ib0, int32_T c7_ldb, real_T
  c7_b_B[36]);
static void c7_b_eml_scalar_eg(SFc7_EulerAugPDJointInstanceStruct *chartInstance);
...
static void c7_emlrt_marshallIn(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c7_Omega, const char_T *c7_name, real_T c7_y[6]);
static uint8_T c7_b_emlrt_marshallIn(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_EulerAugPDJoint, const char_T
  *c7_name);
static void init_dsm_address_info(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_EulerAugPDJoint = 0U;
}
  ...
  (SFc7_EulerAugPDJointInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_EulerAugPDJoint;
  ...
  chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_EulerAugPDJoint = c7_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_EulerAugPDJoint");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_EulerAugPDJoint(chartInstance);
  ...
  *chartInstance)
{
  ...
  c7_c7_EulerAugPDJoint(chartInstance);
...
static const mxArray *c7_sf_marshall(void *chartInstanceVoid, void *c7_u)
{
  ...
  const mxArray *c7_b_y = NULL;
  SFc7_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc7_EulerAugPDJointInstanceStruct *)chartInstanceVoid;
  c7_y = NULL;
...
const mxArray *sf_c7_EulerAugPDJoint_get_eml_resolved_functions_info(void)
{
...
static uint8_T c7_b_emlrt_marshallIn(SFc7_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *
  c7_b_is_active_c7_EulerAugPDJoint, const char_T *c7_name)
{
  uint8_T c7_y;
  uint8_T c7_u0;
  sf_mex_import(c7_name, sf_mex_dup(c7_b_is_active_c7_EulerAugPDJoint), &c7_u0,
                1, 3, 0U, 0, 0U, 0);
  c7_y = c7_u0;
  sf_mex_destroy(&c7_b_is_active_c7_EulerAugPDJoint);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_EulerAugPDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_EulerAugPDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c7_EulerAugPDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Omega\",},{M[8],M[0],T\"is_active_c7_EulerAugPDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_EulerAugPDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_EulerAugPDJointInstanceStruct *chartInstance;
    chartInstance = (SFc7_EulerAugPDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c7_EulerAugPDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_EulerAugPDJointInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_EulerAugPDJoint(void *chartInstanceVar)
{
  enable_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_EulerAugPDJoint(void *chartInstanceVar)
{
  disable_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_EulerAugPDJoint(void *chartInstanceVar)
{
  sf_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c7_EulerAugPDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_EulerAugPDJoint
    ((SFc7_EulerAugPDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c7_EulerAugPDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c7_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_EulerAugPDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c7_EulerAugPDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_EulerAugPDJoint(S);
}

static void sf_opaque_set_sim_state_c7_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_EulerAugPDJoint(S, st);
}

static void sf_opaque_terminate_c7_EulerAugPDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_EulerAugPDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_EulerAugPDJoint((SFc7_EulerAugPDJointInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c7_EulerAugPDJoint
    ((SFc7_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_EulerAugPDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_EulerAugPDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerAugPDJoint","EulerAugPDJoint",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint","EulerAugPDJoint",7,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint",
      "EulerAugPDJoint",7,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerAugPDJoint","EulerAugPDJoint",
        7,2);
      sf_mark_chart_reusable_outputs(S,"EulerAugPDJoint","EulerAugPDJoint",7,1);
    }

    sf_set_rtw_dwork_info(S,"EulerAugPDJoint","EulerAugPDJoint",7);
...
static void mdlRTW_c7_EulerAugPDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerAugPDJoint", "EulerAugPDJoint",7);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c7_EulerAugPDJoint(SimStruct *S)
{
  SFc7_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc7_EulerAugPDJointInstanceStruct *)malloc(sizeof
    (SFc7_EulerAugPDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_EulerAugPDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_EulerAugPDJoint;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_EulerAugPDJoint;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_EulerAugPDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_EulerAugPDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_EulerAugPDJoint;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_EulerAugPDJoint;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_EulerAugPDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_EulerAugPDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_EulerAugPDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_EulerAugPDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_EulerAugPDJoint;
...
void c7_EulerAugPDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_EulerAugPDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_EulerAugPDJoint_method_dispatcher.\n"
