...
static const char *c1_debug_family_names[6] = { "gd", "nargin", "nargout",
  "Theta", "L", "EndPos" };
...
static void initialize_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
static void initialize_params_c1_EulerAugPDJoint
  (SFc1_EulerAugPDJointInstanceStruct *chartInstance);
static void enable_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
static void disable_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_EulerAugPDJoint
  (SFc1_EulerAugPDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_EulerAugPDJoint
  (SFc1_EulerAugPDJointInstanceStruct *chartInstance);
static void set_sim_state_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
static void sf_c1_EulerAugPDJoint(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c1_EulerAugPDJoint
  (SFc1_EulerAugPDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static void c1_fwd_kin(SFc1_EulerAugPDJointInstanceStruct *chartInstance, real_T
...
static void c1_emlrt_marshallIn(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_EndPos, const char_T *c1_name, real_T c1_y[3]);
static uint8_T c1_b_emlrt_marshallIn(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_EulerAugPDJoint, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_EulerAugPDJoint = 0U;
}
  ...
  (SFc1_EulerAugPDJointInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_EndPos)[3];
  c1_EndPos = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(2));
  for (c1_i1 = 0; c1_i1 < 3; c1_i1 = c1_i1 + 1) {
    c1_hoistedGlobal[c1_i1] = (*c1_EndPos)[c1_i1];
  }
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_EulerAugPDJoint;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  for (c1_i3 = 0; c1_i3 < 3; c1_i3 = c1_i3 + 1) {
    (*c1_EndPos)[c1_i3] = c1_dv1[c1_i3];
  }

  chartInstance->c1_is_active_c1_EulerAugPDJoint = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_EulerAugPDJoint");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_EulerAugPDJoint(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T (*c1_c_Theta)[6];
  c1_b_EndPos = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_c_Theta = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0);
  for (c1_i4 = 0; c1_i4 < 6; c1_i4 = c1_i4 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_c_Theta)[c1_i4], 0U);
  }

  for (c1_i5 = 0; c1_i5 < 3; c1_i5 = c1_i5 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_b_EndPos)[c1_i5], 1U);
  }

  for (c1_i6 = 0; c1_i6 < 9; c1_i6 = c1_i6 + 1) {
    _SFD_DATA_RANGE_CHECK(chartInstance->c1_L[c1_i6], 2U);
  }
  ...
  for (c1_i7 = 0; c1_i7 < 6; c1_i7 = c1_i7 + 1) {
    c1_hoistedGlobal[c1_i7] = (*c1_c_Theta)[c1_i7];
  }

  for (c1_i8 = 0; c1_i8 < 9; c1_i8 = c1_i8 + 1) {
    c1_b_hoistedGlobal[c1_i8] = chartInstance->c1_L[c1_i8];
  }

  for (c1_i9 = 0; c1_i9 < 6; c1_i9 = c1_i9 + 1) {
    c1_Theta[c1_i9] = c1_hoistedGlobal[c1_i9];
  }

  for (c1_i10 = 0; c1_i10 < 9; c1_i10 = c1_i10 + 1) {
    c1_b_L[c1_i10] = c1_b_hoistedGlobal[c1_i10];
  }

  sf_debug_symbol_scope_push_eml(0U, 6U, 6U, c1_debug_family_names,
    c1_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(c1_gd, c1_e_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(&c1_nargin, c1_d_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(&c1_nargout, c1_d_sf_marshall, 2U);
  sf_debug_symbol_scope_add_eml(c1_Theta, c1_c_sf_marshall, 3U);
  sf_debug_symbol_scope_add_eml(c1_b_L, c1_b_sf_marshall, 4U);
  sf_debug_symbol_scope_add_eml(c1_EndPos, c1_sf_marshall, 5U);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0, 3);
  for (c1_i11 = 0; c1_i11 < 9; c1_i11 = c1_i11 + 1) {
    c1_c_L[c1_i11] = c1_b_L[c1_i11];
  }

  for (c1_i12 = 0; c1_i12 < 6; c1_i12 = c1_i12 + 1) {
    c1_b_Theta[c1_i12] = c1_Theta[c1_i12];
  }

  c1_fwd_kin(chartInstance, c1_c_L, c1_b_Theta, c1_dv2);
  for (c1_i13 = 0; c1_i13 < 16; c1_i13 = c1_i13 + 1) {
    c1_gd[c1_i13] = c1_dv2[c1_i13];
  }

  _SFD_EML_CALL(0, 4);
  for (c1_i14 = 0; c1_i14 < 3; c1_i14 = c1_i14 + 1) {
    c1_EndPos[c1_i14] = c1_gd[c1_i14 + 12];
  }

  _SFD_EML_CALL(0, -4);
  sf_debug_symbol_scope_pop();
  for (c1_i15 = 0; c1_i15 < 3; c1_i15 = c1_i15 + 1) {
    (*c1_b_EndPos)[c1_i15] = c1_EndPos[c1_i15];
  }
  ...
  c1_in1[9], real_T c1_in2[6], real_T c1_gst[16])
{
  ...
  sf_debug_symbol_scope_add_eml(c1_in2, c1_f_sf_marshall, 66U);
  sf_debug_symbol_scope_add_eml(c1_gst, c1_e_sf_marshall, 67U);
  CV_SCRIPT_FCN(0, 0);
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc1_EulerAugPDJointInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i16 = 0; c1_i16 < 3; c1_i16 = c1_i16 + 1) {
    c1_b_u[c1_i16] = (*((real_T (*)[3])c1_u))[c1_i16];
  }

  for (c1_i17 = 0; c1_i17 < 3; c1_i17 = c1_i17 + 1) {
    c1_c_u[c1_i17] = c1_b_u[c1_i17];
  }
...
static const mxArray *c1_b_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i18 = 0; c1_i18 < 9; c1_i18 = c1_i18 + 1) {
    c1_b_u[c1_i18] = (*((real_T (*)[9])c1_u))[c1_i18];
  }

  for (c1_i19 = 0; c1_i19 < 9; c1_i19 = c1_i19 + 1) {
    c1_c_u[c1_i19] = c1_b_u[c1_i19];
  }
...
static const mxArray *c1_c_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i20 = 0; c1_i20 < 6; c1_i20 = c1_i20 + 1) {
    c1_b_u[c1_i20] = (*((real_T (*)[6])c1_u))[c1_i20];
  }

  for (c1_i21 = 0; c1_i21 < 6; c1_i21 = c1_i21 + 1) {
    c1_c_u[c1_i21] = c1_b_u[c1_i21];
  }
...
static const mxArray *c1_e_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i23 = 0; c1_i23 < 4; c1_i23 = c1_i23 + 1) {
    for (c1_i24 = 0; c1_i24 < 4; c1_i24 = c1_i24 + 1) {
      c1_b_u[c1_i24 + c1_i22] = (*((real_T (*)[16])c1_u))[c1_i24 + c1_i22];
    }
  ...
  for (c1_i26 = 0; c1_i26 < 4; c1_i26 = c1_i26 + 1) {
    for (c1_i27 = 0; c1_i27 < 4; c1_i27 = c1_i27 + 1) {
      c1_c_u[c1_i27 + c1_i25] = c1_b_u[c1_i27 + c1_i25];
    }
...
static const mxArray *c1_f_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i28 = 0; c1_i28 < 6; c1_i28 = c1_i28 + 1) {
    c1_b_u[c1_i28] = (*((real_T (*)[6])c1_u))[c1_i28];
  }

  for (c1_i29 = 0; c1_i29 < 6; c1_i29 = c1_i29 + 1) {
    c1_c_u[c1_i29] = c1_b_u[c1_i29];
  }
...
const mxArray *sf_c1_EulerAugPDJoint_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c1_m0, sf_mex_createstruct("nameCaptureInfo", 1, 39));
  for (c1_i30 = 0; c1_i30 < 39; c1_i30 = c1_i30 + 1) {
    c1_r0 = &c1_info[c1_i30];
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->context, 15,
      0U, 0U, 0U, 2, 1, strlen(c1_r0->context)), "context",
                    "nameCaptureInfo", c1_i30);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c1_r0->name)), "name",
                    "nameCaptureInfo", c1_i30);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c1_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c1_i30);
    ...
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c1_i30
                    );
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c1_i30
                    );
  }
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[39])
{
  ...
  c1_info[1].context = "";
  c1_info[1].name = "fwd_kin";
  c1_info[1].dominantType = "double";
  c1_info[1].resolved = "[E]D:/Learn/Project_Matlab/Fanuc/fwd_kin.m";
  c1_info[1].fileLength = 3324U;
  c1_info[1].fileTime1 = 1366778959U;
  c1_info[1].fileTime2 = 0U;
  c1_info[2].context = "[E]D:/Learn/Project_Matlab/Fanuc/fwd_kin.m";
  c1_info[2].name = "cos";
  c1_info[2].dominantType = "double";
  c1_info[2].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c1_info[2].fileLength = 324U;
  c1_info[2].fileTime1 = 1203422750U;
  c1_info[2].fileTime2 = 0U;
  c1_info[3].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  ...
  c1_info[6].fileLength = 602U;
  c1_info[6].fileTime1 = 1209309186U;
  ...
  c1_info[8].context = "[E]D:/Learn/Project_Matlab/Fanuc/fwd_kin.m";
  c1_info[8].name = "sin";
  c1_info[8].dominantType = "double";
  c1_info[8].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c1_info[8].fileLength = 324U;
  c1_info[8].fileTime1 = 1203422842U;
  c1_info[8].fileTime2 = 0U;
  c1_info[9].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c1_info[9].name = "eml_scalar_sin";
  c1_info[9].dominantType = "double";
  c1_info[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c1_info[9].fileLength = 601U;
  c1_info[9].fileTime1 = 1209309190U;
  c1_info[9].fileTime2 = 0U;
  c1_info[10].context = "[E]D:/Learn/Project_Matlab/Fanuc/fwd_kin.m";
  c1_info[10].name = "times";
  c1_info[10].dominantType = "double";
  c1_info[10].resolved = "[B]times";
  ...
  c1_info[13].name = "uminus";
  c1_info[13].dominantType = "double";
  c1_info[13].resolved = "[B]uminus";
  ...
  c1_info[25].fileLength = 541U;
  c1_info[25].fileTime1 = 1271383988U;
  c1_info[25].fileTime2 = 0U;
  c1_info[26].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m!isintegral";
  c1_info[26].name = "true";
  c1_info[26].dominantType = "";
  c1_info[26].resolved = "[B]true";
  ...
  c1_info[29].fileTime1 = 1251010272U;
  c1_info[29].fileTime2 = 0U;
  c1_info[30].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[30].name = "isscalar";
  c1_info[30].dominantType = "double";
  c1_info[30].resolved = "[B]isscalar";
  ...
  c1_info[31].name = "strcmp";
  c1_info[31].dominantType = "char";
  c1_info[31].resolved = "[B]strcmp";
  ...
  c1_info[32].name = "class";
  c1_info[32].dominantType = "double";
  c1_info[32].resolved = "[B]class";
  ...
  c1_info[33].fileLength = 1535U;
  c1_info[33].fileTime1 = 1192445128U;
  ...
  c1_info[35].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[35].name = "int32";
  c1_info[35].dominantType = "double";
  c1_info[35].resolved = "[B]int32";
  ...
  c1_info[36].fileLength = 3068U;
  c1_info[36].fileTime1 = 1240240410U;
  c1_info[36].fileTime2 = 0U;
  c1_info[37].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c1_info[37].name = "isstruct";
  c1_info[37].dominantType = "double";
  c1_info[37].resolved = "[B]isstruct";
...
static void c1_emlrt_marshallIn(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c1_EndPos, const char_T *c1_name,
  real_T c1_y[3])
{
  real_T c1_dv3[3];
  int32_T c1_i31;
  sf_mex_import(c1_name, sf_mex_dup(c1_EndPos), c1_dv3, 1, 0, 0U, 1, 0U, 1, 3);
  for (c1_i31 = 0; c1_i31 < 3; c1_i31 = c1_i31 + 1) {
    c1_y[c1_i31] = c1_dv3[c1_i31];
  }

  sf_mex_destroy(&c1_EndPos);
}

static uint8_T c1_b_emlrt_marshallIn(SFc1_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_EulerAugPDJoint, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_EulerAugPDJoint), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_EulerAugPDJoint);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_EulerAugPDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_EulerAugPDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c1_EulerAugPDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"EndPos\",},{M[8],M[0],T\"is_active_c1_EulerAugPDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_EulerAugPDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_EulerAugPDJointInstanceStruct *chartInstance;
    chartInstance = (SFc1_EulerAugPDJointInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c1_EndPos)[3];
          c1_EndPos = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c1_Theta = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c1_Theta);
          _SFD_SET_DATA_VALUE_PTR(1U, *c1_EndPos);
          _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c1_L);
        }
      }
    } else {
...
static void sf_opaque_initialize_c1_EulerAugPDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_EulerAugPDJointInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_EulerAugPDJoint(void *chartInstanceVar)
{
  enable_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_EulerAugPDJoint(void *chartInstanceVar)
{
  disable_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_EulerAugPDJoint(void *chartInstanceVar)
{
  sf_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_EulerAugPDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_EulerAugPDJoint
    ((SFc1_EulerAugPDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_EulerAugPDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c1_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_EulerAugPDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_EulerAugPDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_EulerAugPDJoint(S);
}

static void sf_opaque_set_sim_state_c1_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_EulerAugPDJoint(S, st);
}

static void sf_opaque_terminate_c1_EulerAugPDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_EulerAugPDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_EulerAugPDJoint((SFc1_EulerAugPDJointInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_EulerAugPDJoint
    ((SFc1_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_EulerAugPDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_EulerAugPDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerAugPDJoint","EulerAugPDJoint",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint","EulerAugPDJoint",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint",
      "EulerAugPDJoint",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerAugPDJoint","EulerAugPDJoint",
        1,1);
      sf_mark_chart_reusable_outputs(S,"EulerAugPDJoint","EulerAugPDJoint",1,1);
    }

    sf_set_rtw_dwork_info(S,"EulerAugPDJoint","EulerAugPDJoint",1);
...
static void mdlRTW_c1_EulerAugPDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerAugPDJoint", "EulerAugPDJoint",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_EulerAugPDJoint(SimStruct *S)
{
  SFc1_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc1_EulerAugPDJointInstanceStruct *)malloc(sizeof
    (SFc1_EulerAugPDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_EulerAugPDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_EulerAugPDJoint;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_EulerAugPDJoint;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_EulerAugPDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_EulerAugPDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_EulerAugPDJoint;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_EulerAugPDJoint;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_EulerAugPDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_EulerAugPDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_EulerAugPDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_EulerAugPDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_EulerAugPDJoint;
...
void c1_EulerAugPDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_EulerAugPDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_EulerAugPDJoint_method_dispatcher.\n"
