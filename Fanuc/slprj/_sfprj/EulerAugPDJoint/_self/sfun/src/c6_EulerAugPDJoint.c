...
static void initialize_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
static void initialize_params_c6_EulerAugPDJoint
  (SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void enable_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
static void disable_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_EulerAugPDJoint
  (SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_EulerAugPDJoint
  (SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void set_sim_state_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct *
  chartInstance, const mxArray *c6_st);
static void finalize_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
static void sf_c6_EulerAugPDJoint(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c6_EulerAugPDJoint
  (SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static void c6_inv_kin(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c6_gd[16], real_T c6_b_L[9], real_T c6_theta[24], real_T *c6_Num);
static void c6_cross(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                     c6_a[3], real_T c6_b[3], real_T c6_c[3]);
static boolean_T c6_all(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  boolean_T c6_x[2]);
static void c6_mrdivide(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_A[16], real_T c6_B[16], real_T c6_y[16]);
static real_T c6_power(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c6_a, real_T c6_b);
static void c6_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eml_error(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eps(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eml_matlab_zgetrf(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, real_T c6_A[16], real_T c6_b_A[16], int32_T c6_ipiv[4],
  int32_T *c6_info);
static int32_T c6_eml_ixamax(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[16], int32_T c6_ix0);
static int32_T c6_ceval_ixamax(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[16], int32_T c6_ix0, int32_T c6_incx);
static void c6_ceval_xswap(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[16], int32_T c6_ix0, int32_T c6_incx, int32_T c6_iy0,
  int32_T c6_incy, real_T c6_b_x[16]);
static void c6_ceval_xger(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
...
static void c6_eml_warning(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_b_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eml_xtrsm(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_A[16], real_T c6_B[16], real_T c6_b_B[16]);
static void c6_c_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eml_blas_xtrsm(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  ...
  c6_b_B[16]);
static void c6_d_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static real_T c6_atan2(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c6_y, real_T c6_x);
static boolean_T c6_isInRange(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_x, real_T c6_xmin, real_T c6_xmax);
static void c6_expWre(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                      c6_kx[6], real_T c6_theta, real_T c6_g[16]);
static real_T c6_length(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_eye(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                   c6_I[9]);
static void c6_expRot(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                      c6_w[3], real_T c6_theta, real_T c6_R[9]);
static void c6_e_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_f_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_subPro3(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c6_kx[6], real_T c6_p[4], real_T c6_q[4], real_T c6_d[4], real_T c6_theta[2],
  real_T *c6_Nsol);
static void c6_g_eml_scalar_eg(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static real_T c6_ceval_xdot(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[3], int32_T c6_ix0, int32_T c6_incx, real_T c6_y[3],
  int32_T c6_iy0, int32_T c6_incy);
static real_T c6_mpower(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_a);
static real_T c6_norm(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                      c6_x[3]);
static real_T c6_ceval_xnrm2(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[3], int32_T c6_ix0, int32_T c6_incx);
static void c6_b_eml_error(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static void c6_b_isInRange(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_x[2], real_T c6_xmin, real_T c6_xmax, boolean_T c6_isIn[2]);
static boolean_T c6_any(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  boolean_T c6_x[2]);
static real_T c6_subPro1(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_kx[6], real_T c6_p[4], real_T c6_q[4]);
static void c6_subPro2(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
  c6_kx1[6], real_T c6_kx2[6], real_T c6_p[4], real_T c6_q[4], real_T c6_theta1
  [2], real_T c6_theta2[2], real_T *c6_Nsol);
static void c6_findCommon(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_w1[3], real_T c6_w2[3], real_T c6_r1[3], real_T c6_r2[3], real_T
  c6_r[3]);
static real_T c6_det(SFc6_EulerAugPDJointInstanceStruct *chartInstance, real_T
                     c6_x[4]);
static void c6_b_eml_matlab_zgetrf(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, real_T c6_A[4], real_T c6_b_A[4], int32_T c6_ipiv[2], int32_T *
  c6_info);
static int32_T c6_b_eml_ixamax(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_x[4]);
static int32_T c6_b_ceval_ixamax(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, int32_T c6_n, real_T c6_x[4], int32_T c6_ix0, int32_T c6_incx);
static void c6_b_ceval_xswap(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_n, real_T c6_x[4], int32_T c6_ix0, int32_T c6_incx, int32_T c6_iy0,
  int32_T c6_incy, real_T c6_b_x[4]);
static void c6_b_ceval_xger(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  int32_T c6_m, int32_T c6_n, real_T c6_alpha1, int32_T c6_ix0, int32_T c6_incx,
  int32_T c6_iy0, int32_T c6_incy, real_T c6_A[4], int32_T c6_ia0, int32_T
  c6_lda, real_T c6_b_A[4]);
static void c6_c_eml_error(SFc6_EulerAugPDJointInstanceStruct *chartInstance);
static real_T c6_b_subPro1(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
  real_T c6_kx[6], real_T c6_p[4], real_T c6_q[3]);
static real_T c6_c_subPro1(SFc6_EulerAugPDJointInstanceStruct *chartInstance,
...
static void c6_emlrt_marshallIn(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c6_theta, const char_T *c6_name, real_T c6_y[6]);
static uint8_T c6_b_emlrt_marshallIn(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_EulerAugPDJoint, const char_T
  *c6_name);
static void init_dsm_address_info(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_EulerAugPDJoint = 0U;
}
  ...
  (SFc6_EulerAugPDJointInstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_EulerAugPDJoint;
  ...
  chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_EulerAugPDJoint = c6_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_EulerAugPDJoint");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_EulerAugPDJoint(chartInstance);
...
static const mxArray *c6_sf_marshall(void *chartInstanceVoid, void *c6_u)
{
  ...
  const mxArray *c6_b_y = NULL;
  SFc6_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc6_EulerAugPDJointInstanceStruct *)chartInstanceVoid;
  c6_y = NULL;
...
const mxArray *sf_c6_EulerAugPDJoint_get_eml_resolved_functions_info(void)
{
...
static uint8_T c6_b_emlrt_marshallIn(SFc6_EulerAugPDJointInstanceStruct
  *chartInstance, const mxArray *
  c6_b_is_active_c6_EulerAugPDJoint, const char_T *c6_name)
{
  uint8_T c6_y;
  uint8_T c6_u0;
  sf_mex_import(c6_name, sf_mex_dup(c6_b_is_active_c6_EulerAugPDJoint), &c6_u0,
                1, 3, 0U, 0, 0U, 0);
  c6_y = c6_u0;
  sf_mex_destroy(&c6_b_is_active_c6_EulerAugPDJoint);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_EulerAugPDJoint_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_EulerAugPDJoint_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c6_EulerAugPDJoint(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"theta\",},{M[8],M[0],T\"is_active_c6_EulerAugPDJoint\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_EulerAugPDJoint_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_EulerAugPDJointInstanceStruct *chartInstance;
    chartInstance = (SFc6_EulerAugPDJointInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_EulerAugPDJoint(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_EulerAugPDJointInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
  initialize_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_EulerAugPDJoint(void *chartInstanceVar)
{
  enable_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_EulerAugPDJoint(void *chartInstanceVar)
{
  disable_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_EulerAugPDJoint(void *chartInstanceVar)
{
  sf_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c6_EulerAugPDJoint(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_EulerAugPDJoint
    ((SFc6_EulerAugPDJointInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c6_EulerAugPDJoint();/* state var info */
...
static void sf_internal_set_sim_state_c6_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_EulerAugPDJoint();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c6_EulerAugPDJoint(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_EulerAugPDJoint(S);
}

static void sf_opaque_set_sim_state_c6_EulerAugPDJoint(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_EulerAugPDJoint(S, st);
}

static void sf_opaque_terminate_c6_EulerAugPDJoint(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_EulerAugPDJointInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_EulerAugPDJoint((SFc6_EulerAugPDJointInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c6_EulerAugPDJoint
    ((SFc6_EulerAugPDJointInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_EulerAugPDJoint(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_EulerAugPDJoint(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EulerAugPDJoint","EulerAugPDJoint",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint","EulerAugPDJoint",6,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EulerAugPDJoint",
      "EulerAugPDJoint",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EulerAugPDJoint","EulerAugPDJoint",
        6,1);
      sf_mark_chart_reusable_outputs(S,"EulerAugPDJoint","EulerAugPDJoint",6,1);
    }

    sf_set_rtw_dwork_info(S,"EulerAugPDJoint","EulerAugPDJoint",6);
...
static void mdlRTW_c6_EulerAugPDJoint(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EulerAugPDJoint", "EulerAugPDJoint",6);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c6_EulerAugPDJoint(SimStruct *S)
{
  SFc6_EulerAugPDJointInstanceStruct *chartInstance;
  chartInstance = (SFc6_EulerAugPDJointInstanceStruct *)malloc(sizeof
    (SFc6_EulerAugPDJointInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_EulerAugPDJointInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_EulerAugPDJoint;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_EulerAugPDJoint;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_EulerAugPDJoint;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_EulerAugPDJoint;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_EulerAugPDJoint;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_EulerAugPDJoint;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_EulerAugPDJoint;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_EulerAugPDJoint;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_EulerAugPDJoint;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_EulerAugPDJoint;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_EulerAugPDJoint;
...
void c6_EulerAugPDJoint_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_EulerAugPDJoint(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_EulerAugPDJoint(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_EulerAugPDJoint_method_dispatcher.\n"
