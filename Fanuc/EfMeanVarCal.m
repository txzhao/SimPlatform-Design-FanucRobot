...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Trq,Jnt,Vel,Acc,Var]=EfMeanVarCal(File,IniEnc,I2T,Gear,EncRes,IniJnt,SmpT,JntNum)

D2R = pi/180;
R2D = 180/pi;

d=fdesign.lowpass('Fp,Fst,Ap,Ast',0.05,0.1,1,75);
%d=fdesign.lowpass('Fp,Fst,Ap,Ast',0.006,0.05,1,70);
...
%     grid on;
%     str=sprintf('%d Torque Frequency',i);
%     title(str);
% end
