...
%% Configure Axis 1
RobotAxis(1).CurrentSourceSelect =5;
RobotAxis(1).VelSourceSelect = 5;
...
RobotAxis(6).CurrentSourceSelect = 6;%5;
RobotAxis(6).VelSourceSelect = 6;%5;
RobotAxis(6).PosSourceSelect =6;%1;
