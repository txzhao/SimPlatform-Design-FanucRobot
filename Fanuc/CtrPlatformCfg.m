...
DynTrjMode=1;             %%% 1: Arbitary Trj; 2: Velocity Tunning Trj; 3: Pos Tunning Trj 4: Zero
VelLpAxisNum=1;           %选择关节调节速度控制环参数(1-6)
PosLpAxisNum=1;           %选择关节调节位置控制环参数(1-6)
DisturbSelect=2;          %%% 1: Gaussian Noise 2: Zero
FrictionSelect=2;         %%% 1: Friction Torque 2: Zero
...
%% Centralized Control
% 1: Pulse 2: Control Loop (Abosolute) 3: Control Loop (increment) 4: Zero
PosSourceSelect_Ro = 2;
PosSourceSelect_Ad = 2;   
...
InitialPos1=A(1)*Rad2Line(1);
InitialPos2=A(2)*Rad2Line(2);
InitialPos3=A(3)*Rad2Line(3);
InitialPos4=A(4)*Rad2Line(4);
InitialPos5=A(5)*Rad2Line(5);
InitialPos6=A(6)*Rad2Line(6);
...
% in1 = [5.2954 0 0;0 4.7000 0;0 0 5.8635];
...
% in2 = [5.8840 0 0;0 6.0178 0;0 0 0.3374];
...
% in3 = [1.8201 0 0;0 2.2537 0;0 0 1.9485];
...
% in4 = [-0.9393 0 0;0 1.4493 0;0 0 1.4620];
...
% in5 = [0.0191 0 0;0 0.0228 0;0 0 0.0291];
